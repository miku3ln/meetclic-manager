...
-- Tiempo de generación: 16-04-2021 a las 15:31:04
...
INSERT INTO `types_payments` (`id`, `value`, `description`, `status`, `code`)
VALUES (1, 'SIN UTILIZACION DEL SISTEMA FINANCIERO', NULL, 'ACTIVE', '01'),
       (2, 'TARJETA DE CRÉDITO', NULL, 'ACTIVE', '19'),
       (3, 'CHEQUE PROPIO', NULL, 'ACTIVE', '02'),
       (4, 'TRANSFERENCIA PROPIO BANCO', NULL, 'ACTIVE', '07'),
       (5, 'DINERO ELECTRÓNICO', NULL, 'ACTIVE', '17'),
       (6, 'TARJETA DE DÉBITO', NULL, 'ACTIVE', '16'),
       (7, 'TARJETA PREPAGO', NULL, 'ACTIVE', '18'),
       ...
       (16, 'CHEQUE CERTIFICADO', NULL, 'INACTIVE', '03'),
       (17, 'CHEQUE DEL EXTERIOR', NULL, 'INACTIVE', '05'),
       (18, 'CHEQUE DE GERENCIA', NULL, 'INACTIVE', '04'),
       (19, 'DÉBITO DE CUENTA', NULL, 'INACTIVE', '06'),
...
VALUES (1, 'Sin definir', 'ACTIVE', 'null', 'null', '/uploads/products/productCategory/sindefinir.jpg', 0),
       (2, 'Software', 'ACTIVE', 'null', 'null', '/uploads/products/productCategory/sotware.jpg', 0),
