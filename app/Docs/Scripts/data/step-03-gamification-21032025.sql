...
VALUES (136, '/uploads/gamification/gamificationByProcess/process_136.png', 'Compartir noticia',
       ...
       (198, '/uploads/gamification/gamificationByProcess/process_198.png', 'Se unió a red de empresas aliadas',
        ...
        'fa fa-people-arrows');
-- CLIENTE A CLIENTE (ID 12)
INSERT INTO `gamification_by_process`
(`id`, `source`, `title`, `subtitle`, `description`, `state`, `valid_from`, `valid_until`, `expiration_type`,
 `expiration_value`, `frequency_limit_type`, `frequency_limit_value`, `is_repetitive`, `max_times_per_user`,
 `has_source`, `entity`, `entity_id`, `url_manager`, `gamification_id`, `gamification_type_activity_id`,
 `is_url`, `type_manager`, `user_id`, `unique_code`, `allow_golden`, `icon_class`)
VALUES
    (199, '/uploads/gamification/gamificationByProcess/process_199.png', 'Compartir puntos',
     'Compartir puntos con otro cliente',
     'Acción donde un cliente transfiere puntos a otro usuario como reconocimiento o apoyo.', 'ACTIVE', NULL, NULL,
     'NONE', NULL, 'NONE', NULL, 1, 10, 1, 'CLIENTE_CLIENTE', '199', NULL, 1, 12, 0, 1, 1, 'CC-199', 0, 'fa fa-gift'),

    (200, '/uploads/gamification/gamificationByProcess/process_200.png', 'Premiar colaboración',
     'Premiar a otro cliente por ayudar',
     'Acción donde un cliente otorga puntos como forma de gratitud a otro por asistencia o colaboración.', 'ACTIVE', NULL, NULL,
     'NONE', NULL, 'NONE', NULL, 1, 10, 1, 'CLIENTE_CLIENTE', '200', NULL, 1, 12, 0, 1, 1, 'CC-200', 0, 'fa fa-heart');

-- CLIENTE A EMPRESA (ID 13)
INSERT INTO `gamification_by_process`
VALUES
    (201, '/uploads/gamification/gamificationByProcess/process_201.png', 'Donar puntos a empresa',
     'Apoyar campañas de una empresa',
     'El cliente dona puntos a una campaña activa de una empresa, mostrando apoyo a sus iniciativas.', 'ACTIVE', NULL, NULL,
     'NONE', NULL, 'NONE', NULL, 1, 5, 1, 'CLIENTE_EMPRESA', '201', NULL, 1, 13, 0, 1, 1, 'CE-201', 0, 'fa fa-building'),

    (202, '/uploads/gamification/gamificationByProcess/process_202.png', 'Agradecer con puntos',
     'Agradecer públicamente a una empresa',
     'Acción donde un cliente otorga puntos a una empresa como muestra de satisfacción por su servicio.', 'ACTIVE', NULL, NULL,
     'NONE', NULL, 'NONE', NULL, 1, 5, 1, 'CLIENTE_EMPRESA', '202', NULL, 1, 13, 0, 1, 1, 'CE-202', 0, 'fa fa-star');

-- EMPRESA A CLIENTE (ID 14)
INSERT INTO `gamification_by_process`
VALUES
    (203, '/uploads/gamification/gamificationByProcess/process_203.png', 'Premiar fidelidad del cliente',
     'Otorgar puntos a clientes constantes',
     'La empresa otorga puntos por constancia o lealtad a los clientes que han interactuado frecuentemente.', 'ACTIVE', NULL, NULL,
     'NONE', NULL, 'NONE', NULL, 1, NULL, 1, 'EMPRESA_CLIENTE', '203', NULL, 1, 14, 0, 1, 1, 'EC-203', 0, 'fa fa-thumbs-up'),

    (204, '/uploads/gamification/gamificationByProcess/process_204.png', 'Premiar por feedback útil',
     'Incentivar retroalimentación valiosa',
     'La empresa otorga puntos a clientes que brindan comentarios útiles para mejorar sus productos o servicios.', 'ACTIVE', NULL, NULL,
     'NONE', NULL, 'NONE', NULL, 1, NULL, 1, 'EMPRESA_CLIENTE', '204', NULL, 1, 14, 0, 1, 1, 'EC-204', 0, 'fa fa-comment');

-- EMPRESA A EMPRESA (ID 15)
INSERT INTO `gamification_by_process`
VALUES
    (205, '/uploads/gamification/gamificationByProcess/process_205.png', 'Alianza entre empresas',
     'Apoyar a otra empresa en su campaña',
     'Una empresa colabora con otra donando puntos o recursos para una campaña o evento conjunto.', 'ACTIVE', NULL, NULL,
     'NONE', NULL, 'NONE', NULL, 1, NULL, 1, 'EMPRESA_EMPRESA', '205', NULL, 1, 15, 0, 1, 1, 'EE-205', 0, 'fa fa-handshake-o'),

    (206, '/uploads/gamification/gamificationByProcess/process_206.png', 'Compartir puntos empresariales',
     'Transferencia de puntos entre empresas',
     'Permite que una empresa comparta puntos con otra para potenciar alianzas o premiar colaboración.', 'ACTIVE', NULL, NULL,
     'NONE', NULL, 'NONE', NULL, 1, NULL, 1, 'EMPRESA_EMPRESA', '206', NULL, 1, 15, 0, 1, 1, 'EE-206', 0, 'fa fa-exchange');
...
VALUES
-- CLIENTE A CLIENTE
(199, 199, 75.0),   -- Compartir puntos
(200, 200, 100.0),  -- Premiar colaboración

-- CLIENTE A EMPRESA
(201, 201, 50.0),   -- Donar puntos a empresa
(202, 202, 75.0),   -- Agradecer con puntos

-- EMPRESA A CLIENTE
(203, 203, 150.0),  -- Premiar fidelidad del cliente
(204, 204, 125.0),  -- Premiar por feedback útil

-- EMPRESA A EMPRESA
(205, 205, 200.0),  -- Alianza entre empresas
(206, 206, 150.0);  -- Compartir puntos empresariales


INSERT INTO rating_scale_config (stars, label, description, color_hex, active) VALUES
-- ⭐ 1 Estrella
(1, 'Desconexión total',
 'El servicio o la actitud demostraron una falta de reciprocidad, desarmonía o ausencia de compromiso con el bien común. No hubo ayni (intercambio justo) ni respeto a la comunidad.',
 '#C0392B', 1),

-- ⭐⭐ 2 Estrellas
(2, 'Falta de armonía',
 'Hubo intención, pero la experiencia generó desequilibrio. La relación empresa-cliente no fluyó con respeto ni calidez, alejándose del principio de suma kawsay (vida en plenitud).',
 '#E67E22', 1),

-- ⭐⭐⭐ 3 Estrellas
(3, 'Neutralidad respetuosa',
 'La interacción fue funcional, sin mayor vínculo ni conflicto. Se cumplió lo justo, sin fortalecer el tejido comunitario ni afectar el equilibrio.',
 '#F1C40F', 1),

-- ⭐⭐⭐⭐ 4 Estrellas
(4, 'Buen ayni (intercambio)',
 'La relación mostró respeto, escucha y cumplimiento. Hubo intención de servicio desde el corazón, fortaleciendo la confianza y la energía circular de dar y recibir.',
 '#2ECC71', 1),

-- ⭐⭐⭐⭐⭐ 5 Estrellas
(5, 'Suma Kawsay (excelencia)',
 'La experiencia fue profundamente significativa, en armonía con los valores andinos: reciprocidad, comunidad y respeto a la vida. Se sintió conexión, cuidado y propósito compartido.',
 '#3498DB', 1);
