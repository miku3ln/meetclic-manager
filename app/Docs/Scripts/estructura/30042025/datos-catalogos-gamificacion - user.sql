...
INSERT INTO account_gamification (
    id, user_id, balance_available_bee, balance_available_queen, created_at, updated_at
)
VALUES (
           1, 1, 0, 0, NOW(), NOW()
       );
...
-- CLIENTE_A_EMPRESA
INSERT INTO account_gamification_by_movement (
    id, account_gamification_id, amount, type, input_movement, gamification_by_process_id, type_money, description, created_at, updated_at
)
VALUES
    (1, 1, 100.0, 1, 0, 163, 'bee', 'Donó puntos a empresa', NOW(), NOW()),
...
VALUES
    (13, 1, 100.0, 0, 1, 175, 'bee', 'Premió fidelidad del cliente', NOW(), NOW()),
