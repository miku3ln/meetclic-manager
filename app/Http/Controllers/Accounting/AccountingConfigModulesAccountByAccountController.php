...
use App\Models\AccountingConfigModulesAccountByAccount;
use Illuminate\Support\Facades\Request;
use Illuminate\Support\Facades\Response;
use Illuminate\Support\Facades\View;

class AccountingConfigModulesAccountByAccountController extends MyBaseController
{
    ...
    public function getManager()
    {
        ...
        $moduleResource = 'accountingConfigModulesAccountByAccount';
