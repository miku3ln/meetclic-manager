...
use App\Models\RetentionTaxType;
use Illuminate\Support\Facades\Request;
use Illuminate\Support\Facades\Response;
use Illuminate\Support\Facades\View;

class RetentionTaxTypeController extends MyBaseController
{
    ...
    public function getManager()
    {
        ...
        $moduleResource = 'retentionTaxType';
    ...
    public function getTypeRetentionsByTaxPointOfSales ()
    {

        $attributesPost = Request::all();
        $model = new  RetentionTaxType();
        $result = $model->getTypeRetentionsByTax($attributesPost);
        return Response::json($result);
    }
}
