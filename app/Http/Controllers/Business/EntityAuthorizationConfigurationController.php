...
use App\Models\EntityAuthorizationConfiguration;
use Illuminate\Support\Facades\Request;
use Illuminate\Support\Facades\Response;
use Illuminate\Support\Facades\View;

class EntityAuthorizationConfigurationController extends MyBaseController
{
    ...
    public function getManager()
    {
        $model = new EntityAuthorizationConfiguration();
        $moduleMain = 'business';
        $moduleResource = 'entityAuthorizationConfiguration';
