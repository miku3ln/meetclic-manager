...
class AntecedentController extends MyBaseController
{
     ...
     */
    public $model_entity = "antecedent";
    public $name_manager = "Antecedente";

    public function index()
    {
        $model = new Antecedent();
...
//Change
    public function getListAntecedents()
    {
        $data = Request::all();
        $query = Antecedent::query();
    ...
    public function getFormAntecedent($id = null)
    {
        $method = 'POST';
        $model = isset($id) ? Antecedent::find($id) : new Antecedent();
        $camerCase = $model->getCamelCase();
    ...
    {
        $data = Request::all();
        $query = Antecedent::query()->select('id', 'name as text');
        ...
        $query->where('status', '=', Antecedent::STATUS_ACTIVE);
    ...
    public function postSave()
    {
        try {
            ...
            if ($attributesPost[$model->getTable()  . '_id'] == '') { //Create
                ...
                $model = Antecedent::find($attributesPost[$model->getTable() . '_id']);
