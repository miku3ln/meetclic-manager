...
class DentalPieceController extends MyBaseController
{
    ...
    public $name_manager = "Piezas Dental";

    public function index()
    {
        $model = new DentalPiece();
...
//Change
    public function getListDentalPieces()
    {
        $data = Request::all();
        $query = DentalPiece::query();
    ...
    public function getFormDentalPiece($id = null)
    {
        $method = 'POST';
        $model = isset($id) ? DentalPiece::find($id) : new DentalPiece();
        $camerCase = $model->getCamelCase();
    ...
    {
        $data = Request::all();
        $query = DentalPiece::query()->select('id', 'name as text');
    ...
    public function postSave()
    {
        ...
        try {
            ...
            if ($attributesPost[$model->getTable() . '_id'] == '') { //Create
                ...
                $model = DentalPiece::find($attributesPost[$model->getTable() . '_id']);
