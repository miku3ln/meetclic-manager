...
class ProductSubcategoryController extends MyBaseController
{
    ...
    public function getManager()
    {
        $model = new ProductSubcategory();
        $moduleMain = 'products';
        $moduleResource = 'productSubcategory';
    ...
    public function getListSelect2Config()
    {

        $attributesPost = Request::all();
        $model = new  \App\Models\ProductSubcategory();
        $result = $model->getListSelect2Config($attributesPost);
        return Response::json($result);
    }
}
