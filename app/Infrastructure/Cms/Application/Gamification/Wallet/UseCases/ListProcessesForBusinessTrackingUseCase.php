...
use App\Infrastructure\Cms\Application\Gamification\Wallet\DTOs\ListProcessesInputDTO;
...
final class ListProcessesForBusinessTrackingUseCase
{
    public function __construct(
        private readonly ProcessReadPort $processRead
    ) {}

    public function execute(ListProcessesInputDTO $dto): SimpleResultDTO
    {
        ...
        if ($dto->campaignCode == null) return SimpleResultDTO::fail("campaignCode inválido.");
