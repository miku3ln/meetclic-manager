...
class AccountingConfigModulesTypes extends  ModelManager
{
const STATE_ACTIVE = 'ACTIVE';
const STATE_INACTIVE = 'INACTIVE';
protected $table='accounting_config_modules_types';
...
DB::beginTransaction();
try {
$modelName= 'AccountingConfigModulesTypes';
$model = new AccountingConfigModulesTypes();
$createUpdate = true;
if (isset($attributesPost[$modelName]["id"]) && $attributesPost[$modelName]["id"] != "null" && $attributesPost[$modelName]["id"] != "-1") {
$model = AccountingConfigModulesTypes::find($attributesPost[$modelName]['id']);
$createUpdate = false;
} else {
$createUpdate = true;
...
$accountingConfigModulesTypesData = $attributesPost[$modelName];
$attributesSet = $this->getValuesModel(array('fillAble'=>$this->fillable,'haystack'=>$accountingConfigModulesTypesData,'attributesData'=>$this->attributesData));
...
$success = false;
$msj = "Problemas al guardar  AccountingConfigModulesTypes.";
