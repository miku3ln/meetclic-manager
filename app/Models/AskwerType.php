...
class AskwerType extends  ModelManager
{
const STATE_ACTIVE = 'ACTIVE';
const STATE_INACTIVE = 'INACTIVE';
protected $table='askwer_type';
...
DB::beginTransaction();
try {
$modelName= 'AskwerType';
$model = new AskwerType();
$createUpdate = true;
if (isset($attributesPost[$modelName]["id"]) && $attributesPost[$modelName]["id"] != "null" && $attributesPost[$modelName]["id"] != "-1") {
$model = AskwerType::find($attributesPost[$modelName]['id']);
$createUpdate = false;
} else {
$createUpdate = true;
...
$askwerTypeData = $attributesPost[$modelName];
$attributesSet = $this->getValuesModel(array('fillAble'=>$this->fillable,'haystack'=>$askwerTypeData,'attributesData'=>$this->attributesData));
...
$success = false;
$msj = "Problemas al guardar  AskwerType.";
