...
class Bank extends ModelManager
{
...
// Pagination: $perpage 0; get all data
    ...
    public function saveData($params)
    {
        ...
        try {
            ...
            if (isset($attributesPost[$modelName]["id"]) && $attributesPost[$modelName]["id"] != "null" && $attributesPost[$modelName]["id"] != "-1") {
                $model = Bank::find($attributesPost[$modelName]['id']);
                $createUpdate = false;
            } else {
                $createUpdate = true;
            }
            ...
            $bankData = $attributesPost[$modelName];
            $attributesSet = $this->getValuesModel(array('fillAble' => $this->fillable, 'haystack' => $bankData, 'attributesData' => $this->attributesData));
    ...
    public function getListBank($params = [])
    {
        ...
        $status = isset($params['filters']['status']) ? $params['filters']['status'] : self::STATE_ACTIVE;
