...
class BusinessAcademicOfferingsByData extends ModelManager
{
    const STATE_ACTIVE = 'ACTIVE';
    const STATE_INACTIVE = 'INACTIVE';
    protected $table = 'business_academic_offerings_by_data';
    ...
    protected $fillable = array(
        ...
        'source',
        'allow_source',//*
        'business_by_academic_offerings_id',//*
        'title_icon',
        'link'
    ...
    protected $attributesData = [
        ...
        ['column' => 'business_by_academic_offerings_id', 'type' => 'integer', 'defaultValue' => '', 'required' => 'true'],
        ['column' => 'title_icon', 'type' => 'string', 'defaultValue' => '', 'required' => 'false'],
        ['column' => 'link', 'type' => 'string', 'defaultValue' => '', 'required' => 'true'],
    ...
    public static function getRulesModel()
    {
        $rules = ["title" => "required",
            ...
            "business_by_academic_offerings_id" => "required|numeric",
            "title_icon" => "max:15",
            "link" => "required|max:125",
    ...
    public function getAdmin($params)
    {
        ...
        $selectString = "$this->table.id,$this->table.link,$this->table.title,$this->table.description,$this->table.status,$this->table.source,$this->table.allow_source,business_by_academic_offerings.value as business_by_academic_offerings,
...
// Pagination: $perpage 0; get all data
    ...
    public function saveData($params)
    {
        ...
        try {
            ...
            $BusinessAcademicOfferingsByDataData = $attributesPost;


            $modelMultimedia = new Multimedia;
            $business_by_academic_offerings_id = $attributesPost["business_by_academic_offerings_id"];
            ...
            if ($successMultimedia) {
                ...
                $source = $allow_source == 1 ? $currentResource . $successMultimediaModel['source'] : $BusinessAcademicOfferingsByDataData['source'];

                $BusinessAcademicOfferingsByDataData['source'] = $source;

                $attributesSet = $this->getValuesModel(array('fillAble' => $this->fillable, 'haystack' => $BusinessAcademicOfferingsByDataData, 'attributesData' => $this->attributesData));
                ...
                if ($success) {
                    ...
                    $success = false;
                    $msj = "Problemas al guardar  BusinessAcademicOfferingsByData.";
