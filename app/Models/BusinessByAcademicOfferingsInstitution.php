...
class BusinessByAcademicOfferingsInstitution extends ModelManager
{
    const STATE_ACTIVE = 'ACTIVE';
    const STATE_INACTIVE = 'INACTIVE';
    protected $table = 'business_by_academic_offerings_institution';
...
$this->table.source,$this->table.allow_source,$this->table.subtitle";
    ...
    public function saveData($params)
    {
        ...
        DB::beginTransaction();
        try {
            $modelName = 'BusinessByAcademicOfferingsInstitution';
            ...
            if (isset($attributesPost["id"]) && $attributesPost["id"] != "null" && $attributesPost["id"] != "-1") {
                $model = BusinessByAcademicOfferingsInstitution::find($attributesPost['id']);
                $createUpdate = false;
            ...
            if ($allow_source == 1) {
                ...
                $pathSet = "/uploads/web/BusinessByAcademicOfferingsInstitution/images";
            ...
            if ($successMultimedia) {
                ...
                if ($success) {
                    ...
                    $success = false;
                    $msj = "Problemas al guardar  BusinessByAcademicOfferingsInstitution.";
