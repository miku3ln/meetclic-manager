...
class BusinessByFrequentQuestion extends ModelManager
{
    const STATE_ACTIVE = 'ACTIVE';
    const STATE_INACTIVE = 'INACTIVE';
    protected $table = 'business_by_frequent_question';
...
business.id as business_id";
    ...
    public function saveData($params)
    {
        ...
        try {
            ...
            $BusinessByFrequentQuestionData = $attributesPost;
            ...
            if ($successMultimedia) {
                ...
                $attributesSet = $this->getValuesModel(array('fillAble' => $this->fillable, 'haystack' => $BusinessByFrequentQuestionData, 'attributesData' => $this->attributesData));
                ...
                if ($success) {
                    ...
                    $success = false;
                    $msj = "Problemas al guardar  BusinessByFrequentQuestion.";
