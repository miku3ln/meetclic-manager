...
class BusinessByInformationCustom extends ModelManager
{
    const STATE_ACTIVE = 'ACTIVE';
    const STATE_INACTIVE = 'INACTIVE';
    protected $table = 'business_by_information_custom';
...
$this->table.source,$this->table.allow_source,$this->table.subtitle";
    ...
    public function saveData($params)
    {
        ...
        DB::beginTransaction();
        try {
            $modelName = 'BusinessByInformationCustom';
            $model = new BusinessByInformationCustom();
            $createUpdate = true;
            $auxResource = "";
            $modelMultimedia = new Multimedia;

            if (isset($attributesPost["id"]) && $attributesPost["id"] != "null" && $attributesPost["id"] != "-1") {
                $model = BusinessByInformationCustom::find($attributesPost['id']);
                $createUpdate = false;
            ...
            $BusinessByInformationCustomData = $attributesPost;
            ...
            if ($allow_source == 1) {
                ...
                $pathSet = "/uploads/web/BusinessByInformationCustom/images";
            ...
            if ($successMultimedia) {
                ...
                $source = $allow_source == 1 ? $currentResource . $successMultimediaModel['source'] : $BusinessByInformationCustomData['source'];


                $BusinessByInformationCustomData['source'] = $source;

                $attributesSet = $this->getValuesModel(array('fillAble' => $this->fillable, 'haystack' => $BusinessByInformationCustomData, 'attributesData' => $this->attributesData));
                ...
                if ($success) {
                    ...
                    $success = false;
                    $msj = "Problemas al guardar  BusinessByInformationCustom.";
