...
class BusinessByMenuManagementFrontend extends Model
{
    /**
    ...
    protected $table = 'business_by_menu_management_frontend';
    /*
   ...
   ";
    ...
    public function saveData($params)
    {
        ...
        try {
            ...
            $model = new BusinessByMenuManagementFrontend();
            $createUpdate = true;
            if (isset($attributesPost["BusinessByMenuManagementFrontend"]["id"]) && $attributesPost["BusinessByMenuManagementFrontend"]["id"] != "null" && $attributesPost["BusinessByMenuManagementFrontend"]["id"] != "-1") {
                $model = BusinessByMenuManagementFrontend::find($attributesPost["BusinessByMenuManagementFrontend"]['id']);
                $createUpdate = false;
            } else {
                $createUpdate = true;

            }
            $postData = $attributesPost["BusinessByMenuManagementFrontend"];
            $attributesSet = array(
                "name" => $postData["name"],
                "link" => $postData["link"] ,
            ...
            $validateResult = BusinessByMenuManagementFrontend::validateModel($attributesSet);
    ...
    public function getAdminMenuBusiness($params)
    {
        ...
        $selectString = "$this->table.id ,$this->table.name,$this->table.name title ,$this->table.type_item,$this->table.link,$this->table.parent_id,$this->table.weight,$this->table.icon,$this->table.type,$this->table.description,$conditionText
   ";
        $select = DB::raw($selectString);
        $query->select($select);
        $business_id = null;
