...
class BusinessByPartnerCompanies extends ModelManager
{
    const STATE_ACTIVE = 'ACTIVE';
    const STATE_INACTIVE = 'INACTIVE';
    protected $table = 'business_by_partner_companies';
...
// Pagination: $perpage 0; get all data
    ...
    public function saveData($params)
    {
        ...
        DB::beginTransaction();
        try {
            $modelName = 'BusinessByPartnerCompanies';
            $model = new BusinessByPartnerCompanies();
            $createUpdate = true;
            $auxResource = "";
            $modelMultimedia = new Multimedia;

            if (isset($attributesPost["id"]) && $attributesPost["id"] != "null" && $attributesPost["id"] != "-1") {
                $model = BusinessByPartnerCompanies::find($attributesPost['id']);
                $createUpdate = false;
            ...
            $BusinessByPartnerCompaniesData = $attributesPost;
            ...
            if ($allow_source == 1) {
                ...
                $pathSet = "/uploads/web/BusinessByPartnerCompanies/images";
            ...
            if ($successMultimedia) {
                ...
                $source = $allow_source == 1 ? $currentResource . $successMultimediaModel['source'] : $BusinessByPartnerCompaniesData['source'];


                $BusinessByPartnerCompaniesData['source'] = $source;

                $attributesSet = $this->getValuesModel(array('fillAble' => $this->fillable, 'haystack' => $BusinessByPartnerCompaniesData, 'attributesData' => $this->attributesData));
                ...
                if ($success) {
                    ...
                    $success = false;
                    $msj = "Problemas al guardar  BusinessByPartnerCompanies.";
