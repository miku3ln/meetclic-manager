...
class ClinicalExam extends Model
{
    ...
    public function getActionsManager()
    {
        ...
        $action_get_form =  "Hospital" . "'\'" . $model_entity . "Controller" . "@getForm" . $model_entity;
        $action_get_form = str_replace("'", "", $action_get_form);
        $action_save =  "Hospital" . "'\'" . $model_entity . "Controller" . "@postSave";
        $action_save = str_replace("'", "", $action_save);
        $action_load =  "Hospital" . "'\'" . $model_entity . "Controller" . "@getList" . $model_entity . "s";
