...
class CounterByLogUserToBusiness extends ModelManager
{
    const STATE_ACTIVE = 'ACTIVE';
    const STATE_INACTIVE = 'INACTIVE';
    protected $table = 'counter_by_log_user_to_business';
    ...
    public function getAdmin($params)
    {
        ...
        $selectString = "$this->table.id,$this->table.created_at,$this->table.updated_at,$this->table.deleted_at,business.title as business,
business.id as business_id,
$this->table.user_id,$this->table.is_guess";
...
// Pagination: $perpage 0; get all data
    ...
    public function saveData($params)
    {
        ...
        DB::beginTransaction();
        try {
            $modelName = 'CounterByLogUserToBusiness';
            $model = new CounterByLogUserToBusiness();
            $createUpdate = true;

            $counterByLogUserToBusinessData = $attributesPost[$modelName];
            $attributesSet = $counterByLogUserToBusinessData;
            ...
            if ($success) {
                ...
                $success = false;
                $msj = "Problemas al guardar  CounterByLogUserToBusiness.";
