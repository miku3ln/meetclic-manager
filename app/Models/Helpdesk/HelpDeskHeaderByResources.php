...
use App\Models\Projects\Auth;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Validator;

class HelpDeskHeaderByResources extends ModelManager
{


    protected $table = 'help_desk_header_by_resources';
    protected $nameModel = 'HelpDeskHeaderByResources';
    ...
    public static function getRulesModel()
    {
        $rules = [
            ...
            "status" => 'required',
            "project_header_id" => 'required',

        ];
        return $rules;
    }

    public static $selection = 'url,type_multimedia,description,status,project_header_id';
    ...
    public function getAdmin($params)
    {
        ...
        $selectString = "$this->table.id,$this->table.url,$this->table.type_multimedia,$this->table.description,$this->table.status,$this->table.project_header_id";
        ...
        $query->where($this->table . '.project_header_id', '=', $manager_parent_id);
    ...
    public function saveData($params)
    {
        ...
        try {
            ...
            if ($type_multimedia == HelpDeskHeaderByResources::TYPE_IMAGE_UPLOAD) {
                $type = 'image';
                $allowUpload = true;
            } else if ($type_multimedia == HelpDeskHeaderByResources::TYPE_URL_OTHER_SERVER) {
                $url = $urlManager;
                $allowUpload = false;
                $type = 'none';


            } else if ($type_multimedia == HelpDeskHeaderByResources::TYPE_FILE) {
                $url = $urlManager;
                $allowUpload = true;
                $type = 'docs';
            ...
            if ($allowUpload) {
                ...
                $source = $postData["url"];
                $pathSet = "/uploads/helpDesk/HelpDeskHeaderByResources";
            ...
            if ($successMultimedia) {
                ...
                $attributes = array(
                    ...
                    "project_header_id" => $postData["project_header_id"],
