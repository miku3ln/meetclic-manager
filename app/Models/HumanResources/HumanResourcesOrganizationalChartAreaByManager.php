...
class HumanResourcesOrganizationalChartAreaByManager extends ModelManager
{
    protected $nameModel = 'HumanResourcesOrganizationalChartAreaByManager';


    protected $table = 'human_resources_organizational_chart_area_by_manager';
    /*
    ...
    public static $selection = 'human_resources_employee_profile_id,human_resources_organizational_chart_area_id';
    ...
    public function getResponsible($params)
    {
        ...
        $selectString = "$this->table.id,$this->table.human_resources_organizational_chart_area_id,$this->table.human_resources_employee_profile_id,$this->table.type_manager,$this->table.range
    ...
    public function saveData($params)
    {
        ...
        try {
            ...
            if (isset($attributesPost[$this->nameModel]["id"]) && $attributesPost[$this->nameModel]["id"] != "null" && $attributesPost[$this->nameModel]["id"] != "-1") {
                $model = HumanResourcesOrganizationalChartAreaByManager::find($attributesPost[$this->nameModel]['id']);
                $createUpdate = false;
            } else {
                $createUpdate = true;
