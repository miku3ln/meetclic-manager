...
class InformationPhoneType extends ModelManager
{
    const STATE_ACTIVE = 'ACTIVE';
    const STATE_INACTIVE = 'INACTIVE';
    protected $table = 'information_phone_type';
    const TYPE_NOT_SPECIFIC_ID = 1;
    const TYPE_WORKING_ID = 2;
    const TYPE_HOUSE_ID = 3;
    const TYPE_WORKFORCE_ID = 4;
    const TYPE_PERSONAL_PHONE_ID = 4;
...
// Pagination: $perpage 0; get all data
    ...
    public function saveData($params)
    {
        ...
        DB::beginTransaction();
        try {
            $modelName = 'InformationPhoneType';
            $model = new InformationPhoneType();
            $createUpdate = true;
            if (isset($attributesPost[$modelName]["id"]) && $attributesPost[$modelName]["id"] != "null" && $attributesPost[$modelName]["id"] != "-1") {
                $model = InformationPhoneType::find($attributesPost[$modelName]['id']);
                $createUpdate = false;
            } else {
                $createUpdate = true;
            ...
            $informationPhoneTypeData = $attributesPost[$modelName];
            $attributesSet = $this->getValuesModel(array('fillAble' => $this->fillable, 'haystack' => $informationPhoneTypeData, 'attributesData' => $this->attributesData));
            ...
            if ($success) {
                ...
                $success = false;
                $msj = "Problemas al guardar  InformationPhoneType.";
