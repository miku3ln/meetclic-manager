...
class InitialStatusProduct extends  ModelManager
{
const STATE_ACTIVE = 'ACTIVE';
const STATE_INACTIVE = 'INACTIVE';
protected $table='initial_status_product';
...
['column'=>'amount','type'=>'double','defaultValue'=>'','required'=>'true'],
...
$selectString = "$this->table.id,$this->table.amount,$this->table.value,$this->table.created_at,product.code as product,
...
DB::beginTransaction();
try {
$modelName= 'InitialStatusProduct';
$model = new InitialStatusProduct();
$createUpdate = true;

    if (isset($attributesPost[$modelName]["id"]) && $attributesPost[$modelName]["id"] != "null" && $attributesPost[$modelName]["id"] != "-1") {
    $model = InitialStatusProduct::find($attributesPost[$modelName]['id']);
    $createUpdate = false;
    } else {
    $createUpdate = true;
    }
    ...
    $initialStatusProductData = $attributesPost[$modelName];
    $attributesSet = $this->getValuesModel(array('fillAble'=>$this->fillable,'haystack'=>$initialStatusProductData,'attributesData'=>$this->attributesData));
    ...
    $success = false;
    $msj = "Problemas al guardar  InitialStatusProduct.";
