...
class LanguageTemplateAboutUs extends ModelManager
{
    const STATE_ACTIVE = 'ACTIVE';
    const STATE_INACTIVE = 'INACTIVE';
    protected $table = 'language_template_about_us';
...
template_about_us.value as template_about_us,
...
";
        ...
        $entity_name = 'template_about_us_id';
...
// Pagination: $perpage 0; get all data
    ...
    public function saveData($params)
    {
        ...
        DB::beginTransaction();
        try {
            $modelName = 'LanguageTemplateAboutUs';
            $model = new LanguageTemplateAboutUs();
            $createUpdate = true;

            if (isset($attributesPost[$modelName]["id"]) && $attributesPost[$modelName]["id"] != "null" && $attributesPost[$modelName]["id"] != "-1") {
                $model = LanguageTemplateAboutUs::find($attributesPost[$modelName]['id']);
                $createUpdate = false;
            } else {
                $createUpdate = true;
            }
            ...
            $languageTemplateAboutUsData = $attributesPost[$modelName];
            $attributesSet = $this->getValuesModel(array('fillAble' => $this->fillable, 'haystack' => $languageTemplateAboutUsData, 'attributesData' => $this->attributesData));
            ...
            $entity_manager_key = 'template_about_us_id';
            $entity_manager_id = $attributesPost[$modelName]['template_about_us_id'];
            ...
            if ($success) {
                ...
                if ($attributesSet['state'] == 'ACTIVE') {
                    if (isset($attributesPost[$modelName]["id"]) && $attributesPost[$modelName]["id"] != "null" && $attributesPost[$modelName]["id"] != "-1") {
                        ...
                        LanguageTemplateAboutUs::where('state', 'ACTIVE')
                ...
                $success = false;
                $msj = "Problemas al guardar  LanguageTemplateAboutUs.";
    ...
    public function setDelete($params)
    {
        ...
        DB::beginTransaction();
        try {
            $model = LanguageTemplateAboutUs::find($id);
            if ($model) {
