...
class LodgingRoomLevels extends Model
{
    ...
    protected $table = 'lodging_room_levels';
...
/*MANAGER MAINS*/
    public function saveData($params)
    {
        ...
        try {
            ...
            $createUpdate = true;
            if (isset($attributesPost["LodgingRoomLevels"]["id"]) && $attributesPost["LodgingRoomLevels"]["id"] != "null" && $attributesPost["LodgingRoomLevels"]["id"] != "-1") {
                $model = LodgingRoomLevels::find($attributesPost["LodgingRoomLevels"]['id']);
                $createUpdate = false;
            } else {
                $createUpdate = true;
            ...
            $lodgingData = $attributesPost["LodgingRoomLevels"];
            $attributesSet = array(
            ...
            $business_id = $lodgingData["business_id"];
            $validateResult = LodgingRoomLevels::validateModel($attributesSet);
            ...
            if ($success) {
                ...
                $lodgingRoomLevels = self::getDataListAll(array("business_id" => $business_id));
                ...
                $success = false;
                $msj = "Problemas al guardar LodgingRoomLevels.";
