...
class MikrotikRateLimit extends ModelManager
{
    const STATE_ACTIVE = 'ACTIVE';
    const STATE_INACTIVE = 'INACTIVE';
    protected $table = 'mikrotik_rate_limit';
    ...
    public function getAdmin($params)
    {
        ...
        $selectString = "$this->table.id,$this->table.name,$this->table.business_id,$this->table.state";
    ...
    public function saveData($params)
    {
        ...
        try {
            ...
            if (isset($attributesPost[$modelName]["id"]) && $attributesPost[$modelName]["id"] != "null" && $attributesPost[$modelName]["id"] != "-1") {
                $model = MikrotikRateLimit::find($attributesPost[$modelName]['id']);
                $createUpdate = false;
            } else {
                $createUpdate = true;
            }
            ...
            $mikrotikRateLimitData = $attributesPost[$modelName];
            $attributesSet = $this->getValuesModel(array('fillAble' => $this->fillable, 'haystack' => $mikrotikRateLimitData, 'attributesData' => $this->attributesData));
            ...
            if ($success) {
                ...
                $success = false;
                $msj = "Problemas al guardar  MikrotikRateLimit.";
