...
class OrderShoppingByDelivery extends ModelManager
{
    const STATE_ACTIVE = 'ACTIVE';
    const STATE_INACTIVE = 'INACTIVE';
    protected $table = 'order_shopping_by_delivery';
    ...
    public static function getRulesModel()
    {
        $rules = ["people_id" => "required|numeric",
            ...
            "user_id" => "numeric",
            "order_shopping_cart_id" => "numeric",
            "document" => "required",
...
// Pagination: $perpage 0; get all data
    ...
    public function saveDataOrderShipping($params)
    {
        ...
        try {
            $modelName = 'OrderShoppingByDelivery';
            $model = new OrderShoppingByDelivery();
            ...
            if ($success) {
                ...
                $success = false;
                $msj = "Problemas al guardar  OrderShoppingByDelivery.";
    ...
    public function getDelivery($params)
    {
        ...
        $selectString = "$this->table.id,$this->table.people_id,$this->table.payer_email,$this->table.company,$this->table.address_secondary,$this->table.city,$this->table.state_province_id,$this->table.zipcode,$this->table.country_id,$this->table.user_id,$this->table.phone,$this->table.address_main,$this->table.document,$this->table.order_shopping_cart_id
        ...
        $query->select($select);
        $query->join('people', 'people.id', '=', $this->table . '.people_id');
        $query->join('provinces', 'provinces.id', '=', $this->table . '.state_province_id');
        $query->join('countries', 'countries.id', '=', $this->table . '.country_id');
