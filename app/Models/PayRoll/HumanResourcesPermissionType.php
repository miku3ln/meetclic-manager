...
class HumanResourcesPermissionType extends ModelManager
{

    protected $table = 'human_resources_permission_type';
    protected $primaryKey = 'id';
    public $timestamps = false;
    public $modelName = 'HumanResourcesPermissionType';
