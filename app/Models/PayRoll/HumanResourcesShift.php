...
class HumanResourcesShift extends ModelManager
{

    protected $table = 'human_resources_shift';
    ...
    public static function getRulesModel()
    {
        return [
            ...
            "code" => 'required',
            "status" => 'required',
            "pay_overtime" => 'required',
            "entry_time" => 'required',
            "departure_time" => 'required',
            "entry_time_break" => 'required',
            "departure_time_break" => 'required',
    ...
    public function saveData($params)
    {
        ...
        try {
            ...
            if (isset($attributesPost[$this->modelName]["id"]) && $attributesPost[$this->modelName]["id"] != "null" && $attributesPost[$this->modelName]["id"] != "-1") {
                $model = humanResourcesShift::find($attributesPost[$this->modelName]['id']);
                $createUpdate = false;
            } else {
                $createUpdate = true;
            }
