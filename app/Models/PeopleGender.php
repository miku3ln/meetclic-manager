...
class PeopleGender extends ModelManager
{
    const STATE_ACTIVE = 'ACTIVE';
    const STATE_INACTIVE = 'INACTIVE';
    protected $table = 'people_gender';
    const GENDER_MALE_ID = 1;
    const GENDER_FEMALE_ID = 2;
    const GENDER_LGBTI_ID = 3;
    const GENDER_MEN = 0;
    const GENDER_FEMALE= 1;
    const GENDER_FEMALE_LGBTI= 2;
    const GENDER_FEMALE_OTHERS= 3;

    public static function getAllGenders()
    {

        $result = array(
            self::GENDER_MALE_ID => 'Masculino',
            self::GENDER_FEMALE_ID => 'Femenino',
            self::GENDER_LGBTI_ID => 'LGBTI',
...
// Pagination: $perpage 0; get all data
    ...
    public function saveData($params)
    {
        ...
        try {
            ...
            if (isset($attributesPost[$modelName]["id"]) && $attributesPost[$modelName]["id"] != "null" && $attributesPost[$modelName]["id"] != "-1") {
                $model = PeopleGender::find($attributesPost[$modelName]['id']);
                $createUpdate = false;
            } else {
                $createUpdate = true;
            ...
            $peopleGenderData = $attributesPost[$modelName];
            $attributesSet = $this->getValuesModel(array('fillAble' => $this->fillable, 'haystack' => $peopleGenderData, 'attributesData' => $this->attributesData));
            ...
            if ($success) {
                ...
                $success = false;
                $msj = "Problemas al guardar  PeopleGender.";
    ...
    public function saveDataWeb($params)
    {
        $success = false;
        $msj = "";
        $result = array();
        ...
        try {
            ...
            if (isset($attributesPost["id"]) && $attributesPost["id"] != "null" && $attributesPost["id"] != "-1") {
                $model = PeopleGender::find($attributesPost['id']);
                $createUpdate = false;
            } else {
                $createUpdate = true;
