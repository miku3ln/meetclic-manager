...
class ProductIceTypes extends  ModelManager
{
const STATE_ACTIVE = 'ACTIVE';
const STATE_INACTIVE = 'INACTIVE';
protected $table='product_ice_types';
...
DB::beginTransaction();
try {
$modelName= 'ProductIceTypes';
$model = new ProductIceTypes();
$createUpdate = true;

    if (isset($attributesPost[$modelName]["id"]) && $attributesPost[$modelName]["id"] != "null" && $attributesPost[$modelName]["id"] != "-1") {
    $model = ProductIceTypes::find($attributesPost[$modelName]['id']);
    $createUpdate = false;
    } else {
    $createUpdate = true;
    }
    ...
    $productIceTypesData = $attributesPost[$modelName];
    $attributesSet = $this->getValuesModel(array('fillAble'=>$this->fillable,'haystack'=>$productIceTypesData,'attributesData'=>$this->attributesData));
    ...
    $success = false;
    $msj = "Problemas al guardar  ProductIceTypes.";
