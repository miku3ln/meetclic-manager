...
class ProjectHeader extends ModelManager
{


    protected $table = 'project_header';
    protected $nameModel = 'ProjectHeader';
    ...
    public static $selection = 'name,description,status,predetermined,year,business_id,user_id,contractor_company_name,responsible_company_name,help_desk_human_resources_employee_profile_id,
    administrator_human_resources_employee_profile_id,countries_id';
    ...
    public function getAdmin($params)
    {
        ...
        $selectString = "$this->table.id,$this->table.name,$this->table.description,$this->table.status,$this->table.predetermined,$this->table.year,$this->table.business_id,$this->table.user_id,$this->table.contractor_company_name,$this->table.responsible_company_name,$this->table.help_desk_human_resources_employee_profile_id
    ,$this->table.administrator_human_resources_employee_profile_id,$this->table.countries_id
    ...
    ,countries.name countries_name" ;
        ...
        $query->join($relationThree,$this->table.'.countries_id','=',$relationThree.'.id');
    ...
    public function saveData($params)
    {
        ...
        try {
            ...
            if (isset($attributesPost[$this->nameModel]["id"]) && $attributesPost[$this->nameModel]["id"] != "null" && $attributesPost[$this->nameModel]["id"] != "-1") {
                $model = ProjectHeader::find($attributesPost[$this->nameModel]['id']);
                $createUpdate = false;
            } else {
                $createUpdate = true;
            ...
            $attributes = array(
                ...
                "user_id" => $user->id,
                "contractor_company_name" => $postData["contractor_company_name"],
                "responsible_company_name" => $postData["responsible_company_name"],
