...
class TemplateAboutUs extends ModelManager
{
    const STATE_ACTIVE = 'ACTIVE';
    const STATE_INACTIVE = 'INACTIVE';
    protected $table = 'template_about_us';
    ...
    public function getAdmin($params)
    {
        ...
        $selectString = "$this->table.id,$this->table.subtitle,$this->table.value,$this->table.description,$this->table.status,template_information.value as template_information,
...
// Pagination: $perpage 0; get all data
    ...
    public function saveData($params)
    {
        ...
        try {
            ...
            $templateAboutUsData = $attributesPost;
            ...
            if ($allow_source == 1) {
                ...
                $pathSet = "/uploads/web/about-us/images";
            ...
            if ($successMultimedia) {
                ...
                $source = $allow_source == 1 ? $currentResource. $successMultimediaModel['source'] : $templateAboutUsData['source'];


                $templateAboutUsData['source'] = $source;
                $attributesSet = $this->getValuesModel(array('fillAble' => $this->fillable, 'haystack' => $templateAboutUsData, 'attributesData' => $this->attributesData));
                ...
                if ($success) {
                    ...
                    if ($attributesSet['status'] == 'ACTIVE') {
                        if (isset($attributesPost["id"]) && $attributesPost["id"] != "null" && $attributesPost["id"] != "-1") {
                            ...
                            TemplateAboutUs::where('status', 'ACTIVE')
                    ...
                    $success = false;
                    $msj = "Problemas al guardar  TemplateAboutUs.";
    ...
    public function getAboutUsFrontend($params)
    {
        $textValue = $this->table . '.' . $this->field_main;
        $template_information_id=$params['filters']['template_information_id'];
        ...
        $relationLanguage = 'language_template_about_us';
        $relationLanguageId = 'template_about_us_id';
