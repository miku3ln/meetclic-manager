...
class TemplateWishListByUser extends ModelManager
{
    const STATE_ACTIVE = 'ACTIVE';
    const STATE_INACTIVE = 'INACTIVE';
    protected $table = 'template_wish_list_by_user';
    ...
    public function getAdmin($params)
    {
        ...
        $selectString = "$this->table.id,$this->table.status,$this->table.created_at,$this->table.updated_at,$this->table.deleted_at,template_information.value as template_information,
...
// Pagination: $perpage 0; get all data
    ...
    public function saveData($params)
    {
        ...
        try {
            ...
            if (isset($attributesPost[$modelName]["id"]) && $attributesPost[$modelName]["id"] != "null" && $attributesPost[$modelName]["id"] != "-1") {
                $model = TemplateWishListByUser::find($attributesPost[$modelName]['id']);
                $createUpdate = false;
            } else {
                $createUpdate = true;
            }
            ...
            $attributesSet = $this->getValuesModel(array('fillAble' => $this->fillable, 'haystack' => $templateWishListByUserData, 'attributesData' => $this->attributesData));
            ...
            if ($success) {
                ...
                $success = false;
                $msj = "Problemas al guardar  TemplateWishListByUser.";
    ...
    public function getProductWishList($params)
    {
    ...
    public function getProductsWishListCount($params)
    {
