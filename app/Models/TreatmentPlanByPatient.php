...
class TreatmentPlanByPatient extends Model
{
     ...
     * @var string
     */
    protected $table = 'treatment_plan_by_patient';

    protected $fillable = array("patient_id", "status", "treatment_plan_id", "total_price", "tax", "subtotal", "discount", "doctor_id");
    ...
    public function getColumnsNameAdmin()
    {
        $result = array(
            ...
            array(
                "data-column-id" => "treatment_plan_name",
                "data-formatter"=>"treatment_plan_name",
                "text"=>"Nombre Plan",
            ),
            array(
    ...
    function getDataObjFormManagement($treatment_plan_by_patient_id)
    {
        $result = array();
        ...
        if ($treatment_plan_by_patient_id) {//UPDATE
            ...
            $result["modelTDBT"] = $modelTDBT;
            $result["model"] = $modelTDBT;
