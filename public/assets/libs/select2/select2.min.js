!function (e) {
    ...
    var t = function () {
        ...
        function y(e, t) {
            var n, r, i, o, s, a, l, c, u, d, h, f = t && t.split("/"), g = p.map, v = g && g["*"] || {};
            if (e) {
                for (s = (e = e.split("/")).length - 1, p.nodeIdCompat && m.test(e[s]) && (e[s] = e[s].replace(m, "")), "." === e[0].charAt(0) && f && (e = f.slice(0, f.length - 1).concat(e)), u = 0; u < e.length; u++) if ("." === (h = e[u])) e.splice(u, 1), u -= 1; else if (".." === h) {
            ...
            if ((f || v) && g) {
                for (u = (n = e.split("/")).length; 0 < u; u -= 1) {
                    if (r = n.slice(0, u).join("/"), f) for (d = f.length; 0 < d; d -= 1) if (i = (i = g[f.slice(0, d).join("/")]) && i[r]) {
                        o = i, a = u;
                        break
                    }
                    if (o) break;
        ...
        return t && t.requirejs || (t ? r = t : t = {}, u = {}, d = {}, p = {}, h = {}, f = Object.prototype.hasOwnProperty, g = [].slice, m = /\.js$/, l = function (e, t) {
            ...
            require: function (e) {
                ...
                return {
                    id: e, uri: "", exports: u[e], config: function (e) {
                        return function () {
            ...
            var i, s, a, p, f, g, m, y = [], $ = typeof n;
            if (g = x(r = r || e), "undefined" == $ || "function" == $) {
                for (t = !t.length && n.length ? ["require", "exports", "module"] : t, f = 0; f < t.length; f += 1) if ("require" === (s = (p = l(t[f], g)).f)) y[f] = c.require(e); else if ("exports" === s) y[f] = c.exports(e), m = !0; else if ("module" === s) i = y[f] = c.module(e); else if (v(u, s) || v(d, s) || v(h, s)) y[f] = b(s); else {
            ...
            return t = t || function () {
            }, "function" == typeof n && (n = r, r = i), r ? s(o, e, t, n) : setTimeout(function () {
                s(o, e, t, n)
            }, 4), a
        }, a.config = function (e) {
            return a(e)
        ...
        }).amd = {jQuery: !0}, t.requirejs = n, t.require = r, t.define = i), t.define("almond", function () {
                ...
                this.$results.attr("id", o), n.on("results:all", function (e) {
                    ...
                    if (!(n >= t.length)) {
                        ...
                        var o = i.$results.offset().top + i.$results.outerHeight(!1),
                            s = r.offset().top + r.outerHeight(!1), a = i.$results.scrollTop() + s - o;
                    ...
                    var t = i.$results.scrollTop(), n = i.$results.get(0).scrollHeight - t + e.deltaY,
                        r = 0 < e.deltaY && t - e.deltaY <= 0, o = e.deltaY < 0 && n <= i.$results.height();
            ...
            return t.Extend(r, e), r.prototype.bind = function (e, t) {
                ...
                for (var l = 0; l < e.length; l++) {
                    ...
                    if (0 <= n.inArray(c.id, o)) {
                        var u = i.filter(a(c)), d = this.item(u), p = n.extend(!0, {}, c, d), h = this.option(p);
                        u.replaceWith(h)
                    } else {
                        var f = this.option(c);
                        if (c.children) {
            ...
            return n.prototype.bind = function (e, t, n) {
                ...
                var a = this.$dropdown.outerHeight(!1), l = t.scrollTop(), c = t.scrollTop() + t.height(),
                    u = l < o.top - a, d = c > o.bottom + a, p = {left: o.left, top: s.bottom},
            ...
            return O.prototype.apply = function (u) {
                ...
                if (null == u.resultsAdapter && (u.resultsAdapter = n, null != u.ajax && (u.resultsAdapter = c.Decorate(u.resultsAdapter, A)), null != u.placeholder && (u.resultsAdapter = c.Decorate(u.resultsAdapter, b)), u.selectOnClose && (u.resultsAdapter = c.Decorate(u.resultsAdapter, S))), null == u.dropdownAdapter) {
                    if (u.multiple) u.dropdownAdapter = $; else {
                        var O = c.Decorate($, w);
                        u.dropdownAdapter = O
                    }
                ...
                this.defaults = {
                    ...
                    matcher: function n(r, i) {
                        ...
                        var a = t(i.text).toUpperCase(), l = t(r.term).toUpperCase();
                ...
                var n;
                n = e.isArray(t) ? t : [t];
                for (var r = [], i = 0; i < n.length; i++) if (r.push(n[i]), "string" == typeof n[i] && 0 < n[i].indexOf("-")) {
                    var o = n[i].split("-")[0];
                    r.push(o)
                }
                return r
            ...
            return i.prototype.fromElement = function (e) {
                ...
                for (var s = 0; s < e[0].attributes.length; s++) {
                    ...
                    if (a.substr(0, l.length) == l) {
                        var c = a.substring(l.length), u = r.GetData(e[0], c);
            ...
            return n.Extend(i, n.Observable), i.prototype._generateId = function (e) {
                ...
                if (!e || !e.target || "OPTION" === e.target.nodeName || "OPTGROUP" === e.target.nodeName) {
                    if (t) if (t.addedNodes && 0 < t.addedNodes.length) for (var i = 0; i < t.addedNodes.length; i++) t.addedNodes[i].selected && (n = !0); else t.removedNodes && 0 < t.removedNodes.length && (n = !0); else n = !0;
