!function (t) {
    ...
    e.prototype = {
        constructor: e, initInput: function () {
            ...
            var i, s = this.$form.find(".control-group"), n = this.$form.find(".editable-error-block");
            if (!1 === e) s.removeClass(t.fn.editableform.errorGroupClass), n.removeClass(t.fn.editableform.errorBlockClass).empty().hide(); else {
                if (e) {
                    i = ("" + e).split("\n");
            ...
            if ("object" === t.type(s) && void 0 !== s.newValue) {
                if (i = s.newValue, this.input.value2input(i), "string" == typeof s.msg) return this.error(s.msg), void this.showForm()
            } else if (s) return this.error(s), void this.showForm();
            if (this.options.savenochange || this.input.value2str(i) != this.input.value2str(this.value)) {
                var n = this.input.value2submit(i);
                this.isSaving = !0, t.when(this.save(n)).done(t.proxy(function (t) {
                    this.isSaving = !1;
            ...
            var i,
                s = "function" == typeof this.options.pk ? this.options.pk.call(this.options.scope) : this.options.pk;
            return !!("function" == typeof this.options.url || this.options.url && ("always" === this.options.send || "auto" === this.options.send && null != s)) ? (this.showLoading(), i = {
        ...
        return this.each(function () {
            var n = t(this), a = n.data("editableform"), o = "object" == typeof i && i;
    ...
    t.fn.editableutils = {
        inherit: function (t, e) {
            ...
            var a = t.isArray(e), o = [], r = this;
            return t.each(i, function (i, n) {
                if (n.children) o = o.concat(r.itemsByValue(e, n.children, s)); else if (a) t.grep(e, function (t) {
                    return t == (n && "object" == typeof n ? s(n) : n)
                }).length && o.push(n); else {
    ...
    e.prototype = {
        ...
        defaults: {},
        init: function (i, s) {
            this.$element = t(i), this.options = t.extend({}, t.fn.editableContainer.defaults, s), this.splitOptions(), this.formOptions.scope = this.$element[0], this.initContainer(), this.delayedHide = !1, this.$element.on("destroyed", t.proxy(function () {
                this.destroy()
                ...
                if (t.contains(document.documentElement, i.target) && !n.is(document)) {
                    for (s = 0; s < a.length; s++) if (n.is(a[s]) || n.parents(a[s]).length) return;
        ...
        closeOthers: function (e) {
            t(".editable-open").each(function (i, s) {
                if (s !== e && !t(s).find(e).length) {
                    var n = t(s), a = n.data("editableContainer");
        ...
        var n = arguments;
        return this.each(function () {
            var a = t(this), o = "editableContainer", r = a.data(o), l = "object" == typeof s && s,
                h = "inline" === l.mode ? i : e;
    ...
    e.prototype = {
        constructor: e, init: function () {
            ...
            !1 !== this.options.display && (this.isEmpty = void 0 !== e ? e : "function" == typeof this.input.isEmpty ? this.input.isEmpty(this.$element) : "" === t.trim(this.$element.html()), this.options.disabled ? this.isEmpty && (this.$element.empty(), this.options.emptyclass && this.$element.removeClass(this.options.emptyclass)) : this.isEmpty ? (this.$element.html(this.options.emptytext), this.options.emptyclass && this.$element.addClass(this.options.emptyclass)) : this.options.emptyclass && this.$element.removeClass(this.options.emptyclass))
        }, show: function (e) {
            ...
            if (this.options.highlight) {
                var s = this.$element, n = s.css("background-color");
                s.css("background-color", this.options.highlight), setTimeout(function () {
                    "transparent" === n && (n = ""), s.css("background-color", n), s.addClass("editable-bg-transition"), setTimeout(function () {
        ...
        }, setValue: function (e, i, s) {
            this.value = i ? this.input.str2value(e) : e, this.container && this.container.option("value", this.value), t.when(this.render(s)).then(t.proxy(function () {
                this.handleEmpty()
            }, this))
        }, activate: function () {
        ...
        switch (i) {
            ...
            case"submit":
                ...
                if (t.isEmptyObject(l)) {
                    var h = {};
                    if (1 === r.length) {
                        var u = r.data("editable"), p = {
                            name: u.options.name || "",
                            value: u.input.value2submit(u.value),
                            pk: "function" == typeof u.options.pk ? u.options.pk.call(u.options.scope) : u.options.pk
                        };
                        "function" == typeof u.options.params ? p = u.options.params.call(u.options.scope, p) : (u.options.params = t.fn.editableutils.tryParseJson(u.options.params, !0), t.extend(p, u.options.params)), h = {
                            url: u.options.url,
                            data: p,
                            type: "POST"
                        }, o.success = o.success || u.options.success, o.error = o.error || u.options.error
                    } else {
                        var d = this.editable("getValue");
                        h = {url: o.url, data: d, type: "POST"}
                    }
                    h.success = "function" == typeof o.success ? function (t) {
                        o.success.call(r, t, o)
                    } : t.noop, h.error = "function" == typeof o.error ? function () {
                        o.error.apply(r, arguments)
                    } : t.noop, o.ajaxOptions && t.extend(h, o.ajaxOptions), o.data && t.extend(h.data, o.data), t.ajax(h)
                } else "function" == typeof o.error && o.error.call(r, l);
                return this
        }
        return this.each(function () {
            var s = t(this), o = s.data(a), r = "object" == typeof i && i;
            return r && r.selector ? void (o = new e(this, r)) : (o || s.data(a, o = new e(this, r)), void ("string" == typeof i && o[i].apply(o, Array.prototype.slice.call(n, 1))))
        })
    ...
    e.prototype = {
        init: function (e, i, s) {
            this.type = e, this.options = t.extend({}, s, i)
        }, prerender: function () {
    ...
    t.fn.editableutils.inherit(e, t.fn.editabletypes.abstractinput), t.extend(e.prototype, {
        render: function () {
            ...
            var a = t.Deferred(), o = function () {
                "function" == typeof s ? s.call(i, e, this.sourceData, n) : this.value2htmlFinal(e, i), a.resolve()
            };
            ...
            var s;
            if (t.isFunction(this.options.source) ? (s = this.options.source.call(this.options.scope), this.sourceData = null) : s = this.options.source, this.options.sourceCache && t.isArray(this.sourceData)) e.call(this); else {
                try {
                    s = t.fn.editableutils.tryParseJson(s, !1)
                } catch (t) {
                ...
                if ("string" == typeof s) {
                    if (this.options.sourceCache) {
                        ...
                        if (!0 === n.loading) return n.callbacks.push(t.proxy(function () {
                            this.sourceData = n.sourceData, this.doPrepend(), e.call(this)
                        }, this)), void n.err_callbacks.push(t.proxy(i, this));
                        n.loading = !0, n.callbacks = [], n.err_callbacks = []
                    }
                    var o = t.extend({
                        url: s, type: "get", cache: !1, dataType: "json", success: t.proxy(function (s) {
                            n && (n.loading = !1), this.sourceData = this.makeArray(s), t.isArray(this.sourceData) ? (n && (n.sourceData = this.sourceData, t.each(n.callbacks, function () {
                                this.call()
                            })), this.doPrepend(), e.call(this)) : (i.call(this), n && t.each(n.err_callbacks, function () {
                                this.call()
                            }))
                        }, this), error: t.proxy(function () {
                            i.call(this), n && (n.loading = !1, t.each(n.err_callbacks, function () {
                                this.call()
                            }))
                        }, this)
            ...
            if (t.isArray(e)) {
                a = function (t, e) {
                    return s = {value: t, text: e}, !(i++ >= 2) && void 0
                };
                for (var r = 0; r < e.length; r++) "object" == typeof (n = e[r]) ? (i = 0, t.each(n, a), 1 === i ? o.push(s) : i > 1 && (n.children && (n.children = this.makeArray(n.children)), o.push(n))) : o.push({
                    value: n,
                    text: n
                })
    ...
    t.fn.editableutils.inherit(e, t.fn.editabletypes.list), t.extend(e.prototype, {
        renderList: function () {
            ...
            var s = "", n = t.fn.editableutils.itemsByValue(e, this.sourceData);
    ...
    t.fn.editableutils.inherit(e, t.fn.editabletypes.list), t.extend(e.prototype, {
        renderList: function () {
            ...
            var i, s = null;
            return "string" == typeof e && e.length ? (i = new RegExp("\\s*" + t.trim(this.options.separator) + "\\s*"), s = e.split(i)) : s = t.isArray(e) ? e : [e], s
            ...
            var e = [];
            return this.$input.filter(":checked").each(function (i, s) {
                e.push(t(s).val())
            }), e
        }, value2htmlFinal: function (e, i) {
            var s = [], n = t.fn.editableutils.itemsByValue(e, this.sourceData), a = this.options.escape;
    ...
    var e = function (i) {
        if (this.init("select2", i, e.defaults), i.select2 = i.select2 || {}, this.sourceData = null, i.placeholder && (i.select2.placeholder = i.placeholder), !i.select2.tags && i.source) {
            var s = i.source;
            t.isFunction(i.source) && (s = i.source.call(i.scope)), "string" == typeof s ? (i.select2.ajax = i.select2.ajax || {}, i.select2.ajax.data || (i.select2.ajax.data = function (t) {
                return {query: t}
            }), i.select2.ajax.results || (i.select2.ajax.results = function (t) {
                return {results: t}
            }), i.select2.ajax.url = s) : (this.sourceData = this.convertSource(s), i.select2.data = this.sourceData)
        }
    ...
    t.fn.editableutils.inherit(e, t.fn.editabletypes.abstractinput), t.extend(e.prototype, {
        render: function () {
            ...
            var n, a = "", o = this;
            this.options.select2.tags ? n = i : this.sourceData && (n = t.fn.editableutils.itemsByValue(i, this.sourceData, this.idFunc)), t.isArray(n) ? (a = [], t.each(n, function (t, e) {
                a.push(e && "object" == typeof e ? o.formatSelection(e) : e)
            })) : n && (a = o.formatSelection(n)), a = t.isArray(a) ? a.join(this.options.viewseparator) : a, e.superclass.value2html.call(this, a, s)
            ...
            if (t.isArray(e) && (e = e.join(this.getSeparator())), this.$input.data("select2") ? this.$input.val(e).trigger("change", !0) : (this.$input.val(e), this.$input.select2(this.options.select2)), this.isRemote && !this.isMultiple && !this.options.select2.initSelection) {
                var i = this.options.select2.id, s = this.options.select2.formatSelection;
                if (!i && !s) {
            ...
            var s, n, a;
            if (i = i || this.getSeparator(), null === e || e.length < 1) return null;
            for (n = 0, a = (s = e.split(i)).length; a > n; n += 1) s[n] = t.trim(s[n]);
            return s
        }, autosubmit: function () {
    ...
    e.prototype = {
        constructor: e, init: function () {
            ...
            var e = this["$" + t];
            if (e) {
                var i = this["fill" + t.charAt(0).toUpperCase() + t.slice(1)](), s = e.val();
                e.empty();
            ...
            var t, e, i = this.fillCommon("d"), s = -1 !== this.options.template.indexOf("DD"), n = 31;
            if (this.options.smartDays && this.$month && this.$year) {
                var a = parseInt(this.$month.val(), 10), o = parseInt(this.$year.val(), 10);
                isNaN(a) || isNaN(o) || (n = moment([o, a]).daysInMonth())
            }
            for (e = 1; n >= e; e++) t = s ? this.leadZero(e) : e, i.push([e, t]);
            return i
        }, fillMonth: function () {
            var t, e, i = this.fillCommon("M"), s = -1 !== this.options.template.indexOf("MMMM"),
                n = -1 !== this.options.template.indexOf("MMM"), a = -1 !== this.options.template.indexOf("MM");
            ...
            var t, e, i = [], s = -1 !== this.options.template.indexOf("YYYY");
            for (e = this.options.maxYear; e >= this.options.minYear; e--) t = s ? e : (e + "").substring(2), i[this.options.yearDescending ? "push" : "unshift"]([e, t]);
            return this.fillCommon("y").concat(i)
        }, fillHour: function () {
            var t, e, i = this.fillCommon("h"), s = -1 !== this.options.template.indexOf("h"),
                n = (this.options.template.indexOf("H"), -1 !== this.options.template.toLowerCase().indexOf("hh")),
                a = s ? 12 : 23;
            for (e = s ? 1 : 0; a >= e; e++) t = n ? this.leadZero(e) : e, i.push([e, t]);
            return i
        }, fillMinute: function () {
            var t, e, i = this.fillCommon("m"), s = -1 !== this.options.template.indexOf("mm");
            for (e = 0; 59 >= e; e += this.options.minuteStep) t = s ? this.leadZero(e) : e, i.push([e, t]);
            return i
        }, fillSecond: function () {
            var t, e, i = this.fillCommon("s"), s = -1 !== this.options.template.indexOf("ss");
            ...
            return t.each(this.map, function (t) {
                if ("ampm" !== t) {
                    var e = "day" === t ? 1 : 0;
                    return s[t] = n["$" + t] ? parseInt(n["$" + t].val(), 10) : e, isNaN(s[t]) ? (a = !0, !1) : void 0
                }
            }), a ? "" : (this.$ampm && (s.hour = 12 === s.hour ? "am" === this.$ampm.val() ? 0 : 12 : "am" === this.$ampm.val() ? s.hour : s.hour + 12), i = moment([s.year, s.month, s.day, s.hour, s.minute, s.second]), this.highlight(i), null === (e = void 0 === e ? this.options.format : e) ? i.isValid() ? i : null : i.isValid() ? i.format(e) : "")
        }, setValue: function (e) {
            function i(e, i) {
                var s = {};
                return e.children("option").each(function (e, n) {
                    var a, o = t(n).attr("value");
                    "" !== o && (a = Math.abs(o - i), (void 0 === s.distance || a < s.distance) && (s = {
                        value: o,
                        distance: a
                    }))
                }), s.value
            ...
            if (e) {
                var s = "string" == typeof e ? moment(e, this.options.format) : moment(e), n = this, a = {};
                s.isValid() && (t.each(this.map, function (t, e) {
                    "ampm" !== t && (a[t] = s[e[1]]())
                }), this.$ampm && (a.hour >= 12 ? (a.ampm = "pm", a.hour > 12 && (a.hour -= 12)) : (a.ampm = "am", 0 === a.hour && (a.hour = 12))), t.each(a, function (t, e) {
                    n["$" + t] && ("minute" === t && n.options.minuteStep > 1 && n.options.roundTime && (e = i(n["$" + t], e)), "second" === t && n.options.secondStep > 1 && n.options.roundTime && (e = i(n["$" + t], e)), n["$" + t].val(e))
                }), this.options.smartDays && this.fillCombo("day"), this.$element.val(s.format(this.options.format)).change())
            }
        ...
        return n.shift(), "getValue" === i && this.length && (s = this.eq(0).data("combodate")) ? s.getValue.apply(s, n) : this.each(function () {
            var s = t(this), a = s.data("combodate"), o = "object" == typeof i && i;
    ...
    t.extend(t.fn.editableform.Constructor.prototype, {
        initTemplate: function () {
            ...
            e.apply(this);
            var i = null === this.input.options.inputclass || !1 === this.input.options.inputclass, s = "input-sm",
    ...
    }), t.fn.editableform.buttons = '<button type="submit" class="btn btn-primary btn-sm editable-submit x-editable-migueln"><i class="glyphicon glyphicon-ok x-editable-migueln"></i></button><button type="button" class="btn btn-default btn-sm editable-cancel"><i class="glyphicon glyphicon-remove"></i></button>', t.fn.editableform.errorGroupClass = "has-error", t.fn.editableform.errorBlockClass = null, t.fn.editableform.engine = "bs3"
}(window.jQuery), function (t) {
    "use strict";
    ...
    s.prototype = {
        constructor: s, _process_options: function (e) {
            this._o = t.extend({}, this._o, e);
            var i = this.o = t.extend({}, this._o), s = i.language;
            switch (h[s] || (s = s.split("-")[0], h[s] || (s = r.language)), i.language = s, i.startView) {
                case 2:
                case"decade":
                    i.startView = 2;
                    break;
            ...
            var n = u.parseFormat(i.format);
            i.startDate !== -1 / 0 && (i.startDate = u.parseDate(i.startDate, n, i.language)), 1 / 0 !== i.endDate && (i.endDate = u.parseDate(i.endDate, n, i.language)), i.daysOfWeekDisabled = i.daysOfWeekDisabled || [], t.isArray(i.daysOfWeekDisabled) || (i.daysOfWeekDisabled = i.daysOfWeekDisabled.split(/[,\s]*/)), i.daysOfWeekDisabled = t.map(i.daysOfWeekDisabled, function (t) {
            ...
            var s = i || this.date, n = new Date(s.getTime() + 6e4 * s.getTimezoneOffset());
            this.element.trigger({
                type: e, date: n, format: t.proxy(function (t) {
                    var e = t || this.o.format;
                    return u.formatDate(s, e, this.o.language)
                }, this)
            })
        }, show: function (t) {
            ...
            return void 0 === t && (t = this.o.format), u.formatDate(this.date, t, this.o.language)
            ...
            var i = [], s = this.viewDate.getUTCFullYear(), n = this.viewDate.getUTCMonth(), a = this.date.valueOf(),
                o = new Date;
            ...
            var i, s = new Date(this.viewDate), n = s.getUTCFullYear(), a = s.getUTCMonth(),
                o = this.o.startDate !== -1 / 0 ? this.o.startDate.getUTCFullYear() : -1 / 0,
                r = this.o.startDate !== -1 / 0 ? this.o.startDate.getUTCMonth() : -1 / 0,
                l = 1 / 0 !== this.o.endDate ? this.o.endDate.getUTCFullYear() : 1 / 0,
                p = 1 / 0 !== this.o.endDate ? this.o.endDate.getUTCMonth() : 1 / 0;
            this.date && this.date.valueOf(), this.picker.find(".datepicker-days thead th.datepicker-switch").text(h[this.o.language].months[a] + " " + n), this.picker.find("tfoot th.today").text(h[this.o.language].today).toggle(!1 !== this.o.todayBtn), this.picker.find("tfoot th.clear").text(h[this.o.language].clear).toggle(!1 !== this.o.clearBtn), this.updateNavArrows(), this.fillMonths();
            var d = e(n, a - 1, 28, 0, 0, 0, 0), c = u.getDaysInMonth(d.getUTCFullYear(), d.getUTCMonth());
            ...
            k && k == n && $.eq(this.date.getUTCMonth()).addClass("active"), (o > n || n > l) && $.addClass("disabled"), n == o && $.slice(0, r).addClass("disabled"), n == l && $.slice(p + 1).addClass("disabled"), v = "", n = 10 * parseInt(n / 10, 10);
            ...
            if (1 == s.length) switch (s[0].nodeName.toLowerCase()) {
                case"th":
                    switch (s[0].className) {
                        ...
                        case"prev":
                        case"next":
                            var n = u.modes[this.viewMode].navStep * ("prev" == s[0].className ? -1 : 1);
                            switch (this.viewMode) {
                                case 0:
                ...
                case"span":
                    if (!s.is(".disabled")) {
                        if (this.viewDate.setUTCDate(1), s.is(".month")) {
                            var l = 1, h = s.parent().find("span").index(s), p = this.viewDate.getUTCFullYear();
                            this.viewDate.setUTCMonth(h), this._trigger("changeMonth", this.viewDate), 1 === this.o.minViewMode && this._setDate(e(p, h, l, 0, 0, 0, 0))
                        } else {
                            p = parseInt(s.text(), 10) || 0, l = 1, h = 0;
                            this.viewDate.setUTCFullYear(p), this._trigger("changeYear", this.viewDate), 2 === this.o.minViewMode && this._setDate(e(p, h, l, 0, 0, 0, 0))
                        }
                ...
                case"td":
                    if (s.is(".day") && !s.is(".disabled")) {
                        l = parseInt(s.text(), 10) || 1, p = this.viewDate.getUTCFullYear(), h = this.viewDate.getUTCMonth();
                        s.is(".old") ? 0 === h ? (h = 11, p -= 1) : h -= 1 : s.is(".new") && (11 == h ? (h = 0, p += 1) : h += 1), this._setDate(e(p, h, l, 0, 0, 0, 0))
                    }
            }
            ...
            }, i = o + e, n.setUTCMonth(i), (0 > i || i > 11) && (i = (i + 12) % 12); else {
    ...
    n.prototype = {
        updateDates: function () {
            ...
            var i = t(e.target).data("datepicker").getUTCDate(), s = t.inArray(e.target, this.inputs),
                n = this.inputs.length;
            if (-1 != s) {
                if (i < this.dates[s]) for (; s >= 0 && i < this.dates[s];) this.pickers[s--].setUTCDate(i); else if (i > this.dates[s]) for (; n > s && i > this.dates[s];) this.pickers[s++].setUTCDate(i);
                this.updateDates()
            }
        }, remove: function () {
    ...
    var a = t.fn.datepicker, o = t.fn.datepicker = function (e) {
        var a, o = Array.apply(null, arguments);
        return o.shift(), this.each(function () {
            var l = t(this), h = l.data("datepicker"), u = "object" == typeof e && e;
            if (!h) {
                var p = function (e, i) {
                    var s = t(e).data(), n = {}, a = new RegExp("^" + i.toLowerCase() + "([A-Z])");
                    for (var o in i = new RegExp("^" + i.toLowerCase()), s) i.test(o) && (n[o.replace(a, function (t, e) {
                        return e.toLowerCase()
                    })] = s[o]);
                    return n
                }(this, "date"), d = i(t.extend({}, r, p, u).language), c = t.extend({}, r, d, p, u);
                if (l.is(".input-daterange") || c.inputs) {
                    var f = {inputs: c.inputs || l.find("input").toArray()};
                    l.data("datepicker", h = new n(this, t.extend(c, f)))
                } else l.data("datepicker", h = new s(this, c))
            }
            return ("string" != typeof e || "function" != typeof h[e] || void 0 === (a = h[e].apply(h, o))) && void 0
        }), void 0 !== a ? a : this
    }, r = t.fn.datepicker.defaults = {
        autoclose: !1,
        ...
        todayHighlight: !1,
        weekStart: 0
    }, l = t.fn.datepicker.locale_opts = ["format", "rtl", "weekStart"];
    ...
    var h = t.fn.datepicker.dates = {
        ...
        parseDate: function (i, n, a) {
            ...
            if ("string" == typeof n && (n = u.parseFormat(n)), /^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(i)) {
                var o, r = /([\-+]\d+)([dmwy])/, l = i.match(/([\-+]\d+)([dmwy])/g);
                i = new Date;
                for (var p = 0; p < l.length; p++) switch (f = r.exec(l[p]), o = parseInt(f[1]), f[2]) {
                    case"d":
                        i.setUTCDate(i.getUTCDate() + o);
                        break;
                    case"m":
                        i = s.prototype.moveMonth.call(s.prototype, i, o);
                        break;
                    case"w":
                        i.setUTCDate(i.getUTCDate() + 7 * o);
                        break;
                    case"y":
                        i = s.prototype.moveYear.call(s.prototype, i, o)
                }
                return e(i.getUTCFullYear(), i.getUTCMonth(), i.getUTCDate(), 0, 0, 0)
            }
            l = i && i.match(this.nonpunctuation) || [], i = new Date;
            var d, c, f, m = {}, v = ["yyyy", "yy", "M", "MM", "m", "mm", "d", "dd"], y = {
                yyyy: function (t, e) {
            ...
            var b = n.parts.slice();
            if (l.length != b.length && (b = t(b).filter(function (e, i) {
                return -1 !== t.inArray(i, v)
            }).toArray()), l.length == b.length) {
                p = 0;
                for (var g = b.length; g > p; p++) {
                    if (d = parseInt(l[p], 10), f = b[p], isNaN(d)) switch (f) {
                        case"MM":
                            c = t(h[a].months).filter(function () {
                                var t = this.slice(0, l[p].length);
                                return t == l[p].slice(0, t.length)
                            }), d = t.inArray(c[0], h[a].months) + 1;
                            break;
                        case"M":
                            c = t(h[a].monthsShort).filter(function () {
                                var t = this.slice(0, l[p].length);
                                return t == l[p].slice(0, t.length)
                            }), d = t.inArray(c[0], h[a].monthsShort) + 1
                    }
                    m[f] = d
                }
                var w;
                for (p = 0; p < v.length; p++) (w = v[p]) in m && !isNaN(m[w]) && y[w](i, m[w])
            }
            return i
        },
        formatDate: function (e, i, s) {
            ...
            var n = {
                d: e.getUTCDate(),
                D: h[s].daysShort[e.getUTCDay()],
                DD: h[s].days[e.getUTCDay()],
                m: e.getUTCMonth() + 1,
            ...
            e = [];
            for (var a = t.extend([], i.separators), o = 0, r = i.parts.length; r >= o; o++) a.length && e.push(a.shift()), e.push(n[i.parts[o]]);
            return e.join("")
        },
    ...
    u.template = '<div class="datepicker"><div class="datepicker-days"><table class=" table-condensed">' + u.headTemplate + "<tbody></tbody>" + u.footTemplate + '</table></div><div class="datepicker-months"><table class="table-condensed">' + u.headTemplate + u.contTemplate + u.footTemplate + '</table></div><div class="datepicker-years"><table class="table-condensed">' + u.headTemplate + u.contTemplate + u.footTemplate + "</table></div></div>", t.fn.datepicker.DPGlobal = u, t.fn.datepicker.noConflict = function () {
        return t.fn.datepicker = a, this
    }, t(document).on("focus.datepicker.data-api click.datepicker.data-api", '[data-provide="datepicker"]', function (e) {
        var i = t(this);
        i.data("datepicker") || (e.preventDefault(), o.call(i, "show"))
    }), t(function () {
    ...
    t.fn.editableutils.inherit(e, t.fn.editabletypes.abstractinput), t.extend(e.prototype, {
        initPicker: function (e, i) {
            ...
            return i ? void e.superclass.value2html.call(this, s, i) : s
        }, html2value: function (t) {
