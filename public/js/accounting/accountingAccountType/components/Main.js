var componentThisAccountingAccountType;
Vue.component('accounting-account-type-component', {
    template: '#accounting-account-type-template',
    props: {
        params: {
            type: Object,
        }
    ...
    mounted: function () {
        componentThisAccountingAccountType = this;
...
//form config
            ...
            tabCurrentSelector: '#tab-accounting-account-type',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#accounting-account-type-form",
                url: $('#action-accounting-account-type-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el AccountingAccountType.',
                successMessage: 'El AccountingAccountType se guardo correctamente.',
                nameModel: "AccountingAccountType"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#accounting-account-type-grid",
                url: $("#action-accounting-account-type-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
