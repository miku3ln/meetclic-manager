var componentThisAccountingConfigModulesTypes;
Vue.component('accounting-config-modules-types-component', {
    template: '#accounting-config-modules-types-template',
    props: {
        params: {
            type: Object,
        }
    ...
    mounted: function () {
        componentThisAccountingConfigModulesTypes = this;
...
//form config
            ...
            tabCurrentSelector: '#tab-accounting-config-modules-types',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#accounting-config-modules-types-form",
                url: $('#action-accounting-config-modules-types-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el AccountingConfigModulesTypes.',
                successMessage: 'El AccountingConfigModulesTypes se guardo correctamente.',
                nameModel: "AccountingConfigModulesTypes"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#accounting-config-modules-types-grid",
                url: $("#action-accounting-config-modules-types-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
...
//FORM CONFIG
        ...
        getAttributesForm: function () {
            var result = {
                "id": null,
                "value": null, "description": null, "status": null
            };
            return result;
        },
