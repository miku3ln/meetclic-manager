var componentThisAccountingLevel;
Vue.component('accounting-level-component', {
    template: '#accounting-level-template',
    props: {
        params: {
            type: Object,
        }
    ...
    mounted: function () {
        componentThisAccountingLevel = this;
...
//form config
            ...
            tabCurrentSelector: '#tab-accounting-level',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#accounting-level-form",
                url: $('#action-accounting-level-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el AccountingLevel.',
                successMessage: 'El AccountingLevel se guardo correctamente.',
                nameModel: "AccountingLevel"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#accounting-level-grid",
                url: $("#action-accounting-level-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
