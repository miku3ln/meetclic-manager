var componentThisBank;
Vue.component('bank-component', {
...
//form config
            ...
            tabCurrentSelector: '#tab-bank',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#bank-form",
                url: $('#action-bank-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el Bank.',
                successMessage: 'El Bank se guardo correctamente.',
                nameModel: "Bank"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#bank-grid",
                url: $("#action-bank-getAdmin").val()
            },
            showManager: false,
            managerType: null,
        };
