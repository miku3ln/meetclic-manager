var componentThisRetentionTaxType;
var $configCurrentManagement = {
    'processName': 'retention-tax-type',
    ...
    formConfig: {
        "nameSelector": "#retention-tax-type-form",
        "url": $('#action-retention-tax-type-saveData').val(),
        "loadingMessage": 'Guardando...',
        "errorMessage": 'Error al guardar el RetentionTaxType.',
        "successMessage": 'El RetentionTaxType se guardo correctamente.',
        "nameModel": 'RetentionTaxType'
    },
    gridConfig: {
        selectorCurrent: "#retention-tax-type-grid",
        url: $("#action-retention-tax-type-getAdmin").val()
    },
    tabCurrentSelector: '#tab-retention-tax-type'
...
//FORM CONFIG
        ...
        getAttributesForm: function () {
            var result = {
                "id": null,
                "value": null, "description": null, "status": "ACTIVE", "type": null
            };
            return result;
        },
