var componentThisVoucherType;
var $configCurrentManagement = {
    'processName': 'voucher-type',
    ...
    formConfig: {
        "nameSelector": "#voucher-type-form",
        "url": $('#action-voucher-type-saveData').val(),
        "loadingMessage": 'Guardando...',
        "errorMessage": 'Error al guardar el VoucherType.',
        "successMessage": 'El VoucherType se guardo correctamente.',
        "nameModel": 'VoucherType'
    },
    gridConfig: {
        selectorCurrent: "#voucher-type-grid",
        url: $("#action-voucher-type-getAdmin").val()
    },
    tabCurrentSelector: '#tab-voucher-type'
