var componentThisCajaCatalogoTipoFraccion;
var $configCurrentManagement = {
    'processName': 'caja-catalogo-tipo-fraccion',
    ...
    formConfig: {
        "nameSelector": "#caja-catalogo-tipo-fraccion-form",
        "url": $('#action-caja-catalogo-tipo-fraccion-saveData').val(),
        "loadingMessage": 'Guardando...',
        "errorMessage": 'Error al guardar el CajaCatalogoTipoFraccion.',
        "successMessage": 'El CajaCatalogoTipoFraccion se guardo correctamente.',
        "nameModel": 'CajaCatalogoTipoFraccion'
    },
    gridConfig: {
        selectorCurrent: "#caja-catalogo-tipo-fraccion-grid",
        url: $("#action-caja-catalogo-tipo-fraccion-getAdmin").val()
    },
    tabCurrentSelector: '#tab-caja-catalogo-tipo-fraccion'
