var componentThisBusinessAcademicOfferingsByData;
Vue.component('business-academic-offerings-by-data-component', {
    template: '#business-academic-offerings-by-data-template',
    directives: {
        initEventUploads: {
    ...
    mounted: function () {
        componentThisBusinessAcademicOfferingsByData = this;
    ...
    validations: function () {
        var attributes = {
            ...
            "allow_source_data": {},
            change: {},
            "link": {required,maxLength: Validators.maxLength(125)},
        ...
        var dataManager = {
            ...
            configModelEntity: {
                "buttonsManagements": [
                    ...
                    /*{
                        "title": "Administracion Ofertas",
                        "data-placement": "top",
                        "i-class": "fas fa-business-time",
                        "managerType": "managementInformation"
                    }*/
                ]
            },
            managerMenuConfig: {
...
//form config
            ...
            tabCurrentSelector: '#modal-business-academic-offerings-by-data',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#business-academic-offerings-by-data-form",
                url: $('#action-business-academic-offerings-by-data-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el BusinessAcademicOfferingsByData.',
                successMessage: 'El BusinessAcademicOfferingsByData se guardo correctamente.',
                nameModel: "BusinessAcademicOfferingsByData"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#business-academic-offerings-by-data-grid",
                url: $("#action-business-academic-offerings-by-data-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
            ...
            model_id: null,
            rowCurrent: null,
            configModalBusinessAcademicOfferingsDataByInformation: {
                "title": "Title",
                "viewAllow": false,
                "data": []
            },
    ...
    methods: {
        ...
        initCurrentComponent: function () {
            ...
            this.$refs.refBusinessAcademicOfferingsByDataModal.show();
        },
        ...
        _hideModal: function () {
            this._emitToParent({
                type: 'resetComponent',
                'componentName': 'configModalBusinessAcademicOfferingsByData'
            });
        ...
        _cancel: function () {
            this.$refs.refBusinessAcademicOfferingsByDataModal.hide();
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                this.configModalBusinessAcademicOfferingsDataByInformation.data = rowCurrent;
                if (this.configModalBusinessAcademicOfferingsDataByInformation.viewAllow) {
                    this.$refs.refBusinessAcademicOfferingsDataByInformation._setValueOfParent(
                        {type: "openModal", data: this.configModalBusinessAcademicOfferingsDataByInformation}
                    );
                } else {
                    this.configModalBusinessAcademicOfferingsDataByInformation.viewAllow = true;
                }
            }
        },
        initGridManager: function (vmCurrent) {
            ...
            var paramsFilters = {
                business_by_academic_offerings_id: this.model_id
            ...
            var formatters = {
                'description': function (column, row) {
                    ...
                    var result = [
                        ...
                        allow_source_data,
                        "<div class='content-description__information'>",
                        "   <span class='content-description__title'>" + structure.link.label + ":</span><span class='content-description__value'>" + row.link + "</span>",
