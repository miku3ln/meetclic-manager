var componentThisBusinessByAcademicOfferings;
Vue.component('business-by-academic-offerings-component', {
    template: '#business-by-academic-offerings-template',
    directives: {
        initEventUploads: {
    ...
    created: function () {
        var $this = this;
        this.$root.$on("_businessByAcademicOfferings", function (emitValue) {
    ...
    mounted: function () {
        componentThisBusinessByAcademicOfferings = this;
...
//form config
            ...
            tabCurrentSelector: '#tab-business-by-academic-offerings',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#business-by-academic-offerings-form",
                url: $('#action-business-by-academic-offerings-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el Template News.',
                successMessage: 'El BusinessByAcademicOfferings se guardo correctamente.',
                nameModel: "BusinessByAcademicOfferings"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#business-by-academic-offerings-grid",
                url: $("#action-business-by-academic-offerings-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
            ...
            configModalBusinessAcademicOfferingsByData: {
                "title": "Title",
                "viewAllow": false,
                "data": []
            },
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                this.configModalBusinessAcademicOfferingsByData.data = rowCurrent;
                if (this.configModalBusinessAcademicOfferingsByData.viewAllow) {
                    this.$refs.refBusinessAcademicOfferingsByData._setValueOfParent(
                        {type: "openModal", data: this.configModalBusinessAcademicOfferingsByData}
                    );
                } else {
                    this.configModalBusinessAcademicOfferingsByData.viewAllow = true;
                }
            }
        },
