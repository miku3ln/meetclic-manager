var componentThisBusinessByAcademicOfferingsInstitution;
Vue.component('business-by-academic-offerings-institution-component', {
    template: '#business-by-academic-offerings-institution-template',
    directives: {
        initEventUploads: {
    ...
    created: function () {
        var $this = this;
        this.$root.$on("_businessByAcademicOfferingsInstitution", function (emitValue) {
    ...
    mounted: function () {
        componentThisBusinessByAcademicOfferingsInstitution = this;
...
//form config
            ...
            tabCurrentSelector: '#tab-business-by-academic-offerings-institution',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#business-by-academic-offerings-institution-form",
                url: $('#action-business-by-academic-offerings-institution-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el Template News.',
                successMessage: 'El BusinessByAcademicOfferingsInstitution se guardo correctamente.',
                nameModel: "BusinessByAcademicOfferingsInstitution"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#business-by-academic-offerings-institution-grid",
                url: $("#action-business-by-academic-offerings-institution-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
            ...
            configModalBusinessAcademicOfferingsInstitutionByData: {
                "title": "Title",
                "viewAllow": false,
                "data": []
            },
