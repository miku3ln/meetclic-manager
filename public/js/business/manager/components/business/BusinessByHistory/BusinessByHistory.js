var componentThisBusinessByHistory;
Vue.component('business-by-history-component', {
    template: '#business-by-history-template',
    directives: {
        initEventUploads: {
    ...
    created: function () {
        var $this = this;
        this.$root.$on("_businessByHistory", function (emitValue) {
    ...
    mounted: function () {
        componentThisBusinessByHistory = this;
    ...
    validations: function () {
        var attributes = {
            ...
            "subtitle": {required},
            "change": {},
            "author": {required, maxLength: Validators.maxLength(150)},
            "author_titles": {required},
            "main": {required},
...
//form config
            ...
            tabCurrentSelector: '#tab-business-by-history',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#business-by-history-form",
                url: $('#action-business-by-history-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el Template News.',
                successMessage: 'El BusinessByHistory se guardo correctamente.',
                nameModel: "BusinessByHistory"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#business-by-history-grid",
                url: $("#action-business-by-history-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
            ...
            configModalBusinessHistoryByData: {
                "title": "Title",
                "viewAllow": false,
                "data": []
            },
            configModalLanguageBusinessByHistory: {
                "title": "Title",
                "viewAllow": false,
                "data": []
            }
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                this.model.attributes.author = rowCurrent.author;
                this.model.attributes.author_titles = rowCurrent.author_titles;
                this.model.attributes.main = rowCurrent.main;


                this._viewManager(3, rowId);
            } else if (params.managerType == 'languageEntity') {
                this.configModalLanguageBusinessByHistory.data = rowCurrent;
                if (this.configModalLanguageBusinessByHistory.viewAllow) {
                    this.$refs.refLanguageBusinessByHistory._setValueOfParent(
                        {type: "openModal", data: this.configModalLanguageBusinessByHistory}
                    );
                } else {
                    this.configModalLanguageBusinessByHistory.viewAllow = true;
                }
            } else {
                this.configModalBusinessHistoryByData.data = rowCurrent;
                if (this.configModalBusinessHistoryByData.viewAllow) {
                    this.$refs.refBusinessHistoryByData._setValueOfParent(
                        {type: "openModal", data: this.configModalBusinessHistoryByData}
                    );
                } else {
                    this.configModalBusinessHistoryByData.viewAllow = true;
                }
            }
        },
            ...
            var formatters = {
                'description': function (column, row) {
                    ...
                    var result = [
                        ...
                        "<div class='content-description__information'>",
                        "   <span class='content-description__title'>" + structure.main.label + ":</span><span class='content-description__value'><span class='badge badge--size-large " + classMain + " '>" + (row.main == 1 ? "Principal" : "Secundaria")  + "</span></span>",
                        "</div>",
        ...
        getStructureForm: function () {
            var result = {
                ...
                "main": {
                    ...
                    options: [{"value": 0, "text": "Secundario"}, {"value": 1, "text": "Principal"}]
                },
...
//Manager Model
        ...
        getValuesSave: function () {
            ...
            var result = {
                ...
                "author_titles": this.$v.model.attributes.author_titles.$model,
                "author": this.$v.model.attributes.author.$model,
                "main": this.$v.model.attributes.main.$model,
