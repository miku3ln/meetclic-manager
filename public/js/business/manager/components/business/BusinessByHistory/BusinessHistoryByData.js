...
Vue.component('business-history-by-data-component', {
    template: '#business-history-by-data-template',
    directives: {
        initEventUploads: {
    ...
    created: function () {
        ...
        var vmCurrent = this;
        this.$root.$on("_businessHistoryByData", function (emitValue) {
...
//form config
            ...
            tabCurrentSelector: '#modal-business-history-by-data',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#business-history-by-data-form",
                url: $('#action-business-history-by-data-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el BusinessHistoryByData.',
                successMessage: 'El BusinessHistoryByData se guardo correctamente.',
                nameModel: "BusinessHistoryByData"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#business-history-by-data-grid",
                url: $("#action-business-history-by-data-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
            ...
            model_id: null,
            rowCurrent: null,
            configModalLanguageBusinessHistoryByData: {
                "title": "Title",
                "viewAllow": false,
                "data": []
            }
    ...
    methods: {
        ...
        initCurrentComponent: function () {
            ...
            this.$refs.refBusinessHistoryByDataModal.show();
        },
        ...
        _hideModal: function () {
            this._emitToParent({
                type: 'resetComponent',
                'componentName': 'configModalBusinessHistoryByData'
            });
        ...
        _cancel: function () {
            this.$refs.refBusinessHistoryByDataModal.hide();
        ...
        _emitToParent: function (params) {
            this.$root.$emit('_businessByHistory', params);
        },
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                this.configModalLanguageBusinessHistoryByData.data = rowCurrent;
                if (this.configModalLanguageBusinessHistoryByData.viewAllow) {
                    this.$refs.refLanguageBusinessHistoryByData._setValueOfParent(
                        {type: "openModal", data: this.configModalLanguageBusinessHistoryByData}
                    );
                } else {
                    this.configModalLanguageBusinessHistoryByData.viewAllow = true;
                }
            }
        },
