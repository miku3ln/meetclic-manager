var componentThisBusinessByPartnerCompanies;
Vue.component('business-by-partner-companies-component', {
    template: '#business-by-partner-companies-template',
    directives: {
        initEventUploads: {
    ...
    created: function () {
        var $this = this;
        this.$root.$on("_businessByPartnerCompanies", function (emitValue) {
    ...
    mounted: function () {
        componentThisBusinessByPartnerCompanies = this;
...
//form config
            ...
            tabCurrentSelector: '#tab-business-by-partner-companies',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#business-by-partner-companies-form",
                url: $('#action-business-by-partner-companies-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el Template News.',
                successMessage: 'El BusinessByPartnerCompanies se guardo correctamente.',
                nameModel: "BusinessByPartnerCompanies"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#business-by-partner-companies-grid",
                url: $("#action-business-by-partner-companies-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
            ...
            configModalLanguageBusinessByPartnerCompanies: {
                "title": "Title",
                "viewAllow": false,
                "data": []
            }
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                this.configModalLanguageBusinessByPartnerCompanies.data = rowCurrent;
                if (this.configModalLanguageBusinessByPartnerCompanies.viewAllow) {
                    this.$refs.refLanguageBusinessByPartnerCompanies._setValueOfParent(
                        {type: "openModal", data: this.configModalLanguageBusinessByPartnerCompanies}
                    );
                } else {
                    this.configModalLanguageBusinessByPartnerCompanies.viewAllow = true;
                }
            }
        },
