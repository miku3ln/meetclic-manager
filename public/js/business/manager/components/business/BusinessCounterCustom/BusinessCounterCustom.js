var componentThisBusinessCounterCustom;
Vue.component('business-counter-custom-component', {
    template: '#business-counter-custom-template',
    directives: {
    ...
    created: function () {
        var $this = this;
        this.$root.$on("_businessCounterCustom", function (emitValue) {
    ...
    mounted: function () {
        componentThisBusinessCounterCustom = this;
...
//form config
            ...
            tabCurrentSelector: '#tab-business-counter-custom',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#business-counter-custom-form",
                url: $('#action-business-counter-custom-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el Template News.',
                successMessage: 'El BusinessCounterCustom se guardo correctamente.',
                nameModel: "BusinessCounterCustom"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#business-counter-custom-grid",
                url: $("#action-business-counter-custom-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
            ...
            configModalBusinessCounterCustomByData: {
                "title": "Title",
                "viewAllow": false,
                "data": []
            },
            configModalLanguageBusinessCounterCustom: {
                "title": "Title",
                "viewAllow": false,
                "data": []
            }
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                this.configModalLanguageBusinessCounterCustom.data = rowCurrent;
                if (this.configModalLanguageBusinessCounterCustom.viewAllow) {
                    this.$refs.refLanguageBusinessCounterCustom._setValueOfParent(
                        {type: "openModal", data: this.configModalLanguageBusinessCounterCustom}
                    );
                } else {
                    this.configModalLanguageBusinessCounterCustom.viewAllow = true;
                }
            } else {
                this.configModalBusinessCounterCustomByData.data = rowCurrent;
                if (this.configModalBusinessCounterCustomByData.viewAllow) {
                    this.$refs.refBusinessCounterCustomByData._setValueOfParent(
                        {type: "openModal", data: this.configModalBusinessCounterCustomByData}
                    );
                } else {
                    this.configModalBusinessCounterCustomByData.viewAllow = true;
                }
            }
        },
