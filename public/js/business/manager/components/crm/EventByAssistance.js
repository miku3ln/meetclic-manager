var componentThisEventByAssistance;
Vue.component('event-by-assistance-component', {
    template: '#event-by-assistance-template',
    directives: {
        initS2Template: {
    ...
    mounted: function () {
        componentThisEventByAssistance = this;
    ...
    data: function () {
        ...
        var dataManager = {
            ...
            configParams: {},
            labelsConfig: {
                "title": "Gestion de Evento Asistencia ",
                process: {
                    "payment": "Pagos"
                },
                buttons: {
...
//form config
            ...
            tabCurrentSelector: '#modal-event-by-assistance',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#event-by-assistance-form",
                url: $('#action-event-by-assistance-saveData').val(),
                loadingMessage: 'Enviando...',
                errorMessage: 'Error al enviar los correos.',
                successMessage: 'Los correso se enviaron correctamente.',
                nameModel: "EventByAssistance"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#event-by-assistance-grid",
                url: $("#action-event-by-assistance-getAdmin").val(),
                rowsDataManager: {
                    rowsDataDetailsAll: [],
                    rowsKeysData: [],
                    rowsData: [],
    ...
    methods: {
        ...
        initCurrentComponent: function () {
            ...
            this.$refs.refEventByAssistanceModal.show();
        },
        ...
        _hideModal: function () {
            this._emitToParent({
                type: 'resetComponent',
                'componentName': 'configModalEventByAssistance'
            });
        ...
        _cancel: function () {
            this.$refs.refEventByAssistanceModal.hide();
