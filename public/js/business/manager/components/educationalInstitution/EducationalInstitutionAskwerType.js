var componentThisEducationalInstitutionAskwerType;
Vue.component('educational-institution-askwer-type-component', {
    template: '#educational-institution-askwer-type-template',
    props: {
        params: {
            type: Object,
        }
    ...
    mounted: function () {
        componentThisEducationalInstitutionAskwerType = this;
        this.initCurrentComponent();
        removeClassNotView();
        this.model.attributes.business_id = this.business_id;
    },
...
//form config
            ...
            tabCurrentSelector: '#tab-educational-institution-askwer-type',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#educational-institution-askwer-type-form",
                url: $('#action-educational-institution-askwer-type-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el EducationalInstitutionAskwerType.',
                successMessage: 'El EducationalInstitutionAskwerType se guardo correctamente.',
                nameModel: "EducationalInstitutionAskwerType"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#educational-institution-askwer-type-grid",
                url: $("#action-educational-institution-askwer-type-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
...
//Manager Model
        ...
        getValuesSave: function () {
            ...
            var result = {
                EducationalInstitutionAskwerType:
                    {
...
//others functions
        _managerS2Business: function (params) {
            ...
            elementInit.on('select2:select', function (e) {
                ...
                _this.model.attributes.business_id = data;
            }).on("select2:unselecting", function (e) {
                _this.model.attributes.lodging_room_levels_id_data = null;
                _this._setValueForm('business_id', null);
            });
        },
    }
})
