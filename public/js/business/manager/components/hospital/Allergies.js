var componentThisAllergies;
Vue.component('allergies-component', {
    template: '#allergies-template',
    props: {
        params: {
            type: Object,
        }
...
//form config
            ...
            tabCurrentSelector: '#tab-allergies',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#allergies-form",
                url: $('#action-allergies-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el Allergies.',
                successMessage: 'El Allergies se guardo correctamente.',
                nameModel: "Allergies"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#allergies-grid",
                url: $("#action-allergies-getAdmin").val()
            },
            showManager: false,
            managerType: null,
        };
