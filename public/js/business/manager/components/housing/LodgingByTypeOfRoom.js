var componentLodgingByTypeOfRoom;
Vue.component('lodging-by-type-of-room-component', {

    template: '#lodging-by-type-of-room-template',
    directives: {
        initS2: {
    ...
    mounted: function () {
        componentLodgingByTypeOfRoom = this;
        this.$refs.refLodgingByTypeOfRoomModal.show();
        removeClassNotView();
    },
    ...
    methods: {
        ...
        initDataModal: function () {
            ...
            this.createUpdate = rowCurrent.LodgingByTypeOfRoom.length ? false : true;
            var dataOptions = [];
            var lodgingTypeOfRoomByPriceData = rowCurrent.lodgingTypeOfRoomByPriceData;
            ...
            if (!this.createUpdate) {
                ...
                this.labelsConfig.title = "Habitaciones Asignadas! ";
                var lodging_type_of_room_by_price_id = [];
                $.each(rowCurrent.LodgingByTypeOfRoom, function (index, value) {
                ...
                this.model.attributes.lodging_type_of_room_by_price_id = [];

                this.labelsConfig.title = "Registro de Habitaciones! ";
            }
...
//Manager Model
        getValuesSave: function () {
            ...
            $.each(lodgingTypeOfRoomByPriceData, function (index, value) {
                ...
                Lodging.push(setPush);
            });
            var lodging_id = this.lodging_id;
            var result = {LodgingByTypeOfRoom: Lodging, lodging_id: lodging_id};
        ...
        _cancel: function () {
            this.$refs.refLodgingByTypeOfRoomModal.hide();
