var componentThisLodgingRoomFeatures;
Vue.component('lodging-room-features-component', {

    template: '#lodging-room-features-template',
    directives: {},
    props: {
        params: {
            type: Object,
    ...
    mounted: function () {
        componentThisLodgingRoomFeatures = this;
...
//**Modal*
            ...
            tabCurrentSelector: '#tab-lodgingRoomFeatures',
            processName: "Registro de tipo de Habitaciones.",
            formConfig: {
                nameSelector: "#business-by-lodging-room-features-form",
                url: $('#action-lodging-room-features-save').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar la caracteristica.',
                successMessage: 'La caracteristica de habitación se guardo correctamente.',
                nameModel: "LodgingRoomFeatures"
            },
            gridConfig: {
                selectorCurrent: "#lodging-room-features-grid",
                url: $("#action-lodging-room-features-admin").val()
            },
            submitStatus: "no",
            showManager: false,
            businessId: null,
                ...
                ajaxRequest(this.formConfig.url, {
                    ...
                    success_callback: function (response) {
                        ...
                        if (response.success) {
                            ...
                            $configPartial["dataCatalogue"]["LodgingRoomFeatures"] = response.dataCatalogue.LodgingRoomFeatures;
                        }
                    }
                });
            }
