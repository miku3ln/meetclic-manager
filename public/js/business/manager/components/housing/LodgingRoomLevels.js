var componentThisLodgingRoomLevels;
Vue.component('lodging-room-levels-component', {

    template: '#lodging-room-levels-template',
    directives: {},
    props: {
        params: {
            type: Object,
    ...
    mounted: function () {
        componentThisLodgingRoomLevels = this;
...
//**Modal*
            ...
            tabCurrentSelector: '#tab-lodgingRoomLevels',
            processName: "Registro de tipo de Habitaciones.",
            formConfig: {
                nameSelector: "#business-by-lodging-room-levels-form",
                url: $('#action_lodging_room_levels_save').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el Nivel.',
                successMessage: 'El Nivel de habitación se guardo correctamente.',
                nameModel: "LodgingRoomLevels"
            },
            gridConfig: {
                selectorCurrent: "#lodging-room-levels-grid",
                url: $("#action_lodging_room_levels_admin").val()
            },
            submitStatus: "no",
            showManager: false,
            businessId: null,
                ...
                ajaxRequest(this.formConfig.url, {
                    ...
                    success_callback: function (response) {
                        ...
                        if (response.success) {
                            ...
                            $configPartial["dataCatalogue"]["lodgingRoomLevels"] = response.dataCatalogue.lodgingRoomLevels;
                        }
                    }
                });
            }
