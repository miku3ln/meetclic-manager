var componentThisLodgingTypeOfRoom;
Vue.component('lodging-type-of-room-component', {

    template: '#lodging-type-of-room-template',
    directives: {},
    props: {
        params: {
            type: Object,
    ...
    mounted: function () {
        componentThisLodgingTypeOfRoom = this;
...
//**Modal*
            ...
            tabCurrentSelector: '#tab-lodgingTypeOfRoom',
            processName: "Registro de tipo de Habitaciones.",
            formConfig: {
                nameSelector: "#business-by-lodging-type-of-room-form",
                url: $('#action_lodging_type_of_room_save').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el Tipo habitación.',
                successMessage: 'El tipo de habitación se guardo correctamente.',
                nameModel: "LodgingTypeOfRoom"
            },
            gridConfig: {
                selectorCurrent: "#lodging-type-of-room-grid",
                url: $("#action_lodging_type_of_room_admin").val()
            },
            submitStatus: "no",
            showManager: false,
            businessId: null,
