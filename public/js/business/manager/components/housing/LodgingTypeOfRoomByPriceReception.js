var componentThisLodgingTypeOfRoomByPriceReception;
var count = 0;
Vue.component('lodging-type-of-room-by-price-reception-component', {

    template: '#lodging-type-of-room-by-price-reception-template',
    directives: {
        initGridManager:{
    ...
    mounted: function () {
        componentThisLodgingTypeOfRoomByPriceReception = this;
...
//**Modal*
            ...
            lblBtnSave: "Guardar",
            lblBtnClose: "Cerrar",
            tabCurrentSelector: '#tab-lodgingTypeOfRoomByPriceReception',
