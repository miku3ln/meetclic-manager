...
let configProcessModal = {//CPP-004
    'manager': UtilManagerCustomModel.getManagerData('human_resources_department_by_manager'),
    'nameProcess': 'HumanResourcesDepartmentByManager',
    'component': null,
};
Vue.component('business-by-employee-profile-component', {
    ...
    methods: {
        ...
        setDataInit: function (rowCurrent) {
            ...
            this.manager_parent_id = rowCurrent.human_resources_department_id;
            this.businessId = rowCurrent.businessId;
            this.createUpdate = !!rowCurrent.id;
            this.manager_id = this.createUpdate ? rowCurrent.id : -1;
            this.labelsConfig.title = this.labelsConfig.title + ' a ' + rowCurrent.human_resources_departmentName;
            ...
            if (this.createUpdate) {
                ...
                this.labelsConfig.title = "Actualizar Responsable" + ' a ' + rowCurrent.human_resources_departmentName;
            }
...
//Manager Model
        getValuesSave: function () {
            ...
            let data = {
                ...
                human_resources_department_id: this.manager_parent_id,
        ...
        onInitEmployeeProfile: function (params) {
            ...
            let elementInit = $(el).select2({
                ...
                ajax: {// instead of writing the function to execute the request we use Select2's convenient helper
                    url: $("#action-human-resources-employee-profile-getFullNameListDataDepartmentAll").val(),
                    type: "get",
                    dataType: 'json',
