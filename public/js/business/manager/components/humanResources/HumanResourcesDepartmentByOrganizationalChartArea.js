...
let configProcessModalTwo = {//CPP-004
    'manager': UtilManagerCustomModel.getManagerData('human_resources_department_by_organizational_chart_area'),
    'nameProcess': 'HumanResourcesDepartmentByOrganizationalChartArea',
    'component': null,
};
Vue.component(configProcessModalTwo.manager.modelProcess + '-component', {

    template: '#' + configProcessModalTwo.manager.modelProcess + '-template',
    directives: {
        initS2: {
    ...
    mounted: function () {
        configProcessModalTwo.component = this;
    ...
    data: function () {
        let dataManager = {
            ...
            configParams: {},
            tabCurrentSelector: '#modal-'+configProcess.manager.modelProcess ,
            processName: "Gestion de Asignacion de Departamentos.",
            formConfig: {
                nameSelector: "#" + configProcessModalTwo.manager.modelProcess + "-form",
                url: $("#action-" + configProcessModalTwo.manager.modelProcess + "-save").val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el ' + configProcessModalTwo.nameProcess + '.',
                successMessage: 'El ' + configProcessModalTwo.nameProcess + ' se guardo correctamente.',
                nameModel: configProcessModalTwo.manager.modelName
            },
            allowReset: false,
            createUpdate: false,
    ...
    methods: {
        ...
        initCurrentComponent: function () {
            this.initDataModal();
           this.$refs.refHumanResourcesDepartmentByOrganizationalChartAreaModal.show();
        },
        setDataInit: function (rowCurrent) {
            ...
            this.createUpdate = rowCurrent.departments.length>0;
            ...
            if (this.createUpdate) {
                ...
                this.labelsConfig.title = "Actualizar Departamentos" + ' a ' + rowCurrent.human_resources_organizational_chart_areaName;
                this.managerInitAll = true;
                let dataCurrent=[];
                $.each(rowCurrent.departments, function (key, value) {
                    let option = new Option(value.human_resources_departmentName, value.human_resources_department_id, true, true);
                    $('#human_resources_department_id_data').append(option).trigger('change');
                    dataCurrent.push({
                        id: value.human_resources_department_id,
                        text: value.human_resources_departmentName,
                        manager_id:value.id

                    });
                })

                this.model.attributes['human_resources_department_id_data'] = dataCurrent;
            }
...
//Manager Model
        getValuesSave: function () {
            let childrenData = [];
            $.each(this.$v.model.attributes.human_resources_department_id_data.$model, function (key, value) {
                let setPush = value.id;
                childrenData.push(setPush);
            });
            childrenData = childrenData.join(',');
            let data = {
                human_resources_organizational_chart_area_id: this.manager_parent_id,
                human_resources_department_id: this.$v.model.attributes.human_resources_department_id_data.$model == null ? null : this.$v.model.attributes.human_resources_department_id_data.$model.id,
                departments:childrenData,


            };
            let result = {};
            result[configProcessModalTwo.manager.modelName] = data;
            return result;
        ...
        resetForm: function () {
            ...
            this.labelsConfig.title = "Agregar Departamentos";
        },
        ...
        _hideModal: function () {
            this.resetForm();
            $('#human_resources_department_id_data').empty().trigger("change");
            ...
            this._emitToParent({
                type: "resetProcess",
                name: "configModalHumanResourcesDepartmentByOrganizationalChartArea",
            });
            this.$refs.refHumanResourcesDepartmentByOrganizationalChartAreaModal.hide();
        },
        ...
        onInitEmployeeProfile: function (params) {
            ...
            let elementInit = $(el).select2({
                ...
                ajax: {// instead of writing the function to execute the request we use Select2's convenient helper
                    url: $("#action-human-resources-department-listAllArea").val(),
                    type: "get",
                    dataType: 'json',
            ...
            elementInit.on("change", function (e) {
                ...
                if (dataCurrent.length != 0) {
                    _this.model.attributes.human_resources_department_id_data = dataCurrent;
                } else {
