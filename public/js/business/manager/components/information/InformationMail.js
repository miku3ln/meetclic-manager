var componentThisInformationMail;
Vue.component('information-mail-component', {
    template: '#information-mail-template',
    directives: {
        initS2InformationMailType: {
            inserted: function (el, binding, vnode, vm, arg) {
                var paramsInput = binding.value
                paramsInput._managerS2InformationMailType({
    ...
    mounted: function () {
        componentThisInformationMail = this;
    ...
    validations: function () {
        var attributes = {
            ...
            "main": {},
            "entity_type": {},
            "information_mail_type_id_data": {required}
        };
        var result = {
            model: {//change
...
//form config
            ...
            tabCurrentSelector: '#modal-information-mail',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#information-mail-form",
                url: $('#action-information-mail-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el InformationMail.',
                successMessage: 'El InformationMail se guardo correctamente.',
                nameModel: "InformationMail"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#information-mail-grid",
                url: $("#action-information-mail-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
    ...
    methods: {
        ...
        _setValueOfParent: function (params) {
            if (params.type == "openModal") {
                ...
                this.initDataModal();
                this.$refs.refInformationMailModal.show();
        ...
        _hideModal: function () {
            this._emitToParent({
                type: 'resetComponent',
                'componentName': 'configModalInformationMail'
            });
        },
        ...
        _cancel: function () {
            this.$refs.refInformationMailModal.hide();
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                this.model.attributes.information_mail_type_id_data = {
                    id: rowCurrent.information_mail_type_id,
                    text: rowCurrent.information_mail_type
                };
                ...
                formatters: {
                    'description': function (column, row) {
                        ...
                        var result = [
                            ...
                            "   <span class='content-description__title'>Tipo:</span><span class='content-description__value'>" + row.information_mail_type + "</span>",
                            "</div>",
                            "<div class='content-description__information'>",
                            "   <span class='content-description__title'>Principal:</span>" + mainRow,
                            "</div>",
                            "<div class='content-description__information'>",
                            "   <span class='content-description__title'>Email :</span><span class='content-description__value'>" + row.value + "</span>",
                            "</div>",
...
//FORM CONFIG
        ...
        getStructureForm: function () {
            var result = {
                ...
                information_mail_type_id_data: {
                    id: "information_mail_type_id_data",
                    name: "information_mail_type_id_data",
                    label: "Tipo",
                    required: {
                        allow: true,
                        msj: "Campo requerido.",
        ...
        getAttributesForm: function () {
            var information_mail_type_id_data=null;
            if ($managerDefaultData.information_mail_type) {
                information_mail_type_id_data = $managerDefaultData.information_mail_type;
            }
            var result = {
                "id": null,
                "value": null,
                ...
                "main": false,
                "entity_type": null,
                "information_mail_type_id_data": information_mail_type_id_data
            };
            return result;
        },
                ...
                InformationMail:
                    {
                        ...
                        "entity_type": this.entity_type,
                        "information_mail_type_id": this.$v.model.attributes.information_mail_type_id_data.$model.id
...
//others functions
        _managerS2InformationMailType: function (params) {
            var el = params.objSelector
            var valueCurrentRowId = params.rowId
            var dataCurrent = [];
            if (valueCurrentRowId) {

                dataCurrent = [this.model.attributes.information_mail_type_id_data];

                var textCurrent = this.model.attributes.information_mail_type_id_data.text;
                var idCurrent = this.model.attributes.information_mail_type_id_data.id;
                var option = new Option(textCurrent, idCurrent, true, true);
                $(el).append(option).trigger('change');
            }else{
                if(this.model.attributes.information_mail_type_id_data){
                    dataCurrent = [this.model.attributes.information_mail_type_id_data];
            ...
            var elementInit = $(el).select2({
                ...
                data: dataCurrent,
                ajax: {
                    url: $("#action-information-mail-type-getListSelect2").val(),
                    type: 'get',
                    dataType: 'json',
            ...
            elementInit.on('select2:select', function (e) {
                ...
                _this.model.attributes.information_mail_type_id_data = data;
            }).on("select2:unselecting", function (e) {
                _this.model.attributes.lodging_room_levels_id_data = null;
                _this._setValueForm('information_mail_type_id_data', null);
