var componentThisInformationPhone;
Vue.component('information-phone-component', {
    template: '#information-phone-template',
    directives: {
    ...
    mounted: function () {
        componentThisInformationPhone = this;
    ...
    validations: function () {
        var attributes = {
            ...
            "main": {required},
            "entity_type": {},
            "information_phone_operator_id_data": {required},
            "information_phone_type_id_data": {required}
        };
        var result = {
            model: {//change
...
//form config
            ...
            tabCurrentSelector: '#information-phone-form',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#information-phone-form",
                url: $('#action-information-phone-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el InformationPhone.',
                successMessage: 'El InformationPhone se guardo correctamente.',
                nameModel: "InformationPhone"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#information-phone-grid",
                url: $("#action-information-phone-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
    ...
    methods: {
        ...
        initCurrentComponent: function () {
            ...
            this.initDataModal();
            this.$refs.refInformationPhoneModal.show();
        },
        ...
        _hideModal: function () {
            this._emitToParent({
                type: 'resetComponent',
                'componentName': 'configModalInformationPhone'
            });
        ...
        _cancel: function () {
            this.$refs.refInformationPhoneModal.hide();
                ...
                formatters: {
                    'description': function (column, row) {
                        ...
                        var result = [
                            ...
                            "   <span class='content-description__title'>Número:</span><span class='content-description__value'>" + row.value + "</span>",
                            "</div>",
                            "<div class='content-description__information'>",
                            ...
                            "<div class='content-description__information'>",
                            "   <span class='content-description__title'>Operadora:</span><span class='content-description__value'>" + row.information_phone_operator + "</span>",
                            "</div>",

                            "<div class='content-description__information'>",
                            "   <span class='content-description__title'>Tipo de Telefono:</span><span class='content-description__value'>" + row.information_phone_type + "</span>",
                            "</div>",
...
//FORM CONFIG
        ...
        getAttributesForm: function () {
            ...
            if ($managerDefaultData.information_phone_type) {
                information_phone_type_id_data = $managerDefaultData.information_phone_type;
            }
            var result = {
                "id": null,
                "value": null,
                ...
                InformationPhone:
                    {
                        ...
                        "entity_type": this.entity_type,
                        "information_phone_operator_id": this.$v.model.attributes.information_phone_operator_id_data.$model.id,
                        "information_phone_type_id": this.$v.model.attributes.information_phone_type_id_data.$model.id
