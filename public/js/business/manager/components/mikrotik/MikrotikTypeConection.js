var componentThisMikrotikTypeConection;
var $configCurrentManagement = {
    'processName': 'mikrotik-type-conection',
    ...
    formConfig: {
        "nameSelector": "#mikrotik-type-conection-form",
        "url": $('#action-mikrotik-type-conection-saveData').val(),
        "loadingMessage": 'Guardando...',
        "errorMessage": 'Error al guardar el MikrotikTypeConection.',
        "successMessage": 'El MikrotikTypeConection se guardo correctamente.',
        "nameModel": 'MikrotikTypeConection'
    },
    gridConfig: {
        selectorCurrent: "#mikrotik-type-conection-grid",
        url: $("#action-mikrotik-type-conection-getAdmin").val()
    },
    tabCurrentSelector: '#tab-mikrotik-type-conection'
...
Vue.component($configCurrentManagement['processName'] + '-component', {
    ...
    validations: function () {
        var attributes = {
            ...
            "user": {required, maxLength: Validators.maxLength(100)},
            "password": {required, maxLength: Validators.maxLength(100)},
            "ip_conection": {required, maxLength: Validators.maxLength(200)},
            "state": {required}
        };
        var result = {
            model: {//change
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                this.model.attributes.ip_conection = rowCurrent.ip_conection;
            ...
            var formatters = {
                'description': function (column, row) {
                    ...
                    var result = [
                        ...
                        "<div class='content-description__information'>",
                        "   <span class='content-description__title'>" + structure.ip_conection.label + ":</span><span class='content-description__value'>" + row.ip_conection + "</span>",
                        "</div>",
                        "<div class='content-description__information'>",
...
//FORM CONFIG
        ...
        getAttributesForm: function () {
            var result = {
                "id": null,
                "name": null, "ip_conection": null, "state": "ACTIVE","user": null,"password": null
            };
            return result;
        },
...
//Manager Model
        ...
        getValuesSave: function () {
            ...
            var result = {
                MikrotikTypeConection:
                    {
                        "id": this.$v.model.attributes.id.$model ? this.$v.model.attributes.id.$model : -1,
                        "name": this.$v.model.attributes.name.$model,
                        "ip_conection": this.$v.model.attributes.ip_conection.$model,
                        "user": this.$v.model.attributes.user.$model,
