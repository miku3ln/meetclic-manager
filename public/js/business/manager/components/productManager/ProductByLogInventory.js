...
Vue.component(configProductByLogInventory.process + '-component', {
    template: '#' + configProductByLogInventory.process + '-template',
    directives: {}
    , props: {
        params: {
            type: Object,
...
//form config
            ...
            tabCurrentSelector: '#modal-product_by_log_inventory',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#product_by_log_inventory-form",
                url: $('#action-product_by_log_inventory-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el Producto.',
                successMessage: 'El producto se actualizo correctamente.',
                nameModel: configProductByLogInventory.model
            },
//Grid config
            submitStatus: "no",
            showManager: true,
    ...
    methods: {
        ...
        initCurrentComponent: function () {
            this.initDataModal();
            var keyViewElement = 'refModal' + configProductByLogInventory.model;
            this.$refs[keyViewElement].show();
        ...
        _resetComponent: function () {
            this.onSendEventsParent({
                process: configProductByLogInventory.process,
                type: 'resetComponent',
                'componentName': 'configModal' + configProductByLogInventory.model,
...
//Manager Model
        ...
        getValuesSave: function () {
            ...
            var result = {
                [configProductByLogInventory.model]:
                    {
