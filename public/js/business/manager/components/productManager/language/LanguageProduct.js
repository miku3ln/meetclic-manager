var componentThisLanguageProduct;
Vue.component('language-product-component', {
    template: '#language-product-template',
    directives: {
        initS2Language: {
    ...
    mounted: function () {
        componentThisLanguageProduct = this;
...
//form config
            ...
            tabCurrentSelector: '#modal-language-product',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#language-product-form",
                url: $('#action-language-product-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el LanguageProduct.',
                successMessage: 'El LanguageProduct se guardo correctamente.',
                nameModel: "LanguageProduct"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#language-product-grid",
                url: $("#action-language-product-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
    ...
    methods: {
        ...
        initCurrentComponent: function () {
            ...
            this.$refs.refLanguageProductModal.show();
        },
        ...
        _resetComponent: function () {
            this._emitToParent({
                type: 'resetComponent',
                'componentName': 'configModalLanguageProduct'
            });
        },
        _showModal: function () {
            this.resetForm();
        ...
        _cancel: function () {
            this.$refs.refLanguageProductModal.hide();
            this._resetComponent();
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                $this = this;
                ajaxRequest($('#action-language-product-setDelete').val(), {
                    type: 'POST',
                    data: dataSend,
