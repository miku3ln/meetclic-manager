var componentThisProductService;
Vue.component('product-service-component', {
    ...
    mounted: function () {
        componentThisProductService = this;
...
//form config
            ...
            formConfig: {
                nameSelector: "#product-service-form",
                url: $('#action-product-saveDataService').val(),
...
//Grid config
            gridConfig: {
                selectorCurrent: "#product-service-grid",
                url: $("#action-product-getAdminService").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
            ...
            if (params.managerType == "updateEntity") {
                ...
                if (this.configModalLanguageProduct.viewAllow) {
                    this.$refs.refLanguageProductMeasureType._setValueOfParent(
                        {type: "openModal", data: this.configModalLanguageProduct}
                    );
                } else {
...
//Manager Model
        ...
        getValuesSave: function () {
            var taxIdZero = $configPartial.managerProductService.data.taxCurrentZero.id;
            var taxIdCurrent = $configPartial.managerProductService.data.taxCurrent.id;
