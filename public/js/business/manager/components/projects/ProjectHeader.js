let configProcess = {//CPP-004
    'manager': UtilManagerCustomModel.getManagerData('project_header'),
    'nameProcess': 'ProjectHeader',
    'component': null,
};
                ...
                formatters: {
                    'description': function (column, row) {
                        ...
                        let description = (row.name !== "null" && row.name) ? [
                            ...
                            "</div>",
                            "<div class='content-description__information'>",
                            "   <span class='content-description__title'>Pais:</span><span class='content-description__value'>" + (row.countries_name) + "</span>",
                            "</div>",
                            "<div class='content-description__information'>",
                            "   <span class='content-description__title'>Empresa:</span><span class='content-description__value'>" + (row.contractor_company_name) + "</span>",
                            "</div>",
                            "<div class='content-description__information'>",
                            "   <span class='content-description__title'>Responsable Empresa:</span><span class='content-description__value'>" + (row.responsible_company_name) + "</span>",
                            "</div>",
                            "<div class='content-description__information'>",
                            "   <span class='content-description__title'>Administrador de Contrato:</span><span class='content-description__value'>" + (row.administrator_human_resources_employee_profile_name) + "</span>",
                            "</div>",
                            "<div class='content-description__information'>",
                            "   <span class='content-description__title'>Soporte de Contrato:</span><span class='content-description__value'>" + (row.help_desk_human_resources_employee_profile_name) + "</span>",
                            "</div>",
                            "<div class='content-description__information'>",
