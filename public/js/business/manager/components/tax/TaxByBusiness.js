var componentThisTaxByBusiness;
Vue.component('tax-by-business-component', {
    template: '#tax-by-business-template',
    directives: {
        initS2Tax: {
            inserted: function (el, binding, vnode, vm, arg) {
                var paramsInput = binding.value
                paramsInput._managerS2Tax({
    ...
    mounted: function () {
        componentThisTaxByBusiness = this;
...
//form config
            ...
            tabCurrentSelector: '#tab-tax-by-business',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#tax-by-business-form",
                url: $('#action-tax-by-business-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el TaxByBusiness.',
                successMessage: 'El TaxByBusiness se guardo correctamente.',
                nameModel: "TaxByBusiness"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#tax-by-business-grid",
                url: $("#action-tax-by-business-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                this.model.attributes.tax_id_data = {id: rowCurrent.tax_id, text: rowCurrent.tax};
            ...
            var formatters = {
                'description': function (column, row) {
                    ...
                    var result = [
                        ...
                        "   <span class='content-description__title'>" + structure.tax_id_data.label + ":</span><span class='content-description__value'>" + row.tax + "</span>",
                        "</div>",
...
//others functions
        _managerS2Tax: function (params) {
            var el = params.objSelector
            var valueCurrentRowId = params.rowId;

            var dataCurrent = [];
            if (valueCurrentRowId) {
                dataCurrent = [this.model.attributes.tax_id_data];
            }
            var _this = this
            var elementInit = $(el).select2({
                ...
                data: dataCurrent,
                ajax: {
                    url: $("#action-tax-getListSelect2").val(),
                    type: 'get',
                    dataType: 'json',
            ...
            elementInit.on('select2:select', function (e) {
                ...
                _this.model.attributes.tax_id_data = data;
            }).on("select2:unselecting", function (e) {
                _this.model.attributes.lodging_room_levels_id_data = null;
                _this._setValueForm('tax_id_data', null);
            });
        }
