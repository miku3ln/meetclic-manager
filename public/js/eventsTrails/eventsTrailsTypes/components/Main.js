var componentThisEventsTrailsTypes;
Vue.component('events-trails-types-component', {
    template: '#events-trails-types-template',
    props: {
        params: {
            type: Object,
        }
    ...
    mounted: function () {
        componentThisEventsTrailsTypes = this;
...
//form config
            ...
            tabCurrentSelector: '#tab-events-trails-types',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#events-trails-types-form",
                url: $('#action-events-trails-types-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el EventsTrailsTypes.',
                successMessage: 'El EventsTrailsTypes se guardo correctamente.',
                nameModel: "EventsTrailsTypes"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#events-trails-types-grid",
                url: $("#action-events-trails-types-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
