var componentThisEventsTrailsTypeOfCategories;
Vue.component('events-trails-type-of-categories-component', {
    template: '#events-trails-type-of-categories-template',
    props: {
        params: {
            type: Object,
        }
    ...
    mounted: function () {
        componentThisEventsTrailsTypeOfCategories = this;
...
//form config
            ...
            tabCurrentSelector: '#tab-events-trails-type-of-categories',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#events-trails-type-of-categories-form",
                url: $('#action-events-trails-type-of-categories-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el EventsTrailsTypeOfCategories.',
                successMessage: 'El EventsTrailsTypeOfCategories se guardo correctamente.',
                nameModel: "EventsTrailsTypeOfCategories"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#events-trails-type-of-categories-grid",
                url: $("#action-events-trails-type-of-categories-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                this.model.attributes.has_limit = rowCurrent.has_limit;
                this.model.attributes.init_limit = parseInt(rowCurrent.init_limit);
                this.model.attributes.end_limit = parseInt(rowCurrent.end_limit);
            ...
            gridInit.bootgrid({
                ...
                formatters: {
                    'description': function (column, row) {
                        ...
                        var hasLimit = row.has_limit ? [
                            "<div class='content-description__information'>",
                            "   <span class='content-description__title'>Inicio:</span><span class='content-description__value'>" + row.init_limit + "</span>",
                            "</div>",
                            "<div class='content-description__information'>",
                            "   <span class='content-description__title'>Fin:</span><span class='content-description__value'>" + row.end_limit + "</span>",
                            "</div>",
                        ] : [];
                        hasLimit = hasLimit.join('');
                        var result = [
                            ...
                            "</div>",
                            "<div class='content-description__information'>",
                            "   <span class='content-description__title'>Categoria:</span><span class='content-description__value'>" + row.value + "</span>",
                            "</div>",
                            hasLimit,
                            "<div class='content-description__information'>",
                ...
                EventsTrailsTypeOfCategories:
                    {
                        ...
                        "events_trails_project_id": this.events_trails_project_id,
                        "has_limit": this.$v.model.attributes.has_limit.$model,
                        "init_limit": this.$v.model.attributes.init_limit.$model,
                        "end_limit": this.$v.model.attributes.end_limit.$model,
