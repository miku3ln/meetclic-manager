var componentThisEventsTrailsTypeTeams;
Vue.component('events-trails-type-teams-component', {
    template: '#events-trails-type-teams-template',
    directives: {
        initS2EventsTrailsProject: {
            inserted: function (el, binding, vnode, vm, arg) {
                var paramsInput = binding.value
                paramsInput._managerS2EventsTrailsProject({
    ...
    mounted: function () {
        componentThisEventsTrailsTypeTeams = this;
...
//form config
            ...
            tabCurrentSelector: '#tab-events-trails-type-teams',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#events-trails-type-teams-form",
                url: $('#action-events-trails-type-teams-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el EventsTrailsTypeTeams.',
                successMessage: 'El EventsTrailsTypeTeams se guardo correctamente.',
                nameModel: "EventsTrailsTypeTeams"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#events-trails-type-teams-grid",
                url: $("#action-events-trails-type-teams-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                this.model.attributes.quantity = parseInt(rowCurrent.quantity);
                ...
                formatters: {
                    'description': function (column, row) {
                        ...
                        ;var result = [
                            ...
                            "</div>",
                            "<div class='content-description__information'>",
                            "   <span class='content-description__title'>" + structure.quantity.label + ":</span><span class='content-description__value'>" + row.quantity + "</span>",
                            "</div>",
                            "<div class='content-description__information'>",
...
//FORM CONFIG
        ...
        getAttributesForm: function () {
            var result = {
                "id": null,
                "value": null, "description": null, "status": "ACTIVE","quantity": 1,
            };
            return result;
        },
                ...
                EventsTrailsTypeTeams:
                    {
                        ...
                        "events_trails_project_id": this.events_trails_project_id,
                        "quantity": this.$v.model.attributes.quantity.$model
