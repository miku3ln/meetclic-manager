...
Vue.component('template-about-us-component', {
    template: '#template-about-us-template',
    directives: {
        initEventUploads: {
    ...
    created: function () {
        var vmCurrent = this;
        this.$root.$on("_templateAboutUs", function (emitValue) {
...
//form config
            ...
            tabCurrentSelector: '#tab-template-about-us',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#template-about-us-form",
                url: $('#action-template-about-us-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el TemplateAboutUs.',
                successMessage: 'El TemplateAboutUs se guardo correctamente.',
                nameModel: "TemplateAboutUs"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#template-about-us-grid",
                url: $("#action-template-about-us-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
            ...
            configModalTemplateAboutUsByData:{
                "title": "Title",
                "viewAllow": false,
                "data": []
            },
            configModalLanguageTemplateAboutUs: {
                "title": "Title",
                "viewAllow": false,
                "data": []
            }
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                this.configModalLanguageTemplateAboutUs.data = rowCurrent;
                if (this.configModalLanguageTemplateAboutUs.viewAllow) {
                    this.$refs.refLanguageTemplateAboutUs._setValueOfParent(
                        {type: "openModal", data: this.configModalLanguageTemplateAboutUs}
                    );
                } else {
                    this.configModalLanguageTemplateAboutUs.viewAllow = true;
                }
            }else{
                this.configModalTemplateAboutUsByData.data = rowCurrent;
                if (this.configModalTemplateAboutUsByData.viewAllow) {
                    this.$refs.refTemplateAboutUsByData._setValueOfParent(
                        {type: "openModal", data: this.configModalTemplateAboutUsByData}
                    );
                } else {
                    this.configModalTemplateAboutUsByData.viewAllow = true;
                }
            }
        },
