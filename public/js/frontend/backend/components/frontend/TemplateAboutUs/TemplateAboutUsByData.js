var componentThisTemplateAboutUsByData;
Vue.component('template-about-us-by-data-component', {
    template: '#template-about-us-by-data-template',
    directives: {
        initEventUploads: {
    ...
    created: function () {
        var vmCurrent = this;
        this.$root.$on("_templateAboutUsByData", function (emitValue) {
    ...
    mounted: function () {
        componentThisTemplateAboutUsByData = this;
...
//form config
            ...
            tabCurrentSelector: '#modal-template-about-us-by-data',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#template-about-us-by-data-form",
                url: $('#action-template-about-us-by-data-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el TemplateAboutUsByData.',
                successMessage: 'El TemplateAboutUsByData se guardo correctamente.',
                nameModel: "TemplateAboutUsByData"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#template-about-us-by-data-grid",
                url: $("#action-template-about-us-by-data-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
            ...
            model_id: null,
            rowCurrent: null,
            configModalLanguageTemplateAboutUsByData: {
                "title": "Title",
                "viewAllow": false,
                "data": []
            }
    ...
    methods: {
        ...
        initCurrentComponent: function () {
            ...
            this.$refs.refTemplateAboutUsByDataModal.show();
        },
        ...
        _hideModal: function () {
            this._emitToParent({
                type: 'resetComponent',
                'componentName': 'configModalTemplateAboutUsByData'
            });
        ...
        _cancel: function () {
            this.$refs.refTemplateAboutUsByDataModal.hide();
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                this.configModalLanguageTemplateAboutUsByData.data = rowCurrent;
                if (this.configModalLanguageTemplateAboutUsByData.viewAllow) {
                    this.$refs.refLanguageTemplateAboutUsByData._setValueOfParent(
                        {type: "openModal", data: this.configModalLanguageTemplateAboutUsByData}
                    );
                } else {
                    this.configModalLanguageTemplateAboutUsByData.viewAllow = true;
                }
            }
        },
...
//FORM CONFIG
        ...
        getAttributesForm: function () {
            var result = {
                ...
                "source": null,
                "allow_source_data": 0,
                "template_about_us_id_data": null,
                change: false,
            };
            return result;
        },
