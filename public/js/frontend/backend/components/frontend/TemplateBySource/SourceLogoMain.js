...
Vue.component('source-logo-main-component', {
    ...
    mounted: function () {
        componentThisSourceLogoMain = this;
    ...
    data: function () {
        ...
        var dataManager = {
            ...
            tabCurrentSelector: '#source-logo-main-manager',
    ...
    methods: {
        ...
        initCurrentComponent: function () {
            ...
            var rowCurrent = dataImages['logoMain'];
            if (rowCurrent) {
                var attributes = {
                    "id": rowCurrent.id,
