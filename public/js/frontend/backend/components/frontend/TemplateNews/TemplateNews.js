var componentThisTemplateNews;
Vue.component('template-news-component', {
    template: '#template-news-template',
    directives: {
        initEventUploads: {
    ...
    created: function () {
        var $this = this;
        this.$root.$on("_templateNews", function (emitValue) {
    ...
    mounted: function () {
        componentThisTemplateNews = this;
...
//form config
            ...
            tabCurrentSelector: '#tab-template-news',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#template-news-form",
                url: $('#action-template-news-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el Template News.',
                successMessage: 'El TemplateNews se guardo correctamente.',
                nameModel: "TemplateNews"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#template-news-grid",
                url: $("#action-template-news-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
            ...
            configModalTemplateNewsByData:{
                "title": "Title",
                "viewAllow": false,
                "data": []
            },
            configModalLanguageTemplateNews: {
                "title": "Title",
                "viewAllow": false,
                "data": []
            }
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                this.configModalLanguageTemplateNews.data = rowCurrent;
                if (this.configModalLanguageTemplateNews.viewAllow) {
                    this.$refs.refLanguageTemplateNews._setValueOfParent(
                        {type: "openModal", data: this.configModalLanguageTemplateNews}
                    );
                } else {
                    this.configModalLanguageTemplateNews.viewAllow = true;
                }
            }else{
                this.configModalTemplateNewsByData.data = rowCurrent;
                if (this.configModalTemplateNewsByData.viewAllow) {
                    this.$refs.refTemplateNewsByData._setValueOfParent(
                        {type: "openModal", data: this.configModalTemplateNewsByData}
                    );
                } else {
                    this.configModalTemplateNewsByData.viewAllow = true;
                }
            }
        },
            ...
            var formatters = {
                'description': function (column, row) {
                    ...
                    var result = [
                        ...
                        "</div>",
                        "<div class='content-description__information'>",
                        "   <span class='content-description__title'>" + structure.description.label + ":" +'<div>'+ row.description+'</div>' ,
                        "</div>",
