var componentThisTemplateNewsByData;
Vue.component('template-news-by-data-component', {
    template: '#template-news-by-data-template',
    directives: {
        initEventUploads: {
    ...
    created: function () {
        ...
        var vmCurrent = this;
        this.$root.$on("_templateNewsByData", function (emitValue) {
    ...
    mounted: function () {
        componentThisTemplateNewsByData = this;
...
//form config
            ...
            tabCurrentSelector: '#modal-template-news-by-data',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#template-news-by-data-form",
                url: $('#action-template-news-by-data-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el TemplateNewsByData.',
                successMessage: 'El TemplateNewsByData se guardo correctamente.',
                nameModel: "TemplateNewsByData"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#template-news-by-data-grid",
                url: $("#action-template-news-by-data-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
            ...
            model_id: null,
            rowCurrent: null,
            configModalLanguageTemplateNewsByData: {
                "title": "Title",
                "viewAllow": false,
                "data": []
            }
    ...
    methods: {
        ...
        initCurrentComponent: function () {
            ...
            this.$refs.refTemplateNewsByDataModal.show();
        },
        ...
        _hideModal: function () {
            this._emitToParent({
                type: 'resetComponent',
                'componentName': 'configModalTemplateNewsByData'
            });
        ...
        _cancel: function () {
            this.$refs.refTemplateNewsByDataModal.hide();
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                this.configModalLanguageTemplateNewsByData.data = rowCurrent;
                if (this.configModalLanguageTemplateNewsByData.viewAllow) {
                    this.$refs.refLanguageTemplateNewsByData._setValueOfParent(
                        {type: "openModal", data: this.configModalLanguageTemplateNewsByData}
                    );
                } else {
                    this.configModalLanguageTemplateNewsByData.viewAllow = true;
                }
            }
        },
        initGridManager: function (vmCurrent) {
            ...
            var paramsFilters = {
                template_news_id: this.model_id
