var componentThisTemplatePolicies;
Vue.component('template-policies-component', {
    template: '#template-policies-template',
    directives: {
        initEventUploads: {
    ...
    created: function () {
        var $this = this;
        this.$root.$on("_templatePolicies", function (emitValue) {
    ...
    mounted: function () {
        componentThisTemplatePolicies = this;
...
//form config
            ...
            tabCurrentSelector: '#tab-template-policies',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#template-policies-form",
                url: $('#action-template-policies-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el TemplatePolicies.',
                successMessage: 'El TemplatePolicies se guardo correctamente.',
                nameModel: "TemplatePolicies"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#template-policies-grid",
                url: $("#action-template-policies-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
            ...
            configModalTemplatePoliciesByData: {
                "title": "Title",
                "viewAllow": false,
                "data": []
            } , configModalLanguageTemplatePolicies: {
                "title": "Title",
                "viewAllow": false,
                "data": []
            }
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                this.configModalLanguageTemplatePolicies.data = rowCurrent;
                if (this.configModalLanguageTemplatePolicies.viewAllow) {
                    this.$refs.refLanguageTemplatePolicies._setValueOfParent(
                        {type: "openModal", data: this.configModalLanguageTemplatePolicies}
                    );
                } else {
                    this.configModalLanguageTemplatePolicies.viewAllow = true;
                }
            } else {
                this.configModalTemplatePoliciesByData.data = rowCurrent;
                if (this.configModalTemplatePoliciesByData.viewAllow) {
                    this.$refs.refTemplatePoliciesByData._setValueOfParent(
                        {type: "openModal", data: this.configModalTemplatePoliciesByData}
                    );
                } else {
                    this.configModalTemplatePoliciesByData.viewAllow = true;
                }
            }
        },
        ...
        getStructureForm: function () {
            var result = {
                ...
                type: {
                    ...
                    options: [{"value": 0, "text": "Politicas de Privacidad"}, {"value": 1, "text": "Terminos y codiciones de uso"}]
                },
                source: {
                    id: "source",
                    name: "source",
