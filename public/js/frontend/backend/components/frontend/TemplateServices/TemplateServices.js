var componentThisTemplateServices;
Vue.component('template-services-component', {
    template: '#template-services-template',
    directives: {
        initEventUploads: {
    ...
    created: function () {
        var $this = this;
        this.$root.$on("_templateServices", function (emitValue) {
    ...
    mounted: function () {
        componentThisTemplateServices = this;
...
//form config
            ...
            tabCurrentSelector: '#tab-template-services',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#template-services-form",
                url: $('#action-template-services-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el TemplateServices.',
                successMessage: 'El TemplateServices se guardo correctamente.',
                nameModel: "TemplateServices"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#template-services-grid",
                url: $("#action-template-services-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
            ...
            configModalTemplateServicesByData:{
                "title": "Title",
                "viewAllow": false,
                "data": []
            },
            configModalLanguageTemplateServices: {
                "title": "Title",
                "viewAllow": false,
                "data": []
            }
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                this.configModalLanguageTemplateServices.data = rowCurrent;
                if (this.configModalLanguageTemplateServices.viewAllow) {
                    this.$refs.refLanguageTemplateServices._setValueOfParent(
                        {type: "openModal", data: this.configModalLanguageTemplateServices}
                    );
                } else {
                    this.configModalLanguageTemplateServices.viewAllow = true;
                }
            }else{
                this.configModalTemplateServicesByData.data = rowCurrent;
                if (this.configModalTemplateServicesByData.viewAllow) {
                    this.$refs.refTemplateServicesByData._setValueOfParent(
                        {type: "openModal", data: this.configModalTemplateServicesByData}
                    );
                } else {
                    this.configModalTemplateServicesByData.viewAllow = true;
                }
            }
        },
