var componentThisTemplateServicesByData;
Vue.component('template-services-by-data-component', {
    template: '#template-services-by-data-template',
    directives: {
        initEventUploads: {
    ...
    created: function () {
        ...
        var vmCurrent = this;
        this.$root.$on("_templateServicesByData", function (emitValue) {
    ...
    mounted: function () {
        componentThisTemplateServicesByData = this;
...
//form config
            ...
            tabCurrentSelector: '#modal-template-services-by-data',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#template-services-by-data-form",
                url: $('#action-template-services-by-data-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el TemplateServicesByData.',
                successMessage: 'El TemplateServicesByData se guardo correctamente.',
                nameModel: "TemplateServicesByData"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#template-services-by-data-grid",
                url: $("#action-template-services-by-data-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
            ...
            model_id: null,
            rowCurrent: null,
            configModalLanguageTemplateServicesByData: {
                "title": "Title",
                "viewAllow": false,
                "data": []
            }
    ...
    methods: {
        ...
        initCurrentComponent: function () {
            ...
            this.$refs.refTemplateServicesByDataModal.show();
        },
        ...
        _hideModal: function () {
            this._emitToParent({
                type: 'resetComponent',
                'componentName': 'configModalTemplateServicesByData'
            });
        ...
        _cancel: function () {
            this.$refs.refTemplateServicesByDataModal.hide();
        ...
        _emitToParent: function (params) {
            this.$root.$emit('_templateServices', params);
        },
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                this.configModalLanguageTemplateServicesByData.data = rowCurrent;
                if (this.configModalLanguageTemplateServicesByData.viewAllow) {
                    this.$refs.refLanguageTemplateServicesByData._setValueOfParent(
                        {type: "openModal", data: this.configModalLanguageTemplateServicesByData}
                    );
                } else {
                    this.configModalLanguageTemplateServicesByData.viewAllow = true;
                }
            }
        },
        initGridManager: function (vmCurrent) {
            ...
            var paramsFilters = {
                template_services_id: this.model_id
...
//FORM CONFIG
        ...
        getAttributesForm: function () {
            var result = {
                ...
                "source": null,
                "allow_source_data": 0,
                "template_services_id_data": null,
                change: false,
            };
            return result;
        },
