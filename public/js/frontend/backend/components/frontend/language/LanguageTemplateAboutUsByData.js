var componentThisLanguageTemplateAboutUsByData;
Vue.component('language-template-about-us-by-data-component', {
    template: '#language-template-about-us-by-data-template',
    directives: {
        initS2Language: {
    ...
    mounted: function () {
        componentThisLanguageTemplateAboutUsByData = this;
...
//form config
            ...
            tabCurrentSelector: '#modal-language-template-about-us-by-data',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#language-template-about-us-by-data-form",
                url: $('#action-language-template-about-us-by-data-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el LanguageTemplateAboutUsByData.',
                successMessage: 'El LanguageTemplateAboutUsByData se guardo correctamente.',
                nameModel: "LanguageTemplateAboutUsByData"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#language-template-about-us-by-data-grid",
                url: $("#action-language-template-about-us-by-data-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
    ...
    methods: {
        ...
        initCurrentComponent: function () {
            ...
            this.$refs.refLanguageTemplateAboutUsByDataModal.show();
        },

        /*modal events*/
        _resetComponent: function () {
            this.$refs.refLanguageTemplateAboutUsByDataModal.hide();
            this._emitToParent({type:'resetComponent',componentName:'configModalLanguageTemplateAboutUsByData'});
        },
        _showModal: function () {
            this.resetForm();
        ...
        _emitToParent: function (params) {
            this.$root.$emit('_templateAboutUsByData', params);
        },
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                $this = this;
                ajaxRequest($('#action-language-template-about-us-by-data-setDelete').val(), {
                    type: 'POST',
                    data: dataSend,
        ...
        initGridManager: function (vmCurrent) {
            ...
            var paramsFilters = {
                template_about_us_by_data_id: this.model_id
            };
