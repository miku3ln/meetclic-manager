var componentThisLanguageTemplatePolicies;
Vue.component('language-template-policies-component', {
    template: '#language-template-policies-template',
    directives: {
        initS2Language: {
    ...
    mounted: function () {
        componentThisLanguageTemplatePolicies = this;
...
//form config
            ...
            tabCurrentSelector: '#modal-language-template-policies',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#language-template-policies-form",
                url: $('#action-language-template-policies-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el LanguageTemplatePolicies.',
                successMessage: 'El LanguageTemplatePolicies se guardo correctamente.',
                nameModel: "LanguageTemplatePolicies"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#language-template-policies-grid",
                url: $("#action-language-template-policies-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
    ...
    methods: {
        ...
        initCurrentComponent: function () {
            ...
            this.$refs.refLanguageTemplatePoliciesModal.show();
        },
        ...
        _resetComponent: function () {
            this._emitToParent({
                type: 'resetComponent',
                'componentName': 'configModalLanguageTemplatePolicies'
            });
        },
        _showModal: function () {
            this.resetForm();
        ...
        _cancel: function () {
            this.$refs.refLanguageTemplatePoliciesModal.hide();
            this._resetComponent();
        ...
        _emitToParent: function (params) {
            this.$root.$emit('_templatePolicies', params);
        },
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                $this = this;
                ajaxRequest($('#action-language-template-policies-setDelete').val(), {
                    type: 'POST',
                    data: dataSend,
        ...
        initGridManager: function (vmCurrent) {
            ...
            var paramsFilters = {
                template_policies_id: this.model_id
            };
...
//others functions
        ...
        _initSummerNote: function (params) {
            ...
            var fieldCurrentModel = fieldCurrent.split('-')[0];

            var $this = this;

            if (this.model.attributes.id) {
                var htmlSet = this.model.attributes[fieldCurrentModel];
                ...
                callbacks: {
                    onChange: function (contents, $editable) {
                        ...
                        if ('<p><br></p>' == contents || '' == contents) {
                            $this.model.attributes[fieldCurrentModel] = null;
                        } else {
                            $this.model.attributes[fieldCurrentModel] = contents;
                        }
                    }
                }
            });
