var componentThisLanguageTemplateServices;
Vue.component('language-template-services-component', {
    template: '#language-template-services-template',
    directives: {
        initS2Language: {
    ...
    mounted: function () {
        componentThisLanguageTemplateServices = this;
...
//form config
            ...
            tabCurrentSelector: '#modal-language-template-services',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#language-template-services-form",
                url: $('#action-language-template-services-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el LanguageTemplateServices.',
                successMessage: 'El LanguageTemplateServices se guardo correctamente.',
                nameModel: "LanguageTemplateServices"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#language-template-services-grid",
                url: $("#action-language-template-services-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
    ...
    methods: {
        ...
        initCurrentComponent: function () {
            ...
            this.$refs.refLanguageTemplateServicesModal.show();
        },
        ...
        _resetComponent: function () {
            this._emitToParent({
                type: 'resetComponent',
                'componentName': 'configModalLanguageTemplateServices'
            });
        },
        _showModal: function () {
            this.resetForm();
        ...
        _cancel: function () {
            this.$refs.refLanguageTemplateServicesModal.hide();
            this._resetComponent();
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                $this = this;
                ajaxRequest($('#action-language-template-services-setDelete').val(), {
                    type: 'POST',
                    data: dataSend,
