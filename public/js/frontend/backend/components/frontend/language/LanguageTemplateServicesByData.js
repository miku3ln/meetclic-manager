var componentThisLanguageTemplateServicesByData;
Vue.component('language-template-services-by-data-component', {
    template: '#language-template-services-by-data-template',
    directives: {
        initS2Language: {
    ...
    mounted: function () {
        componentThisLanguageTemplateServicesByData = this;
...
//form config
            ...
            tabCurrentSelector: '#modal-language-template-services-by-data',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#language-template-services-by-data-form",
                url: $('#action-language-template-services-by-data-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el LanguageTemplateServicesByData.',
                successMessage: 'El LanguageTemplateServicesByData se guardo correctamente.',
                nameModel: "LanguageTemplateServicesByData"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#language-template-services-by-data-grid",
                url: $("#action-language-template-services-by-data-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
    ...
    methods: {
        ...
        initCurrentComponent: function () {
            ...
            this.$refs.refLanguageTemplateServicesByDataModal.show();
        },

        /*modal events*/
        _resetComponent: function () {
            this.$refs.refLanguageTemplateServicesByDataModal.hide();
            this._emitToParent({type: 'resetComponent', componentName: 'configModalLanguageTemplateServicesByData'});
        },
        _showModal: function () {
            this.resetForm();
        ...
        _emitToParent: function (params) {
            this.$root.$emit('_templateServicesByData', params);
        },
//EVENTS OF CHILDREN
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                $this = this;
                ajaxRequest($('#action-language-template-services-by-data-setDelete').val(), {
                    type: 'POST',
                    data: dataSend,
        ...
        initGridManager: function (vmCurrent) {
            ...
            var paramsFilters = {
                template_services_by_data_id: this.model_id
            };
...
//Manager Model
        ...
        getValuesSave: function () {
            ...
            var result = {
                LanguageTemplateServicesByData:
                    {
