var componentThisLanguageTemplateSliderByImages;
Vue.component('language-template-slider-by-images-component', {
    template: '#language-template-slider-by-images-template',
    directives: {
        initS2Language: {
    ...
    mounted: function () {
        componentThisLanguageTemplateSliderByImages = this;
        this.initCurrentComponent();
    },
    validations: function () {
        var attributes = {
            "id": {},
            "title": {required, maxLength: Validators.maxLength(200)},
            "state": {required},
            "subtitle": {required, maxLength: Validators.maxLength(250)},
...
//form config
            ...
            tabCurrentSelector: '#modal-language-template-slider-by-images',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#language-template-slider-by-images-form",
                url: getUrlSaveLanguageSlider(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el LanguageTemplateSliderByImages.',
                successMessage: 'El LanguageTemplateSliderByImages se guardo correctamente.',
                nameModel: "LanguageTemplateSliderByImages"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#language-template-slider-by-images-grid",
                url: getUrlAdminLanguageSlider()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
    ...
    methods: {
        ...
        initCurrentComponent: function () {
            ...
            this.$refs.refLanguageTemplateSliderByImagesModal.show();
        },
        ...
        _resetComponent: function () {
            this._emitToParent({
                type: 'resetComponent',
                'componentName': 'configModalLanguageTemplateSliderByImages'
            });
        },
        _showModal: function () {
            this.resetForm();
        ...
        _cancel: function () {
            this.$refs.refLanguageTemplateSliderByImagesModal.hide();
            this._resetComponent();
        ...
        _emitToParent: function (params) {
            this.$root.$emit('_templateSliderByImages', params);
        },
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                ajaxRequest($('#action-language-template-slider-by-images-setDelete').val(), {
                    type: 'POST',
                    data: dataSend,
        ...
        initGridManager: function (vmCurrent) {
            ...
            var paramsFilters = {
                template_slider_by_images_id: this.model_id
            };
...
//Manager Model
        ...
        getValuesSave: function () {
            ...
            var result = {
                LanguageTemplateSliderByImages:
                    {
...
function getUrlAdminLanguageSlider() {
    $typeManager = $configPartial['typeManager'];
    $result = $("#action-language-template-slider-by-images-getAdmin").val();
    if ($typeManager == "managerActivitiesGamification") {
        $result = $("#action-language-template-slider-by-images-getAdminActivitiesGamification").val();

    } else if ($typeManager == "managerRewardsGamification") {
        $result = $("#action-language-template-slider-by-images-getAdminRewardsGamification").val();

    }
    return $result;
}

function getUrlSaveLanguageSlider() {
    $typeManager = $configPartial['typeManager'];
    $result = $('#action-language-template-slider-by-images-saveData').val();
    if ($typeManager == "managerActivitiesGamification") {
        $result = $('#action-language-template-slider-by-images-saveDataActivitiesGamification').val();

    } else if ($typeManager == "managerRewardsGamification") {
        $result = $('#action-language-template-slider-by-images-saveDataRewardsGamification').val();
