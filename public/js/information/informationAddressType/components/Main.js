var componentThisInformationAddressType;
Vue.component('information-address-type-component', {
    template: '#information-address-type-template',
    props: {
        params: {
            type: Object,
        }
    ...
    mounted: function () {
        componentThisInformationAddressType = this;
...
//form config
            ...
            tabCurrentSelector: '#tab-information-address-type',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#information-address-type-form",
                url: $('#action-information-address-type-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el InformationAddressType.',
                successMessage: 'El InformationAddressType se guardo correctamente.',
                nameModel: "InformationAddressType"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#information-address-type-grid",
                url: $("#action-information-address-type-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
