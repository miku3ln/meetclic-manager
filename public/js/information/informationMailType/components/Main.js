...
Vue.component('information-mail-type-component', {
    template: '#information-mail-type-template',
    props: {
        params: {
            type: Object,
        }
...
//form config
            ...
            tabCurrentSelector: '#tab-information-mail-type',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#information-mail-type-form",
                url: $('#action-information-mail-type-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el InformationMailType.',
                successMessage: 'El InformationMailType se guardo correctamente.',
                nameModel: "InformationMailType"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#information-mail-type-grid",
                url: $("#action-information-mail-type-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
