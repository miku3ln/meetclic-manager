var componentThisInformationPhoneOperator;
Vue.component('information-phone-operator-component', {
    template: '#information-phone-operator-template',
    props: {
        params: {
            type: Object,
        }
    ...
    mounted: function () {
        componentThisInformationPhoneOperator = this;
...
//form config
            ...
            tabCurrentSelector: '#tab-information-phone-operator',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#information-phone-operator-form",
                url: $('#action-information-phone-operator-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el InformationPhoneOperator.',
                successMessage: 'El InformationPhoneOperator se guardo correctamente.',
                nameModel: "InformationPhoneOperator"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#information-phone-operator-grid",
                url: $("#action-information-phone-operator-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
