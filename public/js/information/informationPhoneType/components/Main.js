var componentThisInformationPhoneType;
Vue.component('information-phone-type-component', {
    ...
    mounted: function () {
        componentThisInformationPhoneType = this;
...
//form config
            ...
            formConfig: {
                ...
                url: $('#action-information-phone-type-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el InformationPhoneType.',
                successMessage: 'El InformationPhoneType se guardo correctamente.',
                nameModel: "InformationPhoneType"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#information-phone-type-grid",
                url: $("#action-information-phone-type-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
