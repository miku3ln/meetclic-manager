...
Vue.component('language-component', {
    ...
    validations: function () {
        var attributes = {
            ...
            "initials": {required, maxLength: Validators.maxLength(4)},
            "state": {required},
            "description": {}
        };
        var result = {
...
//form config
            ...
            tabCurrentSelector: '#tab-language',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#language-form",
                url: $('#action-language-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el Language.',
                successMessage: 'El Language se guardo correctamente.',
                nameModel: "Language"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#language-grid",
                url: $("#action-language-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                this.model.attributes.initials = rowCurrent.initials;
            ...
            var formatters = {
                'description': function (column, row) {
                    ...
                    ;var result = [
                        ...
                        "<div class='content-description__information'>",
                        "   <span class='content-description__title'>" + structure.initials.label + ":</span><span class='content-description__value'>" + row.initials + "</span>",
                        "</div>",
...
//FORM CONFIG
        ...
        getStructureForm: function () {
            var result = {
                ...
                initials: {
                    ...
                    maxLength: {
                        msj: "# Carecteres Excedidos a 4.",
                    },
                    options:[
                        {value:'es',text:"Español"},
                        {value:'kic',text:"Kichwa"},
                        {value:'en',text:"Inglés"},
                        {value:'cmn',text:"Mandarín"},
                        {value:'de',text:"Alemán"},
                        {value:'fr',text:"Francés"},
                        {value:'ko',text:"Koreano"},
                        {value:'ru',text:"Ruso"},
        ...
        getAttributesForm: function () {
            var result = {
                "id": null,
                "value": null, "initials": null, "state": "ACTIVE", "description": null
            };
            return result;
        },
                ...
                Language:
                    {
                        ...
                        "initials": this.$v.model.attributes.initials.$model,
