...
function setValuePatientInformation(data){
    if(data){
        patient_id= data.id;
        patient_information={patient_id:patient_id};
        informationName=data.text;
    }
    else{
        patient_id= null;
        patient_information={};
    ...
    viewValuePatient(informationName);
}
function viewValuePatient(informationName){
    $(".m-portlet__head-text-patient").html(informationName);
}
