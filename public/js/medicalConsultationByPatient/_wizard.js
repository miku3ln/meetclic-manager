    ...
    return {
        init: function () {
                ...
                rWizardObj.on("change", function (e) {
                    ...
                    if (!OdontogramByPatient) {
                        OdontogramByPatient = new managementOdontogram({
                            managementEntity: "odontogram_by_patient",
                            "managementFrm": "odontogramByPatient"
                        });
                    }
                    if(!OdontogramByPatient.getInitEventPortlet()){
            ...
            $('.m-wizard__step-number').on("click", function (e) {
                ...
                stepXElement = $(this).parent().attr("m-wizard-target");

                if (stepXElement) {
                    stepX = stepXElement.split("_")[4];
                    console.log(stepX, "stepX");
                    /*eValidateFrm.form()*/
                    if (eValidateFrm.form()) {
