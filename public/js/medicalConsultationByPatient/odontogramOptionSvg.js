...
function renderOdontograms() {
    ...
    var functionsObjThis = {
        initOdontogramsSvg: function () {
            ...
            action_odontogram_dental_piece_by_odontogram
        ...
        , resizeElementsSNAPSVG: function () {
            resizeElementsSNAPSVG();
    ...
    function resizeElementsSNAPSVG() {
    ...
    function setDimention(elementSNAPSVGChange) {
        var width = $(".m-portlet.m-portlet--full-height").width() - $(".m-portlet.m-portlet--full-height").width() * 22.1 / 100;
        var height = 200;
