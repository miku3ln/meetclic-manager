var componentThisPeopleGender;
Vue.component($configPartial.modelNameAction+'-component', {
    template: '#'+$configPartial['modelNameAction']+'-template',
    props: {
        params: {
            type: Object,
        }
    ...
    mounted: function () {
        componentThisPeopleGender = this;
        this.initCurrentComponent();
    },
    validations: function () {
        var attributes = {
            "id": {},
            "name": {required, maxLength: Validators.maxLength(250)},
            "description": {},
            "status": {required}
        };
        var result = {
...
//form config
            ...
            formConfig: {
                ...
                errorMessage: 'Error al guardar el PeopleGender.',
                successMessage: 'El PeopleGender se guardo correctamente.',
                nameModel: "PeopleGender"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#"+$configPartial.modelNameAction+"-grid",
                url: $("#action-"+$configPartial.modelNameAction+"-getAdmin").val()
            },
            showManager: false,
            managerType: null,
        };
