var componentThisPeopleTypeIdentification;
Vue.component($configPartial.modelNameAction + '-component', {
    template: '#' + $configPartial.modelNameAction + '-template', props: {
        params: {
            type: Object,
        }
    }, created: function () {
        ...
        componentThisPeopleTypeIdentification = this;
...
//**Modal*
            ...
            tabCurrentSelector: '#tab-' + $configPartial.modelNameAction,
            processName: "Registro Ruc.",
            formConfig: {
                nameSelector: "#" + $configPartial.modelNameAction + "-form",
                url: $('#action-' + $configPartial.modelNameAction + '-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar la nacionalidad.',
                successMessage: 'La nacionalidad se guardo correctamente.',
                nameModel: "PeopleTypeIdentification"
            },
            gridConfig: {
                selectorCurrent: "#" + $configPartial.modelNameAction + "-grid",
                url: $("#action-" + $configPartial.modelNameAction + "-admin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
            codeManager: [{id: "C", text: "CEDULA"}, {id: "R", text: "RUC"}, {id: "P", text: "PASAPORTE"}, {
                id: "F",
                text: "CONSUMIDOR FINAL"
            }, {id: "PL", text: "PLACA - RAMV/CPN"}, {id: "-", text: "-"},
        ...
        _destroyTooltip: function (selector) {
            ...
            gridInit.bootgrid({
                ajaxSettings: {
                    method: "POST"
                }, ajax: true, post: function () {
                    return {
                        grid_id: gridName, filters: paramsFilters
                    };
                }, url: urlCurrent, labels: {
                    loading: "Cargando...",
                    noResults: "Sin Resultados!",
                    infos: "Mostrando {{ctx.start}} - {{ctx.end}} de {{ctx.total}} resultados"
                }, css: getCSSCurrentBootGrid(), formatters: {
                    'description': function (column, row) {

                        var description = (row.name !== "null" && row.name) ? ["<div class='content-description__information'>", "   <span class='content-description__title'>Nombre:</span><span class='content-description__value'>" + (row.name) + "</span>", "</div>", "<div class='content-description__information'>", "   <span class='content-description__title'>Descripción:</span><span class='content-description__value'>" + (row.description) + "</span>", "</div>",] : [];
        ...
        getViewErrorForm: function (objValidate) {
            ...
            var result = {
                ...
                name: {
                    ...
                    id: "description", name: "description", label: "Descripción", required: {
                        allow: false, msj: "Campo requerido.", error: false
                    }
                }, code: {
                    id: "code", name: "code", label: "Código", required: {
                        allow: true, msj: "Campo requerido.", error: false
                    }, maxLength: {
                        msj: 'Muy Pe'
                    }
            ...
            var result = {
                name: null, "description": null, code: "-", "status": "ACTIVE"
            };
        ...
        getValuesSave: function () {
            var result = {};
            result[$configPartial.modelName] = {
        ...
        }, getValidateForm: getValidateForm, _resetModel: function (model) {
            model.$reset();
