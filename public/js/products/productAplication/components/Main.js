var componentThisProductAplication;
Vue.component('product-aplication-component', {
    template: '#product-aplication-template',
    props: {
        params: {
            type: Object,
        }
    ...
    mounted: function () {
        componentThisProductAplication = this;
...
//form config
            ...
            tabCurrentSelector: '#tab-product-aplication',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#product-aplication-form",
                url: $('#action-product-aplication-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el ProductAplication.',
                successMessage: 'El ProductAplication se guardo correctamente.',
                nameModel: "ProductAplication"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#product-aplication-grid",
                url: $("#action-product-aplication-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
