var componentThisProductCategory;
Vue.component('product-category-component', {
    ...
    mounted: function () {
        componentThisProductCategory = this;
...
//form config
            ...
            tabCurrentSelector: '#tab-product-category',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#product-category-form",
                url: $('#action-product-category-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el ProductCategory.',
                successMessage: 'El ProductCategory se guardo correctamente.',
                nameModel: "ProductCategory"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#product-category-grid",
                url: $("#action-product-category-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,

            configModalLanguageProductCategory: {
                "title": "Title",
                "viewAllow": false,
                "data": []
            }
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                this.configModalLanguageProductCategory.data = rowCurrent;
                if (this.configModalLanguageProductCategory.viewAllow) {
                    this.$refs.refLanguageProductCategory._setValueOfParent(
                        {type: "openModal", data: this.configModalLanguageProductCategory}
                    );
                } else {
                    this.configModalLanguageProductCategory.viewAllow = true;
                }
            }
        },
...
//FORM CONFIG
        ...
        getAttributesForm: function () {
            var result = {
                "id": null,
                "change": false, "value": null, "state": 'ACTIVE', "description": null, "subtitle": null, "source": null
            };
            return result;
        },
...
//others functions
        _managerEventsUploadSource: function (params) {
