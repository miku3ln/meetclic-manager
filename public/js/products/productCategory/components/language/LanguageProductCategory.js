var componentThisLanguageProductCategory;
Vue.component('language-product-category-component', {
    template: '#language-product-category-template',
    directives: {
        initS2Language: {
    ...
    mounted: function () {
        componentThisLanguageProductCategory = this;
...
//form config
            ...
            tabCurrentSelector: '#modal-language-product-category',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#language-product-category-form",
                url: $('#action-language-product-category-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el LanguageProductCategory.',
                successMessage: 'El LanguageProductCategory se guardo correctamente.',
                nameModel: "LanguageProductCategory"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#language-product-category-grid",
                url: $("#action-language-product-category-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
    ...
    methods: {
        ...
        initCurrentComponent: function () {
            ...
            this.$refs.refLanguageProductCategoryModal.show();
        },
        ...
        _resetComponent: function () {
            this._emitToParent({
                type: 'resetComponent',
                'componentName': 'configModalLanguageProductCategory'
            });
        },
        _showModal: function () {
            this.resetForm();
        ...
        _cancel: function () {
            this.$refs.refLanguageProductCategoryModal.hide();
            this._resetComponent();
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                $this = this;
                ajaxRequest($('#action-language-product-category-setDelete').val(), {
                    type: 'POST',
                    data: dataSend,
        ...
        initGridManager: function (vmCurrent) {
            ...
            var paramsFilters = {
                product_category_id: this.model_id
            };
