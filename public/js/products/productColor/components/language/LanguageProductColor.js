var componentThisLanguageProductColor;
Vue.component('language-product-color-component', {
    template: '#language-product-color-template',
    directives: {
        initS2Language: {
    ...
    mounted: function () {
        componentThisLanguageProductColor = this;
...
//form config
            ...
            tabCurrentSelector: '#modal-language-product-color',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#language-product-color-form",
                url: $('#action-language-product-color-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el LanguageProductColor.',
                successMessage: 'El LanguageProductColor se guardo correctamente.',
                nameModel: "LanguageProductColor"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#language-product-color-grid",
                url: $("#action-language-product-color-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
    ...
    methods: {
        ...
        initCurrentComponent: function () {
            ...
            this.$refs.refLanguageProductColorModal.show();
        },
        ...
        _resetComponent: function () {
            this._emitToParent({
                type: 'resetComponent',
                'componentName': 'configModalLanguageProductColor'
            });
        },
        _showModal: function () {
            this.resetForm();
        ...
        _cancel: function () {
            this.$refs.refLanguageProductColorModal.hide();
            this._resetComponent();
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                $this = this;
                ajaxRequest($('#action-language-product-color-setDelete').val(), {
                    type: 'POST',
                    data: dataSend,
        ...
        initGridManager: function (vmCurrent) {
            ...
            var paramsFilters = {
                product_color_id: this.model_id
            };
