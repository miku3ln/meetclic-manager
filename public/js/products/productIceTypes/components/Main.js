var componentThisProductIceTypes;
Vue.component('product-ice-types-component', {
    template: '#product-ice-types-template',
    props: {
        params: {
            type: Object,
        }
    ...
    mounted: function () {
        componentThisProductIceTypes = this;
...
//form config
            ...
            tabCurrentSelector: '#tab-product-ice-types',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#product-ice-types-form",
                url: $('#action-product-ice-types-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el ProductIceTypes.',
                successMessage: 'El ProductIceTypes se guardo correctamente.',
                nameModel: "ProductIceTypes"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#product-ice-types-grid",
                url: $("#action-product-ice-types-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
