var componentThisLanguageProductMeasureType;
Vue.component('language-product-measure-type-component', {
    template: '#language-product-measure-type-template',
    directives: {
        initS2Language: {
    ...
    mounted: function () {
        componentThisLanguageProductMeasureType = this;
...
//form config
            ...
            tabCurrentSelector: '#modal-language-product-measure-type',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#language-product-measure-type-form",
                url: $('#action-language-product-measure-type-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el LanguageProductMeasureType.',
                successMessage: 'El LanguageProductMeasureType se guardo correctamente.',
                nameModel: "LanguageProductMeasureType"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#language-product-measure-type-grid",
                url: $("#action-language-product-measure-type-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
    ...
    methods: {
        ...
        initCurrentComponent: function () {
            ...
            this.$refs.refLanguageProductMeasureTypeModal.show();
        },
        ...
        _resetComponent: function () {
            this._emitToParent({
                type: 'resetComponent',
                'componentName': 'configModalLanguageProductMeasureType'
            });
        },
        _showModal: function () {
            this.resetForm();
        ...
        _cancel: function () {
            this.$refs.refLanguageProductMeasureTypeModal.hide();
            this._resetComponent();
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                $this = this;
                ajaxRequest($('#action-language-product-measure-type-setDelete').val(), {
                    type: 'POST',
                    data: dataSend,
        ...
        initGridManager: function (vmCurrent) {
            ...
            var paramsFilters = {
                product_measure_type_id: this.model_id
            };
