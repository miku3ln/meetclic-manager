var componentThisProductSizes;
Vue.component('product-sizes-component', {
    template: '#product-sizes-template',
    props: {
        params: {
            type: Object,
        }
    ...
    mounted: function () {
        componentThisProductSizes = this;
...
//form config
            ...
            tabCurrentSelector: '#tab-product-sizes',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#product-sizes-form",
                url: $('#action-product-sizes-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el ProductSizes.',
                successMessage: 'El ProductSizes se guardo correctamente.',
                nameModel: "ProductSizes"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#product-sizes-grid",
                url: $("#action-product-sizes-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
