var componentThisProductSubcategory;
Vue.component('product-subcategory-component', {
    template: '#product-subcategory-template',
    directives: {
    ...
    mounted: function () {
        componentThisProductSubcategory = this;
...
//form config
            ...
            tabCurrentSelector: '#tab-product-subcategory',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#product-subcategory-form",
                url: $('#action-product-subcategory-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el ProductSubcategory.',
                successMessage: 'El ProductSubcategory se guardo correctamente.',
                nameModel: "ProductSubcategory"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#product-subcategory-grid",
                url: $("#action-product-subcategory-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
            configModalLanguageProductSubcategory: {
                "title": "Title",
                "viewAllow": false,
                "data": []
            }
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                this.configModalLanguageProductSubcategory.data = rowCurrent;
                if (this.configModalLanguageProductSubcategory.viewAllow) {
                    this.$refs.refLanguageProductSubcategory._setValueOfParent(
                        {type: "openModal", data: this.configModalLanguageProductSubcategory}
                    );
                } else {
                    this.configModalLanguageProductSubcategory.viewAllow = true;
                }
            }
        },
            ...
            var formatters = {
                'description': function (column, row) {
                    ...
                    ;var result = [
                        ...
                        "</div>",
                        "<div class='content-description__information'>",
                        "   <span   11  class='content-description__title'>" + structure.product_category_id_data.label + ":</span><span class='content-description__value'>" + row.product_category + "</span>",
                        "</div>",
                        "<div class='content-description__information'>",
...
//others functions
        _managerEventsUpload: function (params) {
            ...
            elementInit.on('select2:select', function (e) {
                ...
                _this.model.attributes.product_category_id_data = data;
            }).on("select2:unselecting", function (e) {
                _this.model.attributes.lodging_room_levels_id_data = null;
                _this._setValueForm('product_category_id_data', null);
            });
        },
        //uploads methods
