var componentThisLanguageProductSubcategory;
Vue.component('language-product-subcategory-component', {
    template: '#language-product-subcategory-template',
    directives: {
        initS2Language: {
    ...
    mounted: function () {
        componentThisLanguageProductSubcategory = this;
...
//form config
            ...
            tabCurrentSelector: '#modal-language-product-subcategory',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#language-product-subcategory-form",
                url: $('#action-language-product-subcategory-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el LanguageProductSubcategory.',
                successMessage: 'El LanguageProductSubcategory se guardo correctamente.',
                nameModel: "LanguageProductSubcategory"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#language-product-subcategory-grid",
                url: $("#action-language-product-subcategory-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
    ...
    methods: {
        ...
        initCurrentComponent: function () {
            ...
            this.$refs.refLanguageProductSubcategoryModal.show();
        },
        ...
        _resetComponent: function () {
            this._emitToParent({
                type: 'resetComponent',
                'componentName': 'configModalLanguageProductSubcategory'
            });
        },
        _showModal: function () {
            this.resetForm();
        ...
        _cancel: function () {
            this.$refs.refLanguageProductSubcategoryModal.hide();
            this._resetComponent();
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                $this = this;
                ajaxRequest($('#action-language-product-subcategory-setDelete').val(), {
                    type: 'POST',
                    data: dataSend,
        ...
        initGridManager: function (vmCurrent) {
            ...
            var paramsFilters = {
                product_subcategory_id: this.model_id
            };
