var componentThisProductTrademark;
Vue.component('product-trademark-component', {
    template: '#product-trademark-template',
    props: {
        params: {
            type: Object,
        }
    ...
    mounted: function () {
        componentThisProductTrademark = this;
...
//form config
            ...
            tabCurrentSelector: '#tab-product-trademark',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#product-trademark-form",
                url: $('#action-product-trademark-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el ProductTrademark.',
                successMessage: 'El ProductTrademark se guardo correctamente.',
                nameModel: "ProductTrademark"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#product-trademark-grid",
                url: $("#action-product-trademark-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
            configModalLanguageProductTrademark: {
                "title": "Title",
                "viewAllow": false,
                "data": []
            }
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                this.configModalLanguageProductTrademark.data = rowCurrent;
                if (this.configModalLanguageProductTrademark.viewAllow) {
                    this.$refs.refLanguageProductTrademark._setValueOfParent(
                        {type: "openModal", data: this.configModalLanguageProductTrademark}
                    );
                } else {
                    this.configModalLanguageProductTrademark.viewAllow = true;
                }
            }
        },
        ...
        getStructureForm: function () {
            var result = {
                    ...
                    state:
                        {
                            id: "state",
                            name: "state", label: "Estado", required:
                                {
                                    allow: true,
