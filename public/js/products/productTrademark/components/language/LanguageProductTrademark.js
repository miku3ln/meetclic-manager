var componentThisLanguageProductTrademark;
Vue.component('language-product-trademark-component', {
    template: '#language-product-trademark-template',
    directives: {
        initS2Language: {
    ...
    mounted: function () {
        componentThisLanguageProductTrademark = this;
...
//form config
            ...
            tabCurrentSelector: '#modal-language-product-trademark',
            processName: "Registro Acción.",
            formConfig: {
                nameSelector: "#language-product-trademark-form",
                url: $('#action-language-product-trademark-saveData').val(),
                loadingMessage: 'Guardando...',
                errorMessage: 'Error al guardar el LanguageProductTrademark.',
                successMessage: 'El LanguageProductTrademark se guardo correctamente.',
                nameModel: "LanguageProductTrademark"
            },
//Grid config
            gridConfig: {
                selectorCurrent: "#language-product-trademark-grid",
                url: $("#action-language-product-trademark-getAdmin").val()
            },
            submitStatus: "no",
            showManager: false,
            managerType: null,
    ...
    methods: {
        ...
        initCurrentComponent: function () {
            ...
            this.$refs.refLanguageProductTrademarkModal.show();
        },
        ...
        _resetComponent: function () {
            this._emitToParent({
                type: 'resetComponent',
                'componentName': 'configModalLanguageProductTrademark'
            });
        },
        _showModal: function () {
            this.resetForm();
        ...
        _cancel: function () {
            this.$refs.refLanguageProductTrademarkModal.hide();
            this._resetComponent();
...
//MANAGER PROCESS
        ...
        _managerRowGrid: function (params) {
            ...
            if (params.managerType == "updateEntity") {
                ...
                $this = this;
                ajaxRequest($('#action-language-product-trademark-setDelete').val(), {
                    type: 'POST',
                    data: dataSend,
        ...
        initGridManager: function (vmCurrent) {
            ...
            var paramsFilters = {
                product_trademark_id: this.model_id
            };
