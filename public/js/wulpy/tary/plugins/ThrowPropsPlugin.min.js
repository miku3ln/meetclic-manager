...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    ...
    _gsScope._gsDefine("plugins.ThrowPropsPlugin", ["plugins.TweenPlugin", "TweenLite", "easing.Ease", "utils.VelocityTracker"], function (r, b, S, T) {
        var _, w, P, C, N = function (e, t) {
            ...
            }, l = 999999999999999, o = _gsScope._gsDefine.globals, V = !1, k = {
                x: 1,
                y: 1,
                z: 2,
                scale: 1,
            ...
            B = function (e) {
            ...
            }(window ? window.location.host : ""), u = function (e, t, r, o, n) {
                var i, s, a, c, u = t.length, f = 0, p = l;
                if ("object" == typeof e) {
                    for (; -1 < --u;) {
                ...
                return r < s ? s = r : s < o && (s = o), {max: s, min: s, unitFactor: e.unitFactor}
            }, F = function (e, t, r) {
                ...
                var s, a, c, u, f, p, l, g, d, h, v, m, y, _ = 0, w = 9999999999, P = t.throwProps || t,
        ...
        return (e.constructor = N).version = "0.11.0", N.API = 2, N._autoCSS = !0, N.defaultResistance = 100, N.defaultUnitFactors = {
            ...
            if (e) {
                var t = e._internals, v = t._parseToProxy, m = t._setPluginRatio, y = t.CSSPropTween;
                t._registerComplexSpecialProp("throwProps", {
                    parser: function (e, t, r, o, n, i) {
                        i = new N;
                        var s, a, c, u, f = {}, p = {}, l = {}, g = {}, d = {}, h = {};
            ...
            t.throwProps || (t = {throwProps: t}), 0 === n && (t.throwProps.preventOvershoot = !0), V = !0;
            var i = new b(e, o || 1, t);
            ...
            var n, i, s, a, c, u, f, p, l, g, d, h, v = r._ease, m = isNaN(t.checkpoint) ? .05 : Number(t.checkpoint),
                y = r._duration, _ = t.preventOvershoot, w = 0;
            if (!B) return "";
        ...
        return e.addProp = function (e, t) {
            if (!this._lookup[e]) {
                var r = this.target, o = "function" == typeof r[e], n = o ? this._altProp(e) : e, i = this._firstVP;
            ...
            var t, r, o = this._lookup[e], n = this.target;
            ...
            var t = e.substr(0, 3), r = ("get" === t ? "set" : "set" === t ? "get" : t) + e.substr(3);
