...
function getConfigMap() {
    result = {
        width: $(".content-manager-map").width(),
...
const app = new Vue(
    {
        ...
        methods: {
            ...
            setValueRoutesDrawing: function (params) {
                ...
                if (this.$refs._emitParentToRoutesDrawing._updateChildrenByParent) {
...
var appManager = new Vue(
    {
        ...
        data: {
            managerUrlMain:$managerView['url']['home'],
...
//                scrollwheel: true,
    ...
    this.initMap = function (init_map_element, data) {
        ...
        init_map = true;
        // map.mapTypes.set('greyscale_style', $greyscale_style);
