var LayoutBuilder = function () {
            ...
            $("#builder_export_html").click(function (t) {
                if (t.preventDefault(), envato.isVerified()) {
                    ...
                    e.startLoad({
                        ...
                        method: "POST",
                        data: {builder_export: 1, export_type: "partial", demo: $(a).data("demo")}
                    }).done(function (t) {
                        var i = JSON.parse(t);
                        if (i.message)e.stopWithNotify(i.message); else var r = setInterval(function () {
                            $.ajax("index.php", {
                                method: "POST",
                                data: {builder_export: 1, builder_check: i.id}
                            }).done(function (t) {
                                var i = JSON.parse(t);
                                void 0 !== i && "1" === i.export_status && $("<iframe/>").attr({
                                    ...
                                    }, {type: "success"}), e.doneLoad(), clearInterval(r)
                                }).appendTo(a)
                            })
                        }, 15e3)
                    })
            ...
            $("#builder_export_html_static").click(function (t) {
                if (t.preventDefault(), envato.isVerified()) {
                    ...
                    e.startLoad({
                        ...
                        method: "POST",
                        data: {builder_export: 1, export_type: "html", demo: $(a).data("demo")}
                    }).done(function (t) {
                        var i = JSON.parse(t);
                        if (i.message)e.stopWithNotify(i.message); else var r = setInterval(function () {
                            $.ajax("index.php", {
            ...
            $("#builder_export_angular").click(function (t) {
                if (t.preventDefault(), envato.isVerified()) {
                    ...
                    e.startLoad({
                        ...
                        method: "POST",
                        data: {builder_export: 1, export_type: "angular", demo: $(a).data("demo")}
                    }).done(function (t) {
                        var i = JSON.parse(t);
                        if (i.message)e.stopWithNotify(i.message); else var r = setInterval(function () {
                            $.ajax("index.php", {
    ...
    window.envato = {
        apiKey: "05kxpfkxwymzzczjm75d9s3li4spg0j1", expires_in: "3600", isVerified: function () {
            ...
            return $.ajax("https://marketplace.envato.com/api/edge/keenthemes/" + envato.apiKey + "/verify-purchase:" + e + ".json", {method: "GET"}).done(function (e) {
                $.isEmptyObject(e["verify-purchase"]) ? (grecaptcha.reset(), $("#alert-message").removeClass("alert-success m--hide").addClass("alert-danger").html("Invalid purchase code")) : (envato.setItems(e["verify-purchase"]), envato.setItem("verified", !0), $.ajax("inc/api/envato.php", {
                    method: "POST",
                    data: envato.getItem()
