...
$(document).ready(function () {
    ...
    var t, a, n, o, i, l, r, s = this._chart.ctx, d = this._view, c = d.borderWidth,
    ...
    if (d.horizontal ? (t = d.base, a = d.x, n = d.y - d.height / 2, o = d.y + d.height / 2, i = a > t ? 1 : -1, l = 1, r = d.borderSkipped || "left") : (t = d.x - d.width / 2, a = d.x + d.width / 2, n = d.y > 2 * u ? d.y - u : d.y, i = 1, l = (o = d.base) > n ? 1 : -1, r = d.borderSkipped || "bottom"), c) {
        var m = Math.min(Math.abs(t - a), Math.abs(n - o)), p = (c = c > m ? m : c) / 2,
            f = t + ("left" !== r ? p * i : 0), g = a + ("right" !== r ? -p * i : 0), h = n + ("top" !== r ? p * l : 0),
            b = o + ("bottom" !== r ? -p * l : 0);
        f !== g && (n = h, o = b), h !== b && (t = f, a = g)
    }
    s.beginPath(), s.fillStyle = d.backgroundColor, s.strokeStyle = d.borderColor, s.lineWidth = c;
    var v = [[t, o], [t, n], [a, n], [a, o]], _ = ["bottom", "left", "top", "right"].indexOf(r, 0);
    -1 === _ && (_ = 0);
    var w = e(0);
    s.moveTo(w[0], w[1]);
    for (var k = 1; k < 4; k++) {
