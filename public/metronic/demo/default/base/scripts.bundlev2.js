        ...
        if (0 !== t(this).length) {
            ...
            var o = {
                isInit: !1, offset: 110, stateId: "meta", ajaxParams: {}, init: function (e) {
                    ...
                    var o = [], i = t(n).find("tr:first-child th").get().map(function (e, n) {
                    ...
                    o.setupSubDatatable.call(), o.setupSystemColumn.call(), o.setupHover.call(), void 0 === a.detail && 1 === o.getDepth() && o.lockTable.call(), o.columnHide.call(), o.resetScroll(), o.isInit || (t(n).trigger("m-datatable--on-init", {
                        ...
                        options: a
                    }), o.isInit = !0), t(n).trigger("m-datatable--on-layout-updated", {table: t(n.wrap).attr("id")})
                }, lockTable: function () {
                    var e = {
                        lockEnabled: !1, init: function () {
                            ...
                            t(n.table).find("thead,tbody,tfoot").each(function () {
                                ...
                                0 === t(this).find(".m-datatable__lock").length && t(this).ready(function () {
                                    !function (a) {
                                        if (t(a).find(".m-datatable__lock").length > 0) o.log("Locked container already exist in: ", a); else if (0 !== t(a).find(".m-datatable__row").length) {
                    ...
                    var n = t(window).width(), o = a.columns, i = {left: [], right: []};
                    ...
                    var e = t(n.tableHead).width(), a = t(n.tableHead).find(".m-datatable__lock--left").width(),
                    ...
                    t(n.tableHead).find(".m-datatable__cell").mousedown(function (n) {
                        ...
                        if (o) {
                            var r = t(i).index(), s = t(n.tableBody), d = t(i).closest(".m-datatable__lock");
                            if (d) {
                                var c = t(d).index();
                    ...
                    if (a.layout.height && a.layout.scroll) {
                        var e = t(n.tableHead).find(".m-datatable__row").height(),
                            o = t(n.tableFoot).find(".m-datatable__row").height(), i = a.layout.height;
                    ...
                    t(e).find(".m-datatable__row").each(function (e, a) {
                        var l = t(a).data("obj") || {}, r = o.getOption("rows.callback");
                    ...
                    if (t(n.tableBody).css("overflow", ""), e.hasClass(a, "ps")) t(a).data("ps").update(); else {
                        var i = new PerfectScrollbar(a);
                        t(a).data("ps", i)
                    }
                }, setHeadTitle: function (i) {
                    void 0 === i && (i = n.tableHead), i = t(i)[0];
                    var l = a.columns, r = i.getElementsByTagName("tr")[0], s = i.getElementsByTagName("td");
                    ...
                    var i = function () {
                        ...
                        var i = Math.max(e.perpage * (e.page - 1), 0), l = Math.min(i + e.perpage, e.total);
                        ...
                        var l = function (e, a) {
                            ...
                            var i = Math.max(a.perpage * (a.page - 1), 0), l = Math.min(i + a.perpage, a.total);
                            o.localDataUpdate(), n.dataSet = t(n.dataSet).slice(i, l), o.insertData()
                        };
                        if (t(n.wrap).removeClass("m-datatable--error"), a.pagination) if (a.data.serverPaging && "local" !== a.data.type) {
                            var r = o.getObject("meta", e || null);
                            null !== r ? o.paging(r) : o.paging(i(), l)
                        } else o.paging(i(), l); else o.localDataUpdate();
                        o.insertData()
                    };
                    "local" === a.data.type || !1 === a.data.serverSorting && "sort" === e || !1 === a.data.serverFiltering && "search" === e ? l() : o.getData().done(l)
                }, insertData: function () {
                    n.dataSet = n.dataSet || [];
                    var i = o.getDataSourceParam(), l = i.pagination, r = (Math.max(l.page, 1) - 1) * l.perpage,
                    ...
                    var l = {
                        ...
                        pagingBreakpoint: function () {
                            ...
                            if (0 !== t(a).length) {
                                var i = o.getCurrentPage(), r = t(a).find(".m-pager-input").closest("li");
                    ...
                    t.each(a.columns, function (a, i) {
                        if (void 0 !== i.responsive) {
                            var l = i.field, r = t.grep(t(n.table).find(".m-datatable__cell"), function (e, a) {
                    ...
                    var e = function (e) {
                        e.preventDefault();
                        var n = t(this).closest(".m-datatable__row"), i = t(n).next();
                        if (t(i).hasClass("m-datatable__row-detail")) t(this).find("i").removeClass(o.getOption("layout.icons.rowDetail.expand")).addClass(o.getOption("layout.icons.rowDetail.collapse")), t(i).remove(); else {
                            ...
                            var r = t("<td/>").addClass("m-datatable__detail").attr("colspan", o.getTotalColumns()).appendTo(i),
                                s = t("<table/>");
                            t(l).each(function () {
                                var e = t(this).data("field"), n = t.grep(a.columns, function (t, a) {
                                    return e === t.field
                                })[0];
                    ...
                    o.getOption("data.autoColumns") && (t.each(n.dataSet[0], function (e, n) {
                        0 === t.grep(a.columns, function (t, a) {
                            return e === t.field
                        }).length && a.columns.push({field: e, title: e})
                    ...
                    var i = t(e).index(), l = t(n.tableBody).find(".m-datatable__row"),
                        ...
                        init: function () {
                            ...
                            if (!t.isEmptyObject(e)) {
                                var a = t(n.tableHead).find('.m-datatable__cell[data-field="' + e.field + '"]').attr("data-sort", e.sort),
                                    i = t(a).find("span"), l = t(i).find("i"), r = o.getOption("layout.icons.sort");
                                t(l).length > 0 ? t(l).removeAttr("class").addClass(r[e.sort]) : t(i).append(t("<i/>").addClass(r[e.sort]))
                            }
                        }, sortClick: function (i) {
                            var l = o.getDataSourceParam("sort"), r = t(this).data("field"), s = o.getColumnByField(r);
                    ...
                    var a = o.getObject("sort.field", e), i = o.getObject("sort.sort", e), l = o.getColumnByField(a);
            ...
            }, a = t.extend(!0, {}, t.fn.mDatatable.defaults, a), n.options = a, o.init.apply(this, [a]), t(n.wrap).data("mDatatable", n)); else void 0 === (n = t(this).data("mDatatable")) && t.error("mDatatable not initialized"), a = n.options;
            return n
        }
