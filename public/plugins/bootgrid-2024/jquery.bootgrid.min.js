...
!function (a, b) {
    ...
    function q() {
        if (0 !== this.options.navigation) {
            ...
            if (f.length > 0) {
                ...
                if (this.options.ajax) {
                    var k = i.icon.resolve(e.call(this, {iconCss: b.iconRefresh})),
                        l = a(i.actionButton.resolve(e.call(this, {
                            content: k,
    ...
    function r(b) {
        if (this.options.columnSelection && this.columns.length > 1) {
            var c = this, d = this.options.css, f = this.options.templates,
                h = f.icon.resolve(e.call(this, {iconCss: d.iconColumns})),
                i = a(f.actionDropDown.resolve(e.call(this, {content: h}))), j = g(d.dropDownItem),
                l = g(d.dropDownItemCheckbox), n = g(d.dropDownMenuItems);
    ...
    function u() {
        if (0 !== this.options.navigation) {
            ...
            if (-1 !== this.rowCount && c.length > 0) {
                var f = this.options.templates, h = this.current, i = this.totalPages,
                    j = a(f.pagination.resolve(e.call(this))), k = i - h, l = -1 * (this.options.padding - h),
    ...
    function v(b, c, d, f) {
        var h = this, i = this.options.templates, j = this.options.css,
            k = e.call(this, {css: f, text: d, uri: "#" + c}),
            l = a(i.paginationItem.resolve(k)).on("click" + G, g(j.paginationButton), function (b) {
                ...
                if (!d.hasClass("active") && !d.hasClass("disabled")) {
                    var e = {first: 1, prev: h.current - 1, next: h.current + 1, last: h.totalPages},
                        f = c.attr("data-page").substr(1);
    ...
    function w(b) {
        ...
        if (a.isArray(f)) {
            var h = this.options.css, i = this.options.templates,
                j = a(i.actionDropDown.resolve(e.call(this, {content: c(this.rowCount)}))), k = g(h.dropDownMenu),
                l = g(h.dropDownMenuText), n = g(h.dropDownMenuItems), o = g(h.dropDownItemButton);
    ...
    function x(b) {
        if (b.length > 0) {
            var c = this, d = this.options.css, f = this.options.templates, h = this.element.children("tbody").first(),
                i = !0, j = "";
            a.each(b, function (b, g) {
                ...
                if (c.selection) {
                    var m = -1 !== a.inArray(g[c.identifier], c.selectedRows),
                        n = f.select.resolve(e.call(c, {type: "checkbox", value: g[c.identifier], checked: m}));
    ...
    function y(b) {
        ...
        this.selection && b.off("click" + G, d).on("click" + G, d, function (b) {
            ...
            b.stopPropagation();
            var d = a(this), e = null == c.identifier ? d.data("row-id") : c.converter.from(d.data("row-id") + ""),
    ...
    function z() {
        if (0 !== this.options.navigation) {
            ...
            if (h.length > 0) {
                var i = this, j = this.options.templates, k = null, l = "", m = g(c.searchField),
                    n = a(j.search.resolve(e.call(this))), o = n.is(m) ? n : n.find(m);
    ...
    function B() {
        var b = this, c = this.element.find("thead > tr"), d = this.options.css, f = this.options.templates, h = "",
        ...
        if (a.each(this.columns, function (a, c) {
            if (c.visible) {
                var g = b.sortDictionary[c.id],
                    j = i && g && "asc" === g ? d.iconUp : i && g && "desc" === g ? d.iconDown : "",
                    k = f.icon.resolve(e.call(b, {iconCss: j})), l = c.headerAlign,
    ...
    function C(a) {
        var b = this.options.css, c = g(b.icon), d = a.data("column-id") || a.parents("th").first().data("column-id"),
        ...
        b.setTimeout(function () {
            if ("true" === a.element._bgAria("busy")) {
                var b = a.options.templates, c = a.element.children("thead").first(),
                    d = a.element.children("tbody").first(), f = d.find("tr > td").first(),
                    g = a.element.height() - c.height() - (f.height() + 20), h = a.columns.where(k).length;
