...
(function ($) {
    ...
    var PrintArea = {
        ...
        write: function (PADocument, $ele) {
            PADocument.open();
            PADocument.write(PrintArea.docType() + "<html id='manipulacion-data'>" + PrintArea.getHead() + PrintArea.getBody($ele) + "</html>");
            PADocument.close();
        },
        docType: function () {
            ...
            if (settings.standard == standards.html5)
                return "<!DOCTYPE html id='doctype-modificado'>";
        ...
        getHead: function () {
            ...
            return "<head id='head-print'><title id='title-print'>" + settings.popTitle + "</title>" + extraHead + links + "</head>";
//            return "<head id='head-print'><title id='title-print'>" + settings.popTitle + "</title>" + extraHead + links + "</head>";
        },
