!function (t, e) {
    ...
    return function (t) {
        ...
        "use strict";
        n.r(e);
        var o = n(3), i = n.n(o), s = n(2), r = n.n(s), a = n(0), l = n.n(a), c = n(4), u = n.n(c), h = {
            watch: {
        ...
        var y = {
            ...
            components: u()({}, y), mixins: [h, p, d], props: {
                value: {},
                components: {
                ...
                select: function (t) {
                    ...
                    var e = t.target, n = [this.$el, this.searchEl, this.$refs.toggle.$el];
        ...
        }, [], !1, null, null, null).exports), g = {ajax: d, pointer: p, pointerScroll: h};
