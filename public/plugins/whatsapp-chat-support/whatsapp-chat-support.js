! function (t, a, n) {
    ...
    s.DEFAULTS = {
        ...
        function c() {
            o.onPopupOpen(), a(".whatsapp_chat_support").each(function () {
                var t = a(this);
        ...
        o.debug && a("body").append(d), p.on("click", function () {
        ...
        function w(t) {
            var n = !1,
                s = !1;
            for (var i in t)
                if (t.hasOwnProperty(i) && b(i) == m.day()) {
     ...
     a.fn.whatsappChatSupport = function (t, n, i) {
        return this.each(function (o, e) {
            ...
            l || "string" == typeof t || p.data("whatsappChatSupport", new s(this, t)), l && "string" == typeof t && l[t](n, i)
        })
    }
}(window, jQuery);
