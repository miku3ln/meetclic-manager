...
function initCitybook() {
    ...
    $(".showshare").on("click", function () {
        ...
        var setText = '';
        if (currentText == 'Share' || currentText == 'Compartir') {
            setText = $(this).attr('option-close');
            if (setText == '' || setText == null) {
                setText ='Cerrar';
            }
        } else if (currentText == 'Close' || currentText == 'Cerrar') {
            setText = $(this).attr('option-open');
            if (setText == '' || setText == null) {
                setText ='Compartir';
            }
        }

        $(this).find("span").text(setText);
    ...
    $(".listing-view-layout li a.expand-listing-view").on("click", function (t) {
        t.preventDefault();
        $(this);
    ...
    function onListingsChanged(t) {
        var e = new CustomEvent("listingsChanged", {detail: t});
...
function _initProcessSearch($) {


    window.addEventListener('listingsChanged', function (e) {
        console.log(69, e);
    });
