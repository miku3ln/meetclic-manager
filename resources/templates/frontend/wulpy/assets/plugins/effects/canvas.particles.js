...
(function () {
    ...
    function drawLines(p) {
        ...
        for (var i in p.closest) {
            ...
            ctx.strokeStyle = 'rgba(' + (jQuery("#canvas-particle").attr('data-rgb') || '84,170,204') + ',' + p.active + ')';
            ctx.stroke();
        }
    }
    ...
    function Circle(pos, rad, color) {
        ...
        this.draw = function () {
            ...
            ctx.fillStyle = 'rgba(' + (jQuery("#canvas-particle").attr('data-rgb') || '255,255,255') + ',' + _this.active + ')';
            ctx.fill();
        };
    }
