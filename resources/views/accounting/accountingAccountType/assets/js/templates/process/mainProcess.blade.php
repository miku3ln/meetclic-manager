<script type='text/x-template' id='accounting-account-type-template'>
    <div>
        ...
        @include( 'partials.adminViewVue',['title'=>'Tipos','grid_name'=>'accounting-account-type-grid'])

        <div class="content-form" v-if="showManager">
            <b-form id="accountingAccountTypeForm" v-on:submit.prevent="_submitForm">
