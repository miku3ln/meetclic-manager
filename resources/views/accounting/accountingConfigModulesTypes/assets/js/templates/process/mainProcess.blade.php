<script type='text/x-template' id='accounting-config-modules-types-template'>
    <div>
        ...
        @include( 'partials.adminViewVue',['title'=>'Modulos Tipos','grid_name'=>'accounting-config-modules-types-grid'])

        <div class="content-form" v-if="showManager">
            <b-form id="accountingConfigModulesTypesForm" v-on:submit.prevent="_submitForm">
...
></textarea>
                        ...
                        <b-col md="12">
                            <div class="form-group"
                                ...
                                <label class="form__label " v-html='getLabelForm("status")'  v-html='getLabelForm("status")' ></label>
                                <div class="content-element-form">
