<script type='text/x-template' id='entity-position-fiscal-template'>
<div>
...
<div class="content-manager-grid">
    ...
    <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
        <table id="entity-position-fiscal-grid"
               class=""
...
<div class="content-form" v-if="showManager">
    <b-form id="entityPositionFiscalForm" v-on:submit.prevent="_submitForm">
