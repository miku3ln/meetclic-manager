<script type='text/x-template' id='retention-tax-type-template'>
<div>
...
<div class="content-manager-grid">
    ...
    <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
        <table id="retention-tax-type-grid"
               class=""
...
<div class="content-form" v-if="showManager">
    <b-form id="retentionTaxTypeForm" v-on:submit.prevent="_submitForm">
