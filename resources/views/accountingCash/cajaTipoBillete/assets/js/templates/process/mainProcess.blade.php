<script type='text/x-template' id='caja-tipo-billete-template'>
<div>
...
<div class="content-manager-grid">
    ...
    <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
        <table id="caja-tipo-billete-grid"
               class=""
...
<div class="content-form" v-if="showManager">
    <b-form id="cajaTipoBilleteForm" v-on:submit.prevent="_submitForm">
...
<div class="content-message-errors">
      ...
      <span v-if="!$v.model.attributes.descripcion.maxLength">
       <?php  echo "{{model.structure.descripcion.maxLength.msj}}"?>
      </span>
     </b-form-invalid-feedback>
   </div> 
</div> 
