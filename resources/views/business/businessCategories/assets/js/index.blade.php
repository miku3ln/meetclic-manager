...
<script src="{{ asset('js/'.$pathCurrent.'/components/BusinessSubcategories.js')}}" type='text/javascript'></script>
<script src="{{ asset('js/'.$pathCurrent.'/components/Main.js')}}" type='text/javascript'></script>

<script src="{{ asset('js/'.$pathCurrent.'/App.js')}}" type='text/javascript'></script>
