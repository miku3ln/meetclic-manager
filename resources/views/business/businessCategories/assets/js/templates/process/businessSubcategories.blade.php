<script type='text/x-template' id='business-subcategories-template'>
    <div>
        ...
        <div class='content-component'>
            ...
            <b-modal
                hide-footer
                id="modal-business-subcategories"
                ref="refBusinessSubcategoriesModal"
                size="xl"
            <?php  echo '@show="_showModal"' ?>    <?php  echo '@hidden="_hideModal"' ?>    <?php  echo '@ok="_saveModal"' ?>>
                ...
                <div class="content-form" v-if="showManager">
                    <div class="d-block ">
                        <b-form id="businessSubcategoriesForm" v-on:submit.prevent="_submitForm">
       ...
       <?php  echo "{{model.structure.src.required.msj}}"?>
                                    ...
                                    <b-col md="12">
                                        <div class="form-group"
                                            ...
                                            <label
                                                class="form__label " v-html='getLabelForm("has_icon")'></label>
                                            <div class="content-element-form">
                                                <input
                                    ...
                                    <b-col md="12">
                                        <div class="form-group"
                                            ...
                                            <label
                                                class="form__label " v-html='getLabelForm("icon_class")'> </label>
                                            <div class="content-element-form">
                                                <input
       ...
       <?php  echo "{{model.structure.description.required.msj}}"?>
                ...
                <div class="content-manager-grid">
                    ...
                    <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                        <table id="business-subcategories-grid"
                               class=""
