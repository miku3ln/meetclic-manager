<script type='text/x-template' id='business-academic-offerings-by-data-template'>
    <div>
        <div v-if="configModalBusinessAcademicOfferingsDataByInformation.viewAllow">
            <business-academic-offerings-data-by-information-component
                ref="refBusinessAcademicOfferingsDataByInformation"
                :params="configModalBusinessAcademicOfferingsDataByInformation"
            >
            </business-academic-offerings-data-by-information-component>
        </div>
        <div class='content-component'>
            ...
            <b-modal
                hide-footer
                id="modal-business-academic-offerings-by-data"
                ref="refBusinessAcademicOfferingsByDataModal"
                size="xl"
            <?php  echo '@show="_showModal"' ?>    <?php  echo '@hidden="_hideModal"' ?>    <?php  echo '@ok="_saveModal"' ?>>
                ...
                <div class="content-form" v-if="showManager">
                    <div class="d-block ">
                        <b-form id="BusinessAcademicOfferingsByDataForm" v-on:submit.prevent="_submitForm">
                                        ...
                                        <div class="form-group"
                                            ...
                                            <div class="content-element-form">
                                                <input
                                                    ...
                                                    class="form-control m-input"
                                                    @change="_setValueForm('link', $v.model.attributes.link.$model)"
                                                    v-focus-select
                                                >
                                            </div>
                                            <div class="content-message-errors">
      ...
      <span v-if="!$v.model.attributes.link.required">
       <?php  echo "{{model.structure.link.required.msj}}"?>
                                                    ...
                                                    <span v-if="!$v.model.attributes.link.maxLength">
       <?php  echo "{{model.structure.link.maxLength.msj}}"?>
      </span>
                                                </b-form-invalid-feedback>
                                            </div>
                                        </div>
       ...
       <?php  echo "{{model.structure.description.required.msj}}"?>
                ...
                <div class="content-manager-grid">
                    ...
                    <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                        <table id="business-academic-offerings-by-data-grid"
                               class=""
