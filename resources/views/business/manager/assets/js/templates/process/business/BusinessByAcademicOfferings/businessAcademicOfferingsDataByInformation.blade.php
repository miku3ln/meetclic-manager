<script type='text/x-template' id='business-academic-offerings-data-by-information-template'>
    <div>
        <div class='content-component'>
            <b-modal
                hide-footer
                id="modal-business-academic-offerings-data-by-information"
                ref="refBusinessAcademicOfferingsDataByInformationModal"
                size="xl"
            <?php  echo '@show="_showModal"' ?>    <?php  echo '@hidden="_hideModal"' ?>    <?php  echo '@ok="_saveModal"' ?>>
                ...
                <div class="content-form" v-if="showManager">
                    <div class="d-block ">
                        <b-form id="BusinessAcademicOfferingsDataByInformationForm" v-on:submit.prevent="_submitForm">
                            <b-container>
       ...
       <?php  echo "{{model.structure.description.required.msj}}"?>
                ...
                <div class="content-manager-grid">
                    ...
                    <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                        <table id="business-academic-offerings-data-by-information-grid"
                               class=""
