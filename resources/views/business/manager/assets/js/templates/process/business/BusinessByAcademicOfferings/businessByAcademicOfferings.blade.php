<script type='text/x-template' id='business-by-academic-offerings-template'>
    <div>
        <div v-if="configModalBusinessAcademicOfferingsByData.viewAllow">
            <business-academic-offerings-by-data-component
                ref="refTBusinessAcademicOfferingsByData"
                :params="configModalBusinessAcademicOfferingsByData"
            >
            </business-academic-offerings-by-data-component>
        </div>
        ...
        <div class='content-component'>
            ...
            <div class="content-manager-grid">
                ...
                <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                    <table id="business-by-academic-offerings-grid"
                           class=""
            ...
            <div class="content-form" v-if="showManager">
                <b-form id="businessByAcademicOfferingsForm" v-on:submit.prevent="_submitForm">
