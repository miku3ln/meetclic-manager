<script type='text/x-template' id='business-history-by-data-template'>
    <div>

        <div class='content-component'>
            <div v-if="configModalLanguageBusinessHistoryByData.viewAllow">
                <language-template-business-history-by-data-component
                    ref="refLanguageBusinessHistoryByData"
                    :params="configModalLanguageBusinessHistoryByData"
                >
                </language-template-business-history-by-data-component>
            </div>
            ...
            <b-modal
                hide-footer
                id="modal-business-history-by-data"
                ref="refBusinessHistoryByDataModal"
                size="xl"
            <?php  echo '@show="_showModal"' ?>    <?php  echo '@hidden="_hideModal"' ?>    <?php  echo '@ok="_saveModal"' ?>>
                ...
                <div class="content-form" v-if="showManager">
                    <div class="d-block ">
                        <b-form id="BusinessHistoryByDataForm" v-on:submit.prevent="_submitForm">
       ...
       <?php  echo "{{model.structure.description.required.msj}}"?>
                ...
                <div class="content-manager-grid">
                    ...
                    <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                        <table id="business-history-by-data-grid"
                               class=""
