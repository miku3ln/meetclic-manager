<script type='text/x-template' id='business-counter-custom-template'>
    <div>
        <div v-if="configModalBusinessCounterCustomByData.viewAllow">
            <business-counter-custom-by-data-component
                ref="refBusinessCounterCustomByData"
                :params="configModalBusinessCounterCustomByData"
            >
            </business-counter-custom-by-data-component>
        </div>
        <div v-if="configModalLanguageBusinessCounterCustom.viewAllow">
            <language-business-counter-custom-component
                ref="refLanguageBusinessCounterCustom"
                :params="configModalLanguageBusinessCounterCustom"
                v-on:_businessCounterCustom-emit="_businessCounterCustom($event)"
            >
            </language-business-counter-custom-component>
        </div>
        <div class='content-component'>
            ...
            <div class="content-manager-grid">
                ...
                <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                    <table id="business-counter-custom-grid"
                           class=""
            ...
            <div class="content-form" v-if="showManager">
                <b-form id="businessCounterCustomForm" v-on:submit.prevent="_submitForm">
...
<textarea
    ...
    v-focus-select
></textarea>
                                        <div class="description" id="description" v-initSummerNote="{initMethod:_initSummerNote}"></div>
                                    </div>
                                    <div class="content-message-errors">
                                        <b-form-invalid-feedback
