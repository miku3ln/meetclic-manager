<script type='text/x-template' id='business-by-requirements-template'>
    <div>
        <div class='content-component'>
            ...
            <div class="content-manager-grid">
                ...
                <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                    <table id="business-by-requirements-grid"
                           class=""
            ...
            <div class="content-form" v-if="showManager">
                <b-form id="businessByRequirementsForm" v-on:submit.prevent="_submitForm">
