<script type='text/x-template' id='educational-institution-askwer-type-template'>
    <div>
        ...
        <div class="content-manager-grid">
            ...
            <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                <table id="educational-institution-askwer-type-grid"
                       class=""
        ...
        <div class="content-form" v-if="showManager">
            <b-form id="educationalInstitutionAskwerTypeForm" v-on:submit.prevent="_submitForm">
