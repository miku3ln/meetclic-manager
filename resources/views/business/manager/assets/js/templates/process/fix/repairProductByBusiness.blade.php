<script type='text/x-template' id='repair-product-by-business-template'>
    <div>
        ...
        <div class='content-component'>
            ...
            <div class="content-manager-grid">
                ...
                <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                    <table id="repair-product-by-business-grid"
                           class=""
            ...
            <div class="content-form" v-if="showManager">
                <b-form id="repairProductByBusinessForm" v-on:submit.prevent="_submitForm">
