<script type='text/x-template' id='template-information-template'>
    <div>
        ...
        <div class='content-component'>
                            ...
                            <div class="content-manager-buttons-grid ready" ng-if="managerMenuConfig.view">
                                <div v-for="(menu, key) in managerMenuConfig.menuCurrent" class="inline-data">
                                    <a
                                        target="_blank"
                                        v-if="menu.isUrl"
                                       v-bind:href="getUrlManagerFunction(menu)"
                                       v-init-tool-tip
            ...
            <div class="content-manager-grid">
                ...
                <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                    <table id="template-information-grid"
                           class=""
            ...
            <div class="content-form" v-if="showManager">
                <b-form id="templateInformationForm" v-on:submit.prevent="_submitForm">
