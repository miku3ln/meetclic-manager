<script type="text/x-template" id="lodging-by-type-of-room-template">

    <div>
        <b-modal
                hide-footer
                id="modal-lodging-by-type-of-room"
                ref="refLodgingByTypeOfRoomModal"
                size="xl"
        ...
        >
            ...
            <div class="d-block ">
                <b-form id="LodgingByTypeOfRoomForm" v-on:submit.prevent="_submitForm">
                ...
                <button v-if="createUpdate" type="button"
