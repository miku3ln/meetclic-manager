<script type="text/x-template" id="lodging-type-of-room-by-price-reception-template">
    <div>
        ...
        <div v-if="allowProcess">
            <b-container>
                ...
                <tabs @change="_tapManager" v-if="!showManager">
                    <tab :key="tab.value" v-bind:id="'tab-manager-'+tab.value" v-bind:title="tab.text"
                         v-for="(tab,index) in lodgingRoomLevelsManager.lodgingRoomLevelsData">
                        ...
                        <div v-else>
                            ...
                            <div v-else>
                                <b-row>
                                    <b-col md="3" v-if="filters.status=='ALL'">
                                                ...
                                                <div class="card-body">
                                                    <div class="media d-flex">
                                                        ...
                                                        <div class="media-body text-right align-self-bottom ">
                                                            <span class="d-block mb-1 font-medium-1"><?php echo '{{staticsLodgingRooms.total.label}}' ?></span>
                                    ...
                                    <b-col md="3" v-if="filters.status=='CLEANING' || filters.status=='ALL'">
                                            ...
                                            <div class="card-content">
                                                <div class="card-body">
                                                    <div class="media d-flex">
                                                        ...
                                                        <div class="media-body text-right align-self-bottom ">
                                                            <span class="d-block mb-1 font-medium-1"><?php echo '{{staticsLodgingRooms.cleaning.label}}' ?></span>
                                    ...
                                    <b-col md="3" v-if="filters.status=='OCCUPIED' || filters.status=='ALL'">
                                            ...
                                            <div class="card-content">
                                                <div class="card-body">
                                                    <div class="media d-flex">
                                                        ...
                                                        <div class="media-body text-right align-self-bottom ">
                                                            <span class="d-block mb-1 font-medium-1"><?php echo '{{staticsLodgingRooms.occupied.label}}' ?></span>
                                    ...
                                    <b-col md="3" v-if="filters.status=='FREE' || filters.status=='ALL'">
                                            ...
                                            <div class="card-content">
                                                <div class="card-body">
                                                    <div class="media d-flex">
                                                        ...
                                                        <div class="media-body text-right align-self-bottom ">
                                                            <span class="d-block mb-1 font-medium-1"><?php echo '{{staticsLodgingRooms.free.label}}' ?></span>
                                ...
                                <b-row>
                                    <b-col md="4" v-for="(room,i) in  lodgingRoomLevelsManager.data">
                                            ...
                                            <div class="card-content">
                                                <div class="card-body">
                                                    <div class="media d-flex">
                                                        ...
                                                        <div class="media-body text-right align-self-bottom ">
                                                            <span class="d-block mb-1 font-medium-1"><?php echo '{{room.lodging_type_of_room}}' ?></span>
            ...
            <div class="content-manager-grid">
                ...
                <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager" id="manager-grid-rooms">
