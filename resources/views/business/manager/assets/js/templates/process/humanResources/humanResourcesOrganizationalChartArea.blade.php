                                ...
                                <div class="form-group"
                                    ...
                                    <div class="content-message-errors ">
                                        <b-form-invalid-feedback
                                            ...
                                            <span v-if="!$v.model.attributes.human_resources_employee_profile_id_data.required">
...
<script type="text/x-template" id="human-resources-department-by-organizational-chart-area-template">
    <div>
        <b-modal
            hide-footer
            id="modal-human-resources-department-by-organizational-chart-area"
            ref="refHumanResourcesDepartmentByOrganizationalChartAreaModal"
            size="md"
            <?php echo '@show="_showModal"'; ?>
            <?php echo '@hidden="_hideModal"'; ?>
        ...
        >
            ...
            <div class="d-block ">
                <b-form id="HumanResourcesDepartmentByOrganizationalChartAreaForm" v-on:submit.prevent="_submitForm">
                                ...
                                <div class="form-group"
                                    ...
                                    <div class="content">
                                        ...
                                        <select
                                            ...
                                            class="form-control m-select2 human_resources_department_id_data select2-container-modal"
                                            v-initS2="{model:model.attributes.id,onInitSelect2:onInitEmployeeProfile}"
                                        >
                                        </select>
                                    ...
                                    <div class="content-message-errors ">
                                        <b-form-invalid-feedback
                                            ...
                                            <span v-if="!$v.model.attributes.human_resources_department_id_data.required">
...
<script type="text/x-template" id="human-resources-organizational-chart-area-template">
    <div>

        <div v-if="configModalHumanResourcesDepartmentByOrganizationalChartArea.viewAllow">

            <human-resources-department-by-organizational-chart-area-component

                ref="refHumanResourcesDepartmentByOrganizationalChartArea"
                :params="configModalHumanResourcesDepartmentByOrganizationalChartArea"
        ...
        <div class="content-manager-grid">
            ...
            <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                <table id="human-resources-organizational-chart-area-grid"
                       class=""
            ...
            <b-form id="LodgingForm" v-on:submit.prevent="_submitForm">
                ...
                <b-container>
                    ...
                    <b-row>
                        ...
                        <b-col md="6"
                               v-if="$v.model.attributes.type_item.$model && $v.model.attributes.type.$model !=2 ">
                            <div class="form-group"
                    ...
                    <b-row>
                        ...
                        <b-col md="4" v-if="$v.model.attributes.type.$model!=1" class="not-view">
                            <div class="form-group"
