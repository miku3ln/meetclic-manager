<script type='text/x-template' id='information-phone-template'>
    <div>
        ...
        <div class='content-component'>
            ...
            <b-modal
                    hide-footer
                    id="modal-information-phone"
                    ref="refInformationPhoneModal"
                    size="xl"
            <?php  echo '@show="_showModal"' ?>    <?php  echo '@hidden="_hideModal"' ?>    <?php  echo '@ok="_saveModal"' ?>>
                ...
                <div class="content-form" v-if="showManager">
                    <div class="d-block ">
                        <b-form id="informationPhoneForm" v-on:submit.prevent="_submitForm">
                                ...
                                <b-row>
                                    <b-col md="6">
                                        <div class="form-group"
                                            ...
                                            <label class="form__label " v-html='getLabelForm("information_phone_operator_id_data")' ></label>
                                            <div class="content-element-form">
                                                <input v-model="$v.model.attributes.information_phone_operator_id_data.model"
                                                       type="hidden"
       ...
       <?php  echo "{{model.structure.information_phone_operator_id_data.required.msj}}"?>
                                    ...
                                    <b-col md="6">
                                        <div class="form-group"
                                            ...
                                            <label class="form__label " v-html='getLabelForm("information_phone_type_id_data")' ></label>
                                            <div class="content-element-form">
       ...
       <?php  echo "{{model.structure.value.maxLength.msj}}"?>
                ...
                <div class="content-manager-grid">
                    ...
                    <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                        <table id="information-phone-grid"
                               class=""
