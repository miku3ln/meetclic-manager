<script type='text/x-template' id='information-social-network-template'>
    <div>
        ...
        <div class='content-component'>
            ...
            <b-modal
                    hide-footer
                    id="modal-information-social-network"
                    ref="refInformationSocialNetworkModal"
                    size="xl"
            <?php  echo '@show="_showModal"' ?>    <?php  echo '@hidden="_hideModal"' ?>    <?php  echo '@ok="_saveModal"' ?>>
                ...
                <div class="content-form" v-if="showManager">
                    <div class="d-block ">
                        <b-form id="informationSocialNetworkForm" v-on:submit.prevent="_submitForm">
      ...
      <span v-if="!$v.model.attributes.main.required">
       <?php  echo "{{model.structure.main.required.msj}}"?>
                                ...
                                <b-row>
                                    <b-col md="6">
                                        <div class="form-group"
                                             :class="getClassErrorForm('information_social_network_type_id_data',$v.model.attributes.information_social_network_type_id_data)">
                                            <label class="form__label " v-html='getLabelForm("information_social_network_type_id_data")' ></label>
                                            <div class="content-element-form">
                                                <input v-model="$v.model.attributes.information_social_network_type_id_data.model"
                                                       type="hidden"
                                                       v-bind:id="getNameAttribute('information_social_network_type_id_data')"
                                                       v-bind:name="getNameAttribute('information_social_network_type_id_data')"
                                                       @change="_setValueForm('information_social_network_type_id_data', $v.model.attributes.information_social_network_type_id_data.$model)"
                                                >
                                                <select id="information_social_network_type_id_data"
                                                        class="form-control m-select2 "
                                                        v-initS2InformationSocialNetworkType="{rowId:model.attributes.id,_managerS2InformationSocialNetworkType:_managerS2InformationSocialNetworkType}"
                                                >
                                                </select>
                                            </div>
                                            <div class="content-message-errors">
                                                <b-form-invalid-feedback
                                                        :state="!$v.model.attributes.information_social_network_type_id_data.$error">
      <span v-if="!$v.model.attributes.information_social_network_type_id_data.required">
       <?php  echo "{{model.structure.information_social_network_type_id_data.required.msj}}"?>
      </span>
                                                </b-form-invalid-feedback>
                                            </div>
                                        </div>
       ...
       <?php  echo "{{model.structure.value.maxLength.msj}}"?>
                ...
                <div class="content-manager-grid">
                    ...
                    <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                        <table id="information-social-network-grid"
                               class=""
