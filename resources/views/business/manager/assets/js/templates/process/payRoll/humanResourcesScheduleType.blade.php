...
@php
$nameElement='human-resources-schedule-type';
$nameProcess='HumanResourcesScheduleType';

@endphp
<script type="text/x-template" id="human-resources-schedule-type-template">
    <div>
        ...
        <div class="content-manager-grid">
            ...
            <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                <table id="human-resources-schedule-type-grid"
                       class=""
