                        ...
                        <div class="tab-content padding-10">
                            <div class="tab-pane " ng-class="{'active': (menuTabs[0].active==true)}" id="report-1">
                                <form name="formManager">
                                    ...
                                    $this->renderPartial('process/partials/accountants/invoice/managerOptionsModal/indebtedness');
                                    $this->renderPartial('process/partials/accountants/invoice/managerOptionsModal/indebtednessInit');
                                    $this->renderPartial('process/partials/accountants/invoice/managerOptionsModal/indebtednessBreakDown');
                                    ?>
                            ...
                            <div class="tab-pane" id="report-2" ng-class="{'active': (menuTabs[1].active==true)}"
                                ...
                                <?php
                                $this->renderPartial('process/partials/accountants/invoice/managerOptionsModal/indebtednessBreakDownCollectionPayments');
