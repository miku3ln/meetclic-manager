...
//**Modal*
        ...
        methods: {
            ...
            ...$methodsFormValid,
            generateAllBusinessGamification: async function() {

                ajaxRequestManager($("#action-business-initConfigurationBusinessGamification").val(), {
                    type: 'POST',
                    data: {information: -1},
                    success_callback: function (response) {
                        console.log("esont", response);
                    }
                });
            },
