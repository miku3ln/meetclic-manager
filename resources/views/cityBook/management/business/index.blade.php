...
@section('content')
            ...
            <div class="profile-edit-wrap">
                ...
                <div class="row">
                    ...
                    <div id="tab-business" class="col-md-9">
                        ...
                        @include('cityBook.management.business.partials.wizards.business')
    ...
    @include(  'cityBook.management.business.partials.actions')
@endsection
@section('script')
    ...
    @include( 'cityBook.management.business.assets.js.index')
@endsection
@section('additional-styles')
    @include('cityBook.management.business.assets.css.index')
    @include('partials.plugins.resourcesCss',['summerNote'=>true])
    <style>
