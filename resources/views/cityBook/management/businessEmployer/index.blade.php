...
@section('content')
            ...
            <div class="profile-edit-wrap">
                ...
                <div class="row">
                    ...
                    <div id="tab-business" class="col-md-9">
                            ...
                            @include('cityBook.management.businessEmployer.partials.wizards.business')
    ...
    @include(  'cityBook.management.businessEmployer.partials.actions')
@endsection
@section('script')
    <script>
        var $frontend = true;
    ...
    @include( 'cityBook.management.businessEmployer.assets.js.index')
@endsection
@section('additional-styles')
    @include('cityBook.management.businessEmployer.assets.css.index')
