...
<style>
    .btn.btn-success.btn--manager-process {
        color: #f7f8fd !important;
    }
</style>
<style>
    .upm__actions { display:flex; gap:8px; margin:8px 0; }
    .upm__btn { padding:6px 10px; border:1px solid #ccc; background:#fff; cursor:pointer; }
    .upm__list { display:flex; flex-direction:column; gap:10px; }
    .upm__item { display:flex; gap:10px; border:1px solid #e5e5e5; padding:10px; border-radius:8px; align-items:flex-start; }
    .upm__preview { width:120px; min-width:120px; }
    .upm__thumb { width:120px; height:90px; object-fit:cover; border-radius:6px; }
    .upm__media { width:120px; }
    .upm__doc { width:120px; height:90px; display:flex; align-items:center; justify-content:center; border:1px dashed #ccc; border-radius:6px; }
    .upm__meta { flex:1; }
    .upm__name { font-weight:600; }
    .upm__info { font-size:12px; opacity:0.8; margin-top:2px; }
    .upm__remove { border:1px solid #f1b0b7; background:#fff5f5; padding:6px 10px; cursor:pointer; border-radius:6px; }
    .upm__link { font-size:12px; }
    .upm__title {
        color: #225278;
        font-size: 26px;
        font-weight: bold;
    ...
    .upm__media{
        width: 220px;     /* <-- cambia aquí */
        height: 34px;     /* audio: altura compacta */
    }

    /* Si es video, dale una altura fija (para que no se vea gigante) */
    .upm__preview video.upm__media{
        width: 220px;     /* <-- cambia aquí */
        height: 80px;     /* <-- cambia aquí */
    }

    /* Imágenes (thumb) */
    .upm__thumb{
        width: 70px;      /* <-- cambia aquí */
        height: 70px;     /* <-- cambia aquí */
        object-fit: cover;
        border-radius: 8px;
    }

    .upm__item:has(.upm__media--video) {
