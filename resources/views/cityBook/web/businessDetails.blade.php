...
@section('additional-styles')
    ...
    <style>
        ...
        span.single-icon.single-icon--quick-view.single-icon--quick-view--not-basket {
            width: 100%;
        }
...
@section('additional-scripts')
    ...
    @if ($dataManagerPage['inventory-config']['type'] == 0)
        @include('cityBook.web.partials.businessDetails.assets.js.typeDefault',array())
    @elseif(($dataManagerPage['inventory-config']['type']==1))
        @include('cityBook.web.partials.businessDetails.assets.js.typeOne',array())
