     ...
     * ============================================================ */
        ...
        class GestorEventosModelo {
            ...
            _emitirClickModelo(modo, punto) {
                ...
                try { this.cfg.onModelClick({ modo, punto }); } catch {}
            }
        }
        ...
        class JQueryArViewer {
            ...
            reset() {
                ...
                } catch (err) { this.logError('error.reset_total', {}, err); }
            }

            zoomIn() { if (this.model) this.setUniformScale(this.model.scale.x * this.cfg.model.zoomFactor); }
            zoomOut() { if (this.model) this.setUniformScale(this.model.scale.x / this.cfg.model.zoomFactor); }
            setScale(value) { if (this.model) this.setUniformScale(value); }
            ...
            async onSessionStarted(session) {
                ...
                try {
                    let downRay = null;
                    try { downRay = new XRRay({ x:0, y:0, z:0 }, { x:0, y:-this.cfg.reticleSensitivity.offsetRayDown, z:-1 }); }
                    catch { downRay = null; }
                    hitSource = downRay
            ...
            onXrSelect() {
                try {
                    ...
                    // Solo aceptamos taps durante modo de colocación
                    if (!this.uiState.inPlacementMode) {
                        this.setStatus('Pulsa “Posición nueva” para recolocar.');
                        return;
                    }
            ...
            onXrFrame(tsMs, frame) {
                ...
                try { this.eventos.onFrame(delta); } catch {}
                ...
                $(this.cfg.ui.enterBtn).on('click', async () => {
                    ...
                    if (mode === 'ios-fallback') {
                        ...
                        if (mv && this.cfg.usdzUrl) {
                            try { if (typeof mv.activateAR === 'function') { mv.activateAR(); return; } } catch {}
                        }
            ...
            disableUI(disabled = true, opts = {}) {
                ...
                } catch (err) { this.logError('error.deshabilitar_ui', {}, err); }
            }
        }
        ...
        $(function () {
            const viewer = new JQueryArViewer({
                glbUrl: window.$dataManagerPage['public-root'] + '/simi-rura/examples/HORNET.glb',
                usdzUrl: window.$dataManagerPage['public-root'] + '/simi-rura/examples/HORNET.usdz',
                events: {
    ...
    <div class="container--custom not-view">
        ...
        <div class="d-flex flex-wrap gap-2 mb-3">
            <div class="manager-buttons">
                ...
                <!-- NUEVOS -->
                <button id="btn-explore" class="btn btn-success btn-sm manager-buttons__item not-view" disabled>Explorar</button>
                <button id="btn-new-pos" class="btn btn-outline-primary btn-sm manager-buttons__item not-view" disabled>Posición nueva</button>
            </div>
        </div>
