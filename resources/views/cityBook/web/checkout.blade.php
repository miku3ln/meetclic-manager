...
@section('additional-scripts')
    ...
    @if(!env('allowRoutes'))
        <script src="{{ asset($resourcePathServer.'js/frontend/web/Checkout.js')}}"></script>
    @else
...
@section('content')
    ...
    <div class="breadcrumb-area section-space--breadcrumb section-space--manager-sisdep" id="checkout-page-city-book">
        <div class="container">
            <div class="row">
