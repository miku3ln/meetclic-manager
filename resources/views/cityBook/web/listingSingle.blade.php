...
@section('content')
    ...
    <div class="list-single-carousel-wrap fl-wrap" id="sec1">
        <div class="fw-carousel fl-wrap full-height lightgallery">
            ...
            <div class="slick-slide-item">
                <div class="box-item">
                    <img src="{{ URL::asset($themePath.'images/all/single/9.jpg')}}" alt="">
                    <a href="{{ URL::asset($themePath.'images/all/single/9.jpg')}}" class="gal-link popup-image"><i
            ...
            <div class="slick-slide-item">
                <div class="box-item">
                    <img src="{{ URL::asset($themePath.'images/all/single/8.jpg')}}" alt="">
                    <a href="{{ URL::asset($themePath.'images/all/single/8.jpg')}}" class="gal-link popup-image"><i
                            class="fa fa-search"></i></a>
                </div>
            </div>
            <!-- slick-slide-item end -->
            ...
            <div class="slick-slide-item">
                <div class="box-item">
                    <img src="{{ URL::asset($themePath.'images/all/single/7.jpg')}}" alt="">
                    <a href="{{ URL::asset($themePath.'images/all/single/7.jpg')}}" class="gal-link popup-image"><i
                            class="fa fa-search"></i></a>
                </div>
            </div>
            <!-- slick-slide-item end -->
            ...
            <div class="slick-slide-item">
                <div class="box-item">
                    <img src="{{ URL::asset($themePath.'images/all/single/10.jpg')}}" alt="">
                    <a href="{{ URL::asset($themePath.'images/all/single/10.jpg')}}" class="gal-link popup-image"><i
                            class="fa fa-search"></i></a>
                </div>
            </div>
            <!-- slick-slide-item end -->
            ...
            <div class="slick-slide-item">
                <div class="box-item">
                    <img src="{{ URL::asset($themePath.'images/all/single/11.jpg')}}" alt="">
                    <a href="{{ URL::asset($themePath.'images/all/single/11.jpg')}}" class="gal-link popup-image"><i
                            class="fa fa-search"></i></a>
                </div>
            </div>
            <!-- slick-slide-item end -->
    ...
    <!--  carousel  end-->
    @include('cityBook.web.partials.businessDetails.topMenu')
    <!--  section   -->
                                ...
                                <div class="list-single-header-item">
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <h2>Luxury Hotel Spa <span> - Hosted By </span><a href="author-single.html">Alisa
                                                    Noory</a></h2>
                                        ...
                                        <div class="col-md-4">
                                            <div class="fl-wrap list-single-header-column">
                                                <span class="viewed-counter"><i
                                                        class="fa fa-eye"></i> Viewed -  156 </span>
                                                <a class="custom-scroll-link" href="#reviews"><i
                        ...
                        <div class="list-single-main-item fl-wrap" id="sec3">
                            ...
                            <div class="iframe-holder fl-wrap">
                                <div class="resp-video">
                                    <iframe src="https://player.vimeo.com/video/161566855" width="640" height="360"
                        ...
                        <div class="box-widget-item fl-wrap">
                            ...
                            <div class="box-widget opening-hours">
                                <div class="box-widget-content">
                                    ...
                                    <ul>
                                        <li><span class="opening-hours-day">Monday </span><span
                                        ...
                                        <li><span class="opening-hours-day">Thursday </span><span
                                                class="opening-hours-time">9 AM - 5 PM</span></li>
                                        <li><span class="opening-hours-day">Friday </span><span
                                                class="opening-hours-time">9 AM - 5 PM</span></li>
                                ...
                                <div class="box-widget-content">
                                    <div class="list-author-widget-contacts list-item-widget-contacts">
                                        <ul>
                                            ...
                                            <li><span><i class="fa fa-envelope-o"></i> Mail :</span> <a href="#">AlisaNoory@domain.com</a>
                                            </li>
                        ...
                        <div class="box-widget-item fl-wrap">
                            ...
                            <div class="box-widget list-author-widget">
                                <div class="list-author-widget-header shapes-bg-small  color-bg fl-wrap">
                                    ...
                                    <img src="{{ URL::asset($themePath.'images/avatar/4.jpg')}}" alt="">
                                </div>
                                <div class="box-widget-content">
...
@section('buttonsManagerFooter')
    ...
    <div class="chat-widget-button chat-widget-button--bee"><i class="fa fa-comments-o"></i><span>Chat With Owner</span>
    </div>
@endsection
