<div class="dashboard-list-box fl-wrap">
    <div class="dashboard-header fl-wrap">
        <h3>{{__('frontend.account.menu.my-bees')}}</h3>
    </div>
    <!-- dashboard-list end-->
    <div class="dashboard-list">
        <div class="dashboard-message">
            ...
            <div class="dashboard-listing-table-image">
                <a href="{{route('businessDetails', app()->getLocale()).'/1'}}"><img
            ...
            <div class="dashboard-listing-table-text">
                ...
                <ul class="dashboard-listing-table-opt  fl-wrap">
                    ...
                    <li><a href="#" class="del-btn">{{__('frontend.buttons.delete')}} <i class="fa fa-trash-o"></i></a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="dashboard-list">
        <div class="dashboard-message">
            <div class="dashboard-listing-table-image">
                <a href="{{route('businessDetails', app()->getLocale()).'/2'}}"><img
    ...
    <div class="dashboard-list">
        <div class="dashboard-message">
            <div class="dashboard-listing-table-image">
                <a href="{{route('businessDetails', app()->getLocale()).'/3'}}"><img
    ...
    <div class="dashboard-list">
        <div class="dashboard-message">
            <div class="dashboard-listing-table-image">
                <a href="{{route('businessDetails', app()->getLocale()).'/3/2'}}"><img
                        src="{{ URL::asset($themePath.'images/all/4.jpg')}}" alt=""></a>
            </div>
            <div class="dashboard-listing-table-text">
                <h4><a href="listing-single.html">Event In City Hall</a></h4>
                <span class="dashboard-listing-table-address"><i class="fa fa-map-marker"></i><a href="#">USA 27TH Brooklyn NY</a></span>
