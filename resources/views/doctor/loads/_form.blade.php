{!! Form::model($doctor, array('id' => 'doctor_form','class' => 'm-form m-form--state m-form--fit m-form--label-align-right form-horizontal', 'method' => $method)) !!}
<div class="m-scrollable" data-scrollable="true" data-max-height="200">
    <div class="m-portlet__body">
        {!! Form::hidden('doctor_id', $doctor->id,['id'=>'doctor_id']) !!}
        <div class="form-group m-form__group row">
            <div class="col-md-4">
                {!! Form::label('document','* Documento:', array('class' => 'col-form-label')) !!}
                {!! Form::text('document', $doctor->document, array('class' => 'form-control form-control-sm m-input', 'autocomplete' =>
                'off', 'placeholder' => 'ej. 1003496245', 'maxlength' => '64')) !!}
            </div>
            <div class="col-md-8">
                {!! Form::label('name','* Nombre:', array('class' => 'col-form-label')) !!}
                {!! Form::text('name', $doctor->name, array('class' => 'form-control form-control-sm m-input', 'autocomplete' =>
        ...
        <div class="form-group m-form__group row">
            <div class="col-md-6">
                ...
                {!! Form::text('birthday_date', $doctor->birthday_date ? $doctor->birthday_date : null,
            ...
            <div class="col-md-6">
                ...
                {!! Form::select('gender', array( '0'=> '- Seleccione -','M' => 'Masculino', 'F' => 'Femenino'),$doctor->gender,array('class' => 'form-control form-control-sm m-input') ) !!}
        ...
        <div class="form-group m-form__group row">
            <div class="col-md-6">
                ...
                {!! Form::text('phone', $doctor->phone ? $doctor->phone : null,
            ...
            <div class="col-md-6">
                ...
                {!! Form::text('movil', $doctor->movil ? $doctor->movil : null,
        ...
        <div class="form-group m-form__group row">
            <div class="col-md-6">
                ...
                {!! Form::text('email', $doctor->email ? $doctor->email : null,
            ...
            @if ($doctor->id)
                <div class="col-md-6">
                    ...
                    {!! Form::select('status', array( 'ACTIVE' => 'Activo', 'INACTIVE' => 'Inactivo'),$doctor->status,array('class' => 'form-control form-control-sm m-input') ) !!}
                </div>
            @endif
        </div>
        <div class="form-group m-form__group row">
        ...
        {{--Inputs HIDDEN--}}
        {!! Form::hidden('latitude', $doctor->latitude, array('id'=>'input_latitude','class' => 'form-control input-sm', )) !!}
        {!! Form::hidden('longitude', $doctor->longitude, array('id'=>'input_longitude','class' => 'form-control input-sm')) !!}
        {!! Form::hidden('address', $doctor->address, array('id'=>'address_location','class' => 'form-control input-sm')) !!}
        {{--END Inputs HIDDEN--}}
    </div>
</div>
{!! Form::close() !!}