    ...
    <script>
        ...
        function onScanSuccess(decodedText, decodedResult) {
            ...
            if (value && value !== lastResult) {
                ...
                // escribe en el input y dispara evento por si hay listeners
                $('#fill-data-qr').val(value).trigger('input'); // o .trigger('change')
                $('#input-data-product-search').val(value).trigger('input'); // o .trigger('change')
...
@section('content-manager')
    ...
    <div class="management-qr">
        <div id="qr-reader" style="width:500px"></div>
        <div id="qr-reader-results"></div>
        <input type="text" id="fill-data-qr">
    </div>
                    ...
                    <div class="tab-content border-start bg-white" id="v-pills-tabContent">
                        ...
                        <div id="v-pills-snaks" role="tabpanel" tabindex="0">
                            ...
                            <div class="row row-cols-xl-3 row-cols-lg-3 row-cols-md-2 row-cols-2 g-0"
                                 id="products-data">
                                <div v-if="dataManagerProducts.manager.rows.length === 0"
                                     class="col border-end border-bottom">
