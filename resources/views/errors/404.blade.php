    ...
    <div class="mc-401__wrap">
        <div class="mc-card mc-401__card">
            ...
            <div class="mc-card__header">
                ...
                <div class="mc-badge">Error 404</div>
            </div>

            <!-- Content -->
            <div class="mc-card__content">
                <div class="mc-401__code">404</div>

                <h2 class="mc-401__title">Página no encontrada</h2>

                <p class="mc-401__message">
                    {{ isset($message) ? $message : 'Página no encontrada.' }}
                </p>
