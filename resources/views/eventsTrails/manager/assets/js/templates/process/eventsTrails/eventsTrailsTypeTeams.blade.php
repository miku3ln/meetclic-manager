<script type='text/x-template' id='events-trails-type-teams-template'>
    <div>
        ...
        <div class='content-component'>
            ...
            <div class="content-manager-grid">
                ...
                <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                    <table id="events-trails-type-teams-grid"
                           class=""
            ...
            <div class="content-form" v-if="showManager">
                <b-form id="eventsTrailsTypeTeamsForm" v-on:submit.prevent="_submitForm">
      ...
      <span v-if="!$v.model.attributes.status.required">
       <?php  echo "{{model.structure.status.required.msj}}"?>
                        ...
                        <b-row>
                            <b-col md="4">
                                <div class="form-group"
                                     :class="getClassErrorForm('quantity',$v.model.attributes.quantity)">
                                    <label class="form__label " v-html='getLabelForm("status")'  v-html='getLabelForm("quantity")' ></label>
                                    <div class="content-element-form">
                                        <input
                                            v-model.trim="$v.model.attributes.quantity.$model"
                                            type="number"
                                            min="1"
                                            v-bind:id="getNameAttribute('quantity')"
                                            v-bind:name="getNameAttribute('quantity')"
                                            class="form-control m-input"
                                            @change="_setValueForm('quantity', $v.model.attributes.quantity.$model)"
                                            v-focus-select
                                        >
                                    </div>
                                    <div class="content-message-errors">
                                        <b-form-invalid-feedback
                                            :state="!$v.model.attributes.quantity.$error">
      <span v-if="!$v.model.attributes.quantity.required">
       <?php  echo "{{model.structure.quantity.required.msj}}"?>
      </span>
                            ...
                            <b-col md="8">
                                <div class="form-group"
                                    ...
                                    <label class="form__label " v-html='getLabelForm("status")'  v-html='getLabelForm("value")' ></label>
                                    <div class="content-element-form">
                                        <input
                        ...
                        <b-row>
                            ...
                            <b-col md="12">
                                <div class="form-group"
                                    ...
                                    <label class="form__label " v-html='getLabelForm("status")'  v-html='getLabelForm("description")' ></label>
                                    <div class="content-element-form">
<textarea
