<script type='text/x-template' id='template-news-template'>
    <div>
        <div v-if="configModalTemplateNewsByData.viewAllow">
            <template-news-by-data-component
                ref="refTemplateNewsByData"
                :params="configModalTemplateNewsByData"
            >
            </template-news-by-data-component>
        </div>
        <div v-if="configModalLanguageTemplateNews.viewAllow">
            <language-template-news-component
                ref="refLanguageTemplateNews"
                :params="configModalLanguageTemplateNews"
        ...
        <div class='content-component'>
            ...
            <div class="content-form" v-if="showManager">
                <b-form id="templateNewsForm" v-on:submit.prevent="_submitForm">
                        ...
                        <b-row>
                            <b-col md="4">
                                <div class="form-group"
                                    ...
                                    <label
                                        class="form__label "><?php echo '{{ getLabelForm("allow_source_data") }}'; ?></label>
                                    <div class="content-element-form">
                                        <input
                        ...
                        <b-row>
                            <b-col md="12">
                                <div class="form-group"
                                    ...
                                    <label class="form__label "><?php echo '{{ getLabelForm("subtitle") }}'; ?></label>
                                    <div class="content-element-form">
<textarea
