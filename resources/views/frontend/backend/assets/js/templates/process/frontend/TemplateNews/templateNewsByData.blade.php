<script type='text/x-template' id='template-news-by-data-template'>
    <div>

        <div class='content-component'>
            <div v-if="configModalLanguageTemplateNewsByData.viewAllow">
                <language-template-news-by-data-component
                    ref="refLanguageTemplateNewsByData"
                    :params="configModalLanguageTemplateNewsByData"
                >
                </language-template-news-by-data-component>
            </div>
            ...
            <b-modal
                hide-footer
                id="modal-template-news-by-data"
                ref="refTemplateNewsByDataModal"
                size="xl"
            <?php  echo '@show="_showModal"' ?>    <?php  echo '@hidden="_hideModal"' ?>    <?php  echo '@ok="_saveModal"' ?>>
                ...
                <div class="content-form" v-if="showManager">
                    <div class="d-block ">
                        <b-form id="templateNewsByDataForm" v-on:submit.prevent="_submitForm">
       ...
       <?php  echo "{{model.structure.description.required.msj}}"?>
                ...
                <div class="content-manager-grid">
                    ...
                    <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                        <table id="template-news-by-data-grid"
                               class=""
