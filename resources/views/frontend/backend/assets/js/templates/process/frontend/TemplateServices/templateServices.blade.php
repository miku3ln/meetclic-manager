<script type='text/x-template' id='template-services-template'>
    <div>
        <div v-if="configModalTemplateServicesByData.viewAllow">
            <template-services-by-data-component
                ref="refTemplateServicesByData"
                :params="configModalTemplateServicesByData"
            >
            </template-services-by-data-component>
        </div>
        <div v-if="configModalLanguageTemplateServices.viewAllow">
            <language-template-services-component
                ref="refLanguageTemplateServices"
                :params="configModalLanguageTemplateServices"
        ...
        <div class='content-component'>
            ...
            <div class="content-manager-grid">
                ...
                <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                    <table id="template-services-grid"
                           class=""
            ...
            <div class="content-form" v-if="showManager">
                <b-form id="templateServicesForm" v-on:submit.prevent="_submitForm">
