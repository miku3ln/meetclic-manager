<script type='text/x-template' id='template-services-by-data-template'>
    <div>

        <div class='content-component'>
            <div v-if="configModalLanguageTemplateServicesByData.viewAllow">
                <language-template-services-by-data-component
                    ref="refLanguageTemplateServicesByData"
                    :params="configModalLanguageTemplateServicesByData"
                >
                </language-template-services-by-data-component>
            </div>
            ...
            <b-modal
                hide-footer
                id="modal-template-services-by-data"
                ref="refTemplateServicesByDataModal"
                size="xl"
            <?php  echo '@show="_showModal"' ?>    <?php  echo '@hidden="_hideModal"' ?>    <?php  echo '@ok="_saveModal"' ?>>
                ...
                <div class="content-form" v-if="showManager">
                    <div class="d-block ">
                        <b-form id="templateServicesByDataForm" v-on:submit.prevent="_submitForm">
       ...
       <?php  echo "{{model.structure.description.required.msj}}"?>
                ...
                <div class="content-manager-grid">
                    ...
                    <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                        <table id="template-services-by-data-grid"
                               class=""
