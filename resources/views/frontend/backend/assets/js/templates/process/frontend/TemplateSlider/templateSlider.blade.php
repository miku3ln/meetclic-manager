<script type='text/x-template' id='template-slider-template'>
    <div>

        <div v-if="configModalTemplateSliderByImages.viewAllow">
            <template-slider-by-images-component
                ref="refTemplateSliderByImages"
                :params="configModalTemplateSliderByImages"
            >
            </template-slider-by-images-component>
        </div>
        ...
        <div class='content-component'>
            ...
            <div class="content-form" v-if="showManager">
                <b-form id="templateSliderForm" v-on:submit.prevent="_submitForm">
