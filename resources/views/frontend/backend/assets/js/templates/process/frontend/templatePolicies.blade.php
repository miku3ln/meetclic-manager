<script type='text/x-template' id='template-policies-template'>
    <div>

        <div class='content-component'>

            <div v-if="configModalLanguageTemplatePolicies.viewAllow">
                <language-template-policies-component
                    ref="refLanguageTemplatePolicies"
                    :params="configModalLanguageTemplatePolicies"
                    v-on:_templatePolicies-emit="_templatePolicies($event)"
                >
                </language-template-policies-component>
            </div>
            ...
            <div class="content-manager-grid">
                ...
                <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                    <table id="template-policies-grid"
                           class=""
            ...
            <div class="content-form" v-if="showManager">
                <b-form id="templatePoliciesForm" v-on:submit.prevent="_submitForm">
