<script type='text/x-template' id='language-template-policies-template'>
    <div>
        ...
        <div class='content-component'>
            ...
            <b-modal
                hide-footer
                id="modal-language-template-policies"
                ref="refLanguageTemplatePoliciesModal"
                size="xl"
...
<textarea
    ...
    v-focus-select
></textarea>
                                                <div class="description" id="description-language"
                ...
                <div class="content-manager-grid">
                    ...
                    <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                        <table id="language-template-policies-grid"
                               class=""
