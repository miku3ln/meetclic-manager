<script type='text/x-template' id='language-template-services-template'>
    <div>
        ...
        <div class='content-component'>
            ...
            <b-modal
                hide-footer
                id="modal-language-template-services"
                ref="refLanguageTemplateServicesModal"
                size="xl"
...
></textarea>
                ...
                <div class="content-manager-grid">
                    ...
                    <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                        <table id="language-template-services-grid"
                               class=""
