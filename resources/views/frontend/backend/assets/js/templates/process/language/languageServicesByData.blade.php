<script type='text/x-template' id='language-template-services-by-data-template'>
    <div>
        ...
        <div class='content-component'>
            ...
            <b-modal
                hide-footer
                id="modal-language-template-services-by-data"
                ref="refLanguageTemplateServicesByDataModal"
                size="xl"
            <?php  echo '@show="_showModal"' ?>    <?php  echo '@hidden="_hideModal"' ?>    <?php  echo '@ok="_saveModal"' ?>>
                ...
                <div class="content-form" v-if="showManager">
                    <div class="d-block ">
                        <b-form id="languageTemplateServicesByDataForm" v-on:submit.prevent="_submitForm">
...
></textarea>
                ...
                <div class="content-manager-grid">
                    ...
                    <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                        <table id="language-template-services-by-data-grid"
                               class=""
