    ...
    <div id="app-management" class="page-home-init" dataManagerPageType="{{$dataManagerPage['type']}}">
        ...
        <section class="listsearch">
            <header class="listsearch__subheader" role="region" aria-label="Filtros y título">
                ...
                <div class="listsearch__subheader-actions">
                    <div class="listing-view-layout not-view">
                        <ul>
                            <li id="view-grid"><a class="grid" href="#"><i class="fa fa-th-large"></i></a></li>
                            <li  id="view-list"><a class="list active" href="#"><i class="fa fa-list-ul"></i></a></li>
                            <li  id="view-expand"><a href="#" class="expand-listing-view"><i class="fa fa-expand"></i></a></li>
                        </ul>
                    </div>
        ...
        <div class="data-page  manager-page__data-page">
            ...
            <div class="col-list-wrap left-list" id="manager-list2">
            ...
            <div class="map-container column-map right-pos-map" id="manager-map" v-if="configDataMapManager.allow">
                <map-manager-component
                    ref="refBusiness"
                    :params="configDataMapManager"
                    v-on:_actions-emit="_updateParentByChildren($event)"
