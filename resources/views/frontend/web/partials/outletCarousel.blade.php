                ...
                <div class="container">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="section-title-area text-left">
                                <h2 class="section-title section-title--not-after section-title--custom">
                                    <a class="section-title__link" href="{{  route('shopOutlets', app()->getLocale()) }}" target="_blank">
                                        {{__('labels.thirty')}}
                                    </a>
                                  </h2>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="product-outlet-slider-wrapper " data-slick-setting='{
                                "data-lg-items":4,
                        "slidesToShow": 4,
                        "slidesToScroll": 4,
                        "arrows": true,
                                                ...
                                                <div class="product-hover-icon-wrapper" id="row-balance-{{$row['id']}}">
                                                    ...
                                                    @if($dataManagerPage['shopConfig']['allow'])
                                                        <span class="single-icon single-icon--add-to-cart">
                                                            <a
                                                                class="management-outlets add-cart"
