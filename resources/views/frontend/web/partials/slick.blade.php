...
$resourcePathServer=$resourcePathServer.'frontend/';
?>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    {"breakpoint":479, "settings": {"slidesToShow": 1, "arrows": false, "slidesToScroll": 1} }
                                        ...
                                        <div class="single-image">
                                            <img src="{{Url::asset($resourcePathServer.'assets/img/products/big1-1.jpg')}}" class="img-fluid" alt="">
                                        </div>
                                        <div class="single-image">
                                            <img src="{{Url::asset($resourcePathServer.'assets/img/products/big1-2.jpg')}}" class="img-fluid" alt="">
                                        </div>
                                        <div class="single-image">
                                            <img src="{{Url::asset($resourcePathServer.'assets/img/products/big1-3.jpg')}}" class="img-fluid" alt="">
                                        </div>
                                        <div class="single-image">
                                            <img src="{{Url::asset($resourcePathServer.'assets/img/products/big1-4.jpg')}}" class="img-fluid" alt="">
                                        </div>
                                        <div class="single-image">
                                            <img src="{{Url::asset($resourcePathServer.'assets/img/products/big1-5.jpg')}}" class="img-fluid" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="product-details-description-wrapper">
                        ...
                        <p class="description">
                            Upholstered velvet ottoman with antique stud detailing. Invite restrained
                            glamour and on-trend colour into your design scheme with the Eichholtz Ponti Ottoman.
                            Inspired by the neo-classical influences of Italian icon, Gio Ponti, this contemporary
                            ottoman collection is presented in a choice of velvet and linen colourways.
                        </p>
                        ...
                        <div class="product-color">
                            ...
                            <ul>
                                <li>
                                    <a class="active" href="#" data-tippy="Black" data-tippy-inertia="true"
                                ...
                                <li>
                                    <a href="#" data-tippy="Blue" data-tippy-inertia="true"
                                       data-tippy-animation="shift-away" data-tippy-delay="50" data-tippy-arrow="true"
                                       data-tippy-theme="roundborder">
                                        <span class="color-picker blue"></span>
                                    </a></li>
                                <li>
                                    <a href="#" data-tippy="Brown" data-tippy-inertia="true"
                                       data-tippy-animation="shift-away" data-tippy-delay="50" data-tippy-arrow="true"
                                       data-tippy-theme="roundborder">
                        ...
                        <div class="quick-view-other-info">
                            ...
                            <div class="product-brand">
                                <a href="shop-left-sidebar.html">
                                    <img src="{{Url::asset($resourcePathServer.'assets/img/brands/brand-2.png')}}" class="img-fluid" alt="">
                                </a>
                            </div>
        ...
        <div class="description-tab-navigation">
            <div class="nav nav-tabs justify-content-center" id="nav-tab2" role="tablist">
                <a class="nav-item nav-link active" id="description-tab" data-toggle="tab"
                   ...
                   role="tab" aria-selected="true">DESCRIPTION
                </a>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="description-content">
                                    <p class="long-desc">Inspired by the simplistic style of traditional Scandinavian
                                        design, this cone shaped ceiling pendant adds an understated elegance to any
                                        interior design scheme.
                                        Strung on a 3m coloured cord, this simple yet stylish ceiling light can be hung
                                        above your breakfast bar or dining table to enhance your surroundings.
                                        A modern interpretation of a classic pendant light, Annular is available in a
                                        choice of muted colourways and will look wonderful hung alone, or as a cluster
                                        for greater visual impact.</p>
