<script type='text/x-template' id='information-address-type-template'>
    <div>
        ...
        <div class='content-component'>
            ...
            <div class="content-manager-grid">
                ...
                <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                    <table id="information-address-type-grid"
                           class=""
            ...
            <div class="content-form" v-if="showManager">
                <b-form id="informationAddressTypeForm" v-on:submit.prevent="_submitForm">
