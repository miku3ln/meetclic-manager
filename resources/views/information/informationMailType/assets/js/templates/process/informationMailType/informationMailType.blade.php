<script type="text/x-template" id="information-mail-type-template">
    <div>
        ...
        <div class="content-manager-grid">
            ...
            <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                <table id="information-mail-type-grid"
                       class=""
        ...
        <div class="content-form" v-if="showManager">
            ...
            <b-form id="information-mail-type-form" v-on:submit.prevent="_submitForm">
