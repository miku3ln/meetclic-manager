<script type='text/x-template' id='information-phone-operator-template'>
<div>
...
<div class="content-manager-grid">
    ...
    <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
        <table id="information-phone-operator-grid"
               class=""
...
<div class="content-form" v-if="showManager">
    <b-form id="informationPhoneOperatorForm" v-on:submit.prevent="_submitForm">
