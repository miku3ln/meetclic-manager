...
<head>
    ...
    @include('layouts.backline.typeHtml.styles')
    <style>
        .img-fluid {
            max-width: 100%;
            height: auto;
...
$urlManagerPage = route('homeBackLine', app()->getLocale());
$addClassManagerHeader=$nameRoute == 'homeBackLine'?'':'dark-header--back-line';

?>
<div id="main" class="back-line">
    <!-- header-->
    <header class="main-header dark-header fs-header sticky {{$addClassManagerHeader}}  not-view">
        <div class="header-inner">
            ...
            @include('layouts.backline.typeHtml.buttonsManager',['type'=>'managerUserTop'])
            <!--  navigation -->
            ...
            <div class="nav-holder main-menu">
                <nav>
                    ...
                    @include('layouts.backline.typeHtml.menu',$paramsMenu)
    ...
    <!-- wrapper end -->
    <!--footer -->
    <footer class="main-footer dark-footer  not-view">
        ...
        @if(env("allowCustomerFooter"))
            ...
            <div class="sub-footer fl-wrap not-view">
                <div class="container">
                    <div class="row">
    ...
    @if($businessMainInformation['allow'])
        <!--CMS-TEMPLATE-WHATSAPP-SEND-TEMPLATE-->
        <a class=" to-top--contact-whatsapp chat-widget-button-content not-view" target="_blank">
...
@include('layouts.backline.typeHtml.scripts')
<script>

    var $businessMainInformation = <?php echo json_encode($businessMainInformation) ?>;
    var $nameRoute = '<?php echo ($nameRoute) ?>';

    var $allowHome = <?php echo($nameRoute == 'homeBackLine' ? 1 : 0) ?>;
    var $urlMain = "<?php echo(route('homeBackLine', app()->getLocale())) ?>";

    function activeMenuPachamama() {
        var nameSection='manager-process-all';
        if ($allowHome) {
            ...
            var currentSection = '';
            if (scrollPosition < $('#'+nameSection).offset().top - 67.5) {
                currentSection = 'menu__pachamama';
            } else if (scrollPosition >= $('#'+nameSection).offset().top - 79 && scrollPosition < $('#tics').offset().top - 76) {

                currentSection = 'menu__kichwa';
            } else if (scrollPosition >= $('#tics').offset().top - 76 && scrollPosition < $('#kloster').offset().top - 73) {
                currentSection = 'menu__elements';


            } else if (scrollPosition >= $('#kloster').offset().top - 73) {
    ...
    function getAllowHeaderBackground() {
        ...
        if ($allowHome) {
            ...
            if (scrollPosition >= $('#manager-process-all').offset().top - 67.5) {
                result = true;
