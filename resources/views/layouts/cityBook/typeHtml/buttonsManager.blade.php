...
@if($type=='managerUserTop')
    ...
    <div class="manager-language dropdown-translator ">
        <button class="dropdown-translator" id="languageDropdown" aria-haspopup="true" aria-expanded="false">
        {{$languageCurrentText}}
        ...
        <ul class="manager-language__ul dropdown-menu-translator list" aria-labelledby="languageDropdown">
            ...
            <li class="option">
                <a  class="manager-language__item {{$selectEs}}" language="es">
            ...
            <li>
                <a  class="manager-language__item {{$selectKi}}" language="ki">
            ...
            <li>
                <a  class="manager-language__item {{$selectEn}}" language="en">
    ...
    <!-- nav-button-wrap-->
    <div class="nav-button-wrap color-bg nav-button-wrap--menu-mobiles">
