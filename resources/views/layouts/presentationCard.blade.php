...
<head id="presentation-card-head">
<?php
                            ...
                            @else
                                ...
                                @else
                                    <div class="content-name-business ">{{env('userNameFirst')}}<span
                                            class="content-name-business__second">{{env('userNameSecond')}}</span></div>
                                @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="footer-social">
                                ...
                                @if($businessMainInformation['allow'])<!--CMS-TEMPLATE-WHATSAPP-SEND-TEMPLATE -->
                        ...
                        <div class="col-md-5">
                        @if($dataManagerPage['shopConfig']['allow'])<!---CMS-TEMPLATE-SHOPPING-CONFIG-TEMPLATE--->
                            <div class="row">
                                <div class="col-md-12">
