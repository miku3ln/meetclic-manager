...
if (isset($pageSectionsConfig)) {
    ...
    $elementNew = $pageSectionsConfig['contactTop']['language']['view'] ? ' lang="' . $dataManagerPageSet['languageHeader']['language'] . '"   xml:lang="' . $dataManagerPageSet['languageHeader']['language'] . '"' : '';
}

?>

<html
    class="no-js" <?php echo $elementNew ?>>
...
<head>
    ...
    @include('layouts.frontend.styles',['dataManagerPage'=>$dataManagerPageSet,
...
<div class="content-manager-render" nameRoute="{{$nameRoute}}">
    @yield('content')
</div>
@if(isset($dataManagerPageSet['chat']))
    {{$dataManagerPageSet['chat']}}
@endif
<!--====================  footer ====================-->
@if(isset($dataFooter))
    @include('layouts.frontend.footer-area',['dataFooter'=>$dataFooter,'dataManagerPage'=>$dataManagerPageSet,'activeHome'=>$activeHome,
...
@else
    @include('layouts.frontend.footer-area',['dataManagerPage'=>$dataManagerPageSet,'activeHome'=>$activeHome,
'activePages'=>$activePages,
'activeAboutUs'=>$activeAboutUs,
'activeContactUs'=>$activeContactUs,
'activeServices'=>$activeServices,
...
=            quick view         =
=============================================-->
@include('layouts.partials.quick-view-product',['dataMenu'=>$dataMenuSet,
'pageSectionsConfig'=>$pageSectionsConfigSet])
...
@include('layouts.frontend.scripts',['dataManagerPage'=>$dataManagerPageSet,
'pageSectionsConfig'=>$pageSectionsConfigSet])

<div class="modal fade" id="modal-data-preview" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
...
@if(isset($pageSectionsConfigSet['business']['view']))
    ...
    <a id="whatsapp-contact__a" target="blank" class="chat-widget-button-content"
       data="{{json_encode($pageSectionsConfigSet['business']['data'])}}" text="{{env('textMsgButtonWhatsApp')}}">
