...
@section('additional-styles')
    <link href="{{ asset('metronic/plugins/wizard/wizard.css') }}" rel="stylesheet"
          type="text/css">
    {{-----BOOTGRID PLUGIN--}}
    <link href="{{ asset($url_path_plugins."bootgrid/css/jquery.bootgrid.css") }}" rel="stylesheet"
          type="text/css">
@endsection
@section('content')
    <!-- BEGIN: Subheader -->
...
@section('additional-scripts')
    {{----- PLUGINS--}}
    {{--BOOTGRID--}}
    <script src="{{ asset($url_path_plugins."bootgrid/js/jquery.bootgrid.js") }}" type="text/javascript"></script>
    <script src="{{ asset($url_path_plugins."bootgrid/js/jquery.bootgrid.fa.js") }}" type="text/javascript"></script>
    <script src="{{ asset($url_path_plugins."tooltip/js/tooltip.min.js") }}" type="text/javascript"></script>


    {{--ALERTS--}}
    <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
    {{--scripts GESTION--}}
    <script src="{{ asset('js/'.$model_entity.'/Grids.js') }}" type="text/javascript"></script>
    <script src="{{ asset('js/'.$model_entity.'/_form.js') }}" type="text/javascript"></script>
    <script src="{{ asset('js/'.$model_entity.'/_formStep2.js') }}" type="text/javascript"></script>
    <script src="{{ asset('js/'.$model_entity.'/_wizard.js') }}" type="text/javascript"></script>
