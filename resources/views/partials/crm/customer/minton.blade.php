...
<b-row>
    ...
    <b-col md="6">
        <div class="form-group"
             :class="getClassErrorForm('user_by_about_us_web',$v.model.attributes.user_by_about_us_web)">
            <label
                class="form__label " v-html='getLabelForm("user_by_about_us_web")' ></label>
            <div class="content-element-form">
            ...
            <div class="content-message-errors">
                <b-form-invalid-feedback
                    :state="!$v.model.attributes.user_by_about_us_web.$error">
      <span v-if="!$v.model.attributes.user_by_about_us_web.required">
       <?php  echo "{{model.structure.user_by_about_us_web.required.msj}}"?>
      </span>
                </b-form-invalid-feedback>
            </div>
        </div>
