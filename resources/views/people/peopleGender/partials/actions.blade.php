{{--ACTIONS MODEL--}}
<input id="action-people-gender-saveData" type="hidden"
value="{{action("People\PeopleGenderController@saveData")}}"/>

<input id="action-people-gender-getAdmin" type="hidden"
value="{{action("People\PeopleGenderController@getAdmin")}}"/>
