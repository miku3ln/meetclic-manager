<?php  $resourcePathServer=env('APP_IS_SERVER')?'public/':'';?>
@php
...
<script src="{{ asset($resourcePathServer.'js/'.$pathCurrent.'/components/peopleTypeIdentification/PeopleTypeIdentification.js')}}" type='text/javascript'></script>
