<script type='text/x-template' id='language-product-category-template'>
    <div>
        ...
        <div class='content-component'>
            ...
            <b-modal
                hide-footer
                id="modal-language-product-category"
                ref="refLanguageProductCategoryModal"
                size="xl"
            <?php  echo '@show="_showModal"' ?>    <?php  echo '@hidden="_hideModal"' ?>    <?php  echo '@ok="_saveModal"' ?>>
                ...
                <div class="content-form" v-if="showManager">
                    <div class="d-block ">
                        <b-form id="languageProductCategoryForm" v-on:submit.prevent="_submitForm">
...
></textarea>
                ...
                <div class="content-manager-grid">
                    ...
                    <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                        <table id="language-product-category-grid"
                               class=""
