<script type='text/x-template' id='product-category-template'>
    <div>

        <div class='content-component'>

            <div v-if="configModalLanguageProductCategory.viewAllow">
                <language-product-category-component
                    ref="refLanguageProductCategory"
                    :params="configModalLanguageProductCategory"
                >
                </language-product-category-component>
            </div>
            ...
            <div class="content-manager-grid">
                ...
                <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                    <table id="product-category-grid"
                           class=""
            ...
            <div class="content-form" v-if="showManager">
                <b-form id="productCategoryForm" v-on:submit.prevent="_submitForm">
                            ...
                            <b-col md="4">
                                <div class=" content-box-image content-box-preview"
                                    ...
                                    <div class="content-element-form">
                                        <input
                                                v-initEventUploadSource="{initMethod:_managerEventsUploadSource,modelCurrent: this.model,paramsInit:getAttributesManagerUpload({nameField:'source',modelCurrent: this.model})}"
