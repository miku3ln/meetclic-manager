<script type='text/x-template' id='product-ice-template'>
<div>
...
<div class="content-form" v-if="showManager">
    <b-form id="productIceForm" v-on:submit.prevent="_submitForm">
...
<label class="form__label "><?php echo'{{getLabelForm("state")}}'?></label>
<div class="content-element-form">
...
:class="getClassErrorForm('product_ice_types_id_data',$v.model.attributes.product_ice_types_id_data)">
<label class="form__label "><?php echo'{{getLabelForm("product_ice_types_id_data")}}'?></label>
<div class="content-element-form">
<input v-model="$v.model.attributes.product_ice_types_id_data.model" type="hidden"
v-bind:id="getNameAttribute('product_ice_types_id_data')"
v-bind:name="getNameAttribute('product_ice_types_id_data')"
@change="_setValueForm('product_ice_types_id_data', $v.model.attributes.product_ice_types_id_data.$model)"
>
<select id="product_ice_types_id_data"
class="form-control m-select2 "
v-initS2ProductIceTypes="{rowId:model.attributes.id,_managerS2ProductIceTypes:_managerS2ProductIceTypes}"
>
</select>
  </div>
<div class="content-message-errors">
      <b-form-invalid-feedback
      :state="!$v.model.attributes.product_ice_types_id_data.$error">
      <span v-if="!$v.model.attributes.product_ice_types_id_data.required">
       <?php  echo "{{model.structure.product_ice_types_id_data.required.msj}}"?>
      </span>
     </b-form-invalid-feedback>
   </div>
</div>
