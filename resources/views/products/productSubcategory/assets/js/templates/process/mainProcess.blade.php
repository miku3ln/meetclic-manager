<script type='text/x-template' id='product-subcategory-template'>
    <div>

        <div class='content-component'>

            <div v-if="configModalLanguageProductSubcategory.viewAllow">
                <language-product-subcategory-component
                    ref="refLanguageProductSubcategory"
                    :params="configModalLanguageProductSubcategory"
                >
                </language-product-subcategory-component>
            </div>
            ...
            <div class="content-manager-grid">
                ...
                <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                    <table id="product-subcategory-grid"
                           class=""
            ...
            <div class="content-form" v-if="showManager">
                <b-form id="productSubcategoryForm" v-on:submit.prevent="_submitForm">
