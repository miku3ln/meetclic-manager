<script type='text/x-template' id='product-trademark-template'>
    <div>

        <div class='content-component'>

            <div v-if="configModalLanguageProductTrademark.viewAllow">
                <language-product-trademark-component
                    ref="refLanguageProductTrademark"
                    :params="configModalLanguageProductTrademark"
                >
                </language-product-trademark-component>
            </div>
            ...
            <div class="content-manager-grid">
                ...
                <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                    <table id="product-trademark-grid"
                           class=""
            ...
            <div class="content-form" v-if="showManager">
                <b-form id="productTrademarkForm" v-on:submit.prevent="_submitForm">
