<form id="{{ $frmId }}_form" class="m-form m-form--state m-form--fit m-form--label-align-right form-horizontal" method="{{ $method }}">
    <div class="m-portlet__body">
        ...
        <div class="form-group m-form__group row">
            ...
            <div class="col-md-9">
                <input type="text" name="name" id="name" class="form-control m-input" autocomplete="off" placeholder="ej. Lesion,Hecho ,Por Hacer ,Pre Existente," maxlength="64" value="{{ $model->name }}">
            </div>
        </div>

        <div class="form-group m-form__group row">
            <label for="color" id="color_label" class="col-form-label col-md-3">* Color:</label>
            <div class="col-md-9">
                <input type="text" name="color" id="color" class="form-control m-input" autocomplete="off" placeholder="ej. #fff" maxlength="64" value="{{ $model->color }}">
            </div>
        </div>
