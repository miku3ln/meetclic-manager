...
<script src="{{ asset($resourcePathServer.'js/'.$pathCurrent.'/components/ShippingRateServices.js') }}"
        type="text/javascript"></script>
<script src="{{ asset($resourcePathServer.'js/'.$pathCurrent.'/components/ShippingRateBusinessByConversionFactor.js') }}"
        type="text/javascript"></script>
