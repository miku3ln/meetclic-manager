<script type='text/x-template' id='shipping-rate-business-template'>
    <div>

        <div class='content-component'>
            <div v-if="configModalShippingRateServices.viewAllow">
                <shipping-rate-services-component
                    ref="refShippingRateServices"
                    :params="configModalShippingRateServices"
                >
                </shipping-rate-services-component>
            </div>
            <div v-if="configModalShippingRateBusinessByConversionFactor.viewAllow">
                <shipping-rate-business-by-conversion-factor-component
                    ref="refShippingRateBusinessByConversionFactor"
                    :params="configModalShippingRateBusinessByConversionFactor"
                >
                </shipping-rate-business-by-conversion-factor-component>
            </div>
            ...
            <div class="content-manager-grid">
                ...
                <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                    <table id="shipping-rate-business-grid"
                           class=""
            ...
            <div class="content-form" v-if="showManager">
                <b-form id="shippingRateBusinessForm" v-on:submit.prevent="_submitForm">
