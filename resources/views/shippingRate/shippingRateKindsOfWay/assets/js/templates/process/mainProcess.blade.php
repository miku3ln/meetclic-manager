<script type='text/x-template' id='shipping-rate-kinds-of-way-template'>
    <div>
        ...
        <div class='content-component'>
            ...
            <div class="content-manager-grid">
                ...
                <div class="custom-scroll-admin-grid table-responsive" v-show="!showManager">
                    <table id="shipping-rate-kinds-of-way-grid"
                           class=""
            ...
            <div class="content-form" v-if="showManager">
                <b-form id="shippingRateKindsOfWayForm" v-on:submit.prevent="_submitForm">
