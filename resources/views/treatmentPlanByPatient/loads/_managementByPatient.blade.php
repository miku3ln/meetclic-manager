<div class="col-lg-12">
    <div class="m-portlet m-portlet--accent m-portlet--head-solid-bg m-portlet--head-sm"
         m-portlet="true" id="m_portlet_{{$tableConfig["id"]}}">
        <div class="m-portlet__head">
            ...
            <div class="m-portlet__head-tools">
                <ul class="m-portlet__nav">
                    ...
                    <li class="m-portlet__nav-item">
                        <a   data-toggle="tooltip" data-placement="top" title=" Agregar Plan Tratamiento"  action="{{action("Hospital\TreatmentPlanByPatientController@getManagementByPatientForm")}}" href="#" m-portlet-tool="add-register"
                           class="m-portlet__nav-link m-portlet__nav-link--icon"
                    ...
                    <li class="m-portlet__nav-item m-portlet__nav-item-update-{{$tableConfig["id"]}} hide-element">
                        <a data-toggle="tooltip" data-placement="top" title=" Editar Plan Tratamiento"  action="{{action("Hospital\TreatmentPlanByPatientController@getManagementByPatientForm")}}" href="#" m-portlet-tool="update-register"
                           class="m-portlet__nav-link m-portlet__nav-link--icon"
                    ...
                    <li  class="m-portlet__nav-item m-portlet__nav-item-view-{{$tableConfig["id"]}}- hide-element">
                        <a data-toggle="tooltip" data-placement="top" title=" Ver  Plan Tratamiento"  action="{{action("Hospital\TreatmentPlanByPatientController@getManagementByPatientForm")}}" href="#" m-portlet-tool="view-register"
                           class="m-portlet__nav-link m-portlet__nav-link--icon"
                           aria-describedby="tooltip_cr4rw063iy"><i class="la la-eye"></i></a>
                        <div class="m-tooltip m-tooltip--portlet tooltip bs-tooltip-top" role="tooltip"
                             id="tooltip_cr4rw063iy" aria-hidden="true" x-placement="top"
                             style="position: absolute; transform: translate3d(321px, -33px, 0px); top: 0px; left: 0px; will-change: transform; display: none;">
                            <div class="tooltip-arrow arrow" style="left: 48px;"></div>
                            <div class="tooltip-inner">Ver</div>
                        </div>
                    </li>
                </ul>
            </div>
