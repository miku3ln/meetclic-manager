<script type="text/x-template" id="actions-template">
    <div>
        ...
        @include( 'partials.adminViewVue',['title'=>'Menu','grid_name'=>'actions-grid'])
            ...
            <b-form id="LodgingForm" v-on:submit.prevent="_submitForm">
                ...
                <b-container>
                    ...
                    <b-row>
                        ...
                        <b-col md="4" v-if="$v.model.attributes.type.$model!=1">
                            <div class="form-group"
                    ...
                    <b-row>
                        ...
                        <b-col md="6" v-show="$v.model.attributes.type.$model !=2">
                            <div class="form-group"
