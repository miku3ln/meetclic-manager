    ...
    <div id="app-management">
                        ...
                        <div class="modal-container">
                            ...
                            <div class="modal-footer">
                                <slot name="footer">
                                    ...
                                    <button class="btn--manager-close" @click="$emit('close')">
                                        CERRAR
                                    </button>
                                </slot>
                            </div>
        ...
        <modal v-if="showModal" @close="showModal = false">
            <!--
              ...
              default content
            -->
            <h3 slot="header">   <?php echo "{{titleModal}}" ?></h3>

            <div class="m-portlet__body" slot="body">
                ...
                <h1 class="title-message">Mueve a la vaca alredor de la luna :)</h1>
            ...
            <button type="button"
                    class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air" v-on:click="checkForm()">
                Guardar
            </button>

        </modal>
        <business-management-component :business="business" class="business-data">
...
@section('script')
    ...
    <script src="{{ asset($resourcePathServer.'js/'.$model_entity.'/tary/plugins/TweenMax.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset($resourcePathServer.'js/'.$model_entity.'/tary/plugins/Draggable-latest-beta.js') }}" type="text/javascript"></script>
    <script src="{{ asset($resourcePathServer.'js/'.$model_entity.'/tary/plugins/ThrowPropsPlugin.min.js') }}" type="text/javascript"></script>

    <script src="{{ asset($resourcePathServer.'js/'.$model_entity.'/tary/googleMaps.js') }}" type="text/javascript"></script>
    <script src="{{ asset($resourcePathServer.'js/'.$model_entity.'/tary/firebase.js') }}" type="text/javascript"></script>
    <script src="{{ asset($resourcePathServer.'js/'.$model_entity.'/tary/index.js') }}" type="text/javascript"></script>
    <script src="{{ asset($resourcePathServer.'js/'.$model_entity.'/tary/app.js') }}" type="text/javascript"></script>
