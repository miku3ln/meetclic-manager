...
$publicRoot = asset($publicAsset);

$routesExamples=[
    'chasquiPrefix'=>[
       // 'nianes'=>route('chasqui.nianes', ['language' => 'es']),
        'nianes'=>route('chasqui.nianesChasqui', ['language' => 'es', 'id' => 1]),
        'routeView'=>route('chasqui.routeViewChasqui', ['language' => 'es', 'id' => 1]),
    ...
    <div id="app-management">
        ...
        >
            ...
            <view-marker-information-component
                ...
                :params="configDataViewMarkerInformation"
        ...
        <routes-drawing-component
            ...
            :params="configDataRoutesDrawing"
...
@section('script')
            ...
            <div class="content-view-information-title">
                ...
                <div class="adventure-types">
                    <adventure-type-component
                        ...
                        :params="configDataAdventureType"
                        ref="_emitParentToLegendInformation"
                        ...
                        <table class="content-legend-adventure-type__tbl">
                            ...
                            <tr v-for="(adventure, index)  in data">
                                <th v-for="(adventureCols, indexCol)  in adventure.data"
                                    ...
                                    <span
                                        class="name-adventure--th"> <?php echo "{{adventureCols.adventure_adventure_type_text}}"?> </span>
                                </th>
                            </tr>
    ...
    <script type="text/javascript">
        ...
        var $publicAsset = <?php echo json_encode($publicAsset)?>;
        var $publicRoot = <?php echo json_encode($publicAsset)?>;
        var $routesExamples = <?php echo json_encode($routesExamples)?>;
    ...
    <script src="{{ asset($resourcePathServer.'js/'.$pathCurrent.'/Components/Configuration.js') }}"
